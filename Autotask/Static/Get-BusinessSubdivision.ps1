...
#>
Function Get-BusinessSubdivision
{
...
.EXAMPLE
Get-BusinessSubdivision -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-BusinessSubdivision -BusinessSubdivisionName SomeName
Returns the object with BusinessSubdivisionName 'SomeName', if any.
 .EXAMPLE
Get-BusinessSubdivision -BusinessSubdivisionName 'Some Name'
Returns the object with BusinessSubdivisionName 'Some Name', if any.
 .EXAMPLE
Get-BusinessSubdivision -BusinessSubdivisionName 'Some Name' -NotEquals BusinessSubdivisionName
Returns any objects with a BusinessSubdivisionName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-BusinessSubdivision -BusinessSubdivisionName SomeName* -Like BusinessSubdivisionName
Returns any object with a BusinessSubdivisionName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-BusinessSubdivision -BusinessSubdivisionName SomeName* -NotLike BusinessSubdivisionName
...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('BusinessDivisionSubdivision:BusinessSubdivisionID')]
    [String]
