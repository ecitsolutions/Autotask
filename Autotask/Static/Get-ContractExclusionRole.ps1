...
#>
Function Get-ContractExclusionRole
{
...
.EXAMPLE
Get-ContractExclusionRole -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractExclusionRole -ContractExclusionRoleName SomeName
Returns the object with ContractExclusionRoleName 'SomeName', if any.
 .EXAMPLE
Get-ContractExclusionRole -ContractExclusionRoleName 'Some Name'
Returns the object with ContractExclusionRoleName 'Some Name', if any.
 .EXAMPLE
Get-ContractExclusionRole -ContractExclusionRoleName 'Some Name' -NotEquals ContractExclusionRoleName
Returns any objects with a ContractExclusionRoleName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractExclusionRole -ContractExclusionRoleName SomeName* -Like ContractExclusionRoleName
Returns any object with a ContractExclusionRoleName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractExclusionRole -ContractExclusionRoleName SomeName* -NotLike ContractExclusionRoleName
