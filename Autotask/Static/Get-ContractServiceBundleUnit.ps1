...
#>
Function Get-ContractServiceBundleUnit
{
...
.EXAMPLE
Get-ContractServiceBundleUnit -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractServiceBundleUnit -ContractServiceBundleUnitName SomeName
Returns the object with ContractServiceBundleUnitName 'SomeName', if any.
 .EXAMPLE
Get-ContractServiceBundleUnit -ContractServiceBundleUnitName 'Some Name'
Returns the object with ContractServiceBundleUnitName 'Some Name', if any.
 .EXAMPLE
Get-ContractServiceBundleUnit -ContractServiceBundleUnitName 'Some Name' -NotEquals ContractServiceBundleUnitName
Returns any objects with a ContractServiceBundleUnitName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractServiceBundleUnit -ContractServiceBundleUnitName SomeName* -Like ContractServiceBundleUnitName
Returns any object with a ContractServiceBundleUnitName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractServiceBundleUnit -ContractServiceBundleUnitName SomeName* -NotLike ContractServiceBundleUnitName
