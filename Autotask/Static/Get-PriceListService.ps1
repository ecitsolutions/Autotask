...
.EXAMPLE
Get-PriceListService -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PriceListService -PriceListServiceName SomeName
Returns the object with PriceListServiceName 'SomeName', if any.
 .EXAMPLE
Get-PriceListService -PriceListServiceName 'Some Name'
Returns the object with PriceListServiceName 'Some Name', if any.
 .EXAMPLE
Get-PriceListService -PriceListServiceName 'Some Name' -NotEquals PriceListServiceName
Returns any objects with a PriceListServiceName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PriceListService -PriceListServiceName SomeName* -Like PriceListServiceName
Returns any object with a PriceListServiceName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PriceListService -PriceListServiceName SomeName* -NotLike PriceListServiceName
