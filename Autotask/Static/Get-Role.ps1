...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('ContractRate:RoleID', 'ContractFactor:RoleID', 'ResourceServiceDeskRole:RoleID', 'ResourceRoleQueue:RoleID', 'PriceListRole:RoleID', 'TaskSecondaryResource:RoleID', 'ResourceRole:RoleID', 'BillingItem:RoleID', 'ResourceRoleDepartment:RoleID', 'TicketSecondaryResource:RoleID', 'ContractExclusionRole:RoleID', 'Resource:DefaultServiceDeskRoleID', 'Ticket:AssignedResourceRoleID', 'QuoteItem:LaborID', 'TimeEntry:RoleID', 'ContractRoleCost:RoleID', 'Task:AssignedResourceRoleID')]
    [String]
