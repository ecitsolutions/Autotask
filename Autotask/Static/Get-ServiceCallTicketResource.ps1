...
#>
Function Get-ServiceCallTicketResource
{
...
.EXAMPLE
Get-ServiceCallTicketResource -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ServiceCallTicketResource -ServiceCallTicketResourceName SomeName
Returns the object with ServiceCallTicketResourceName 'SomeName', if any.
 .EXAMPLE
Get-ServiceCallTicketResource -ServiceCallTicketResourceName 'Some Name'
Returns the object with ServiceCallTicketResourceName 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTicketResource -ServiceCallTicketResourceName 'Some Name' -NotEquals ServiceCallTicketResourceName
Returns any objects with a ServiceCallTicketResourceName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTicketResource -ServiceCallTicketResourceName SomeName* -Like ServiceCallTicketResourceName
Returns any object with a ServiceCallTicketResourceName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ServiceCallTicketResource -ServiceCallTicketResourceName SomeName* -NotLike ServiceCallTicketResourceName
...
# Follow this external ID and return any external objects
    ...
    [Alias('GetRef')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('ServiceCallTicketID', 'ResourceID')]
    [String]
