...
#>
Function Get-InventoryTransfer
{
...
.EXAMPLE
Get-InventoryTransfer -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-InventoryTransfer -InventoryTransferName SomeName
Returns the object with InventoryTransferName 'SomeName', if any.
 .EXAMPLE
Get-InventoryTransfer -InventoryTransferName 'Some Name'
Returns the object with InventoryTransferName 'Some Name', if any.
 .EXAMPLE
Get-InventoryTransfer -InventoryTransferName 'Some Name' -NotEquals InventoryTransferName
Returns any objects with a InventoryTransferName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-InventoryTransfer -InventoryTransferName SomeName* -Like InventoryTransferName
Returns any object with a InventoryTransferName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-InventoryTransfer -InventoryTransferName SomeName* -NotLike InventoryTransferName
