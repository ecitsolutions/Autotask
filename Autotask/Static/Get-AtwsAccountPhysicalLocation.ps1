...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('InstalledProduct:AccountPhysicalLocationID', 'Contact:AccountPhysicalLocationID', 'Account:BillToAccountPhysicalLocationID', 'Ticket:AccountPhysicalLocationID', 'ServiceCall:AccountPhysicalLocationID')]
    [String]
