...
#>
Function Get-ResourceServiceDeskRole
{
...
.EXAMPLE
Get-ResourceServiceDeskRole -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ResourceServiceDeskRole -ResourceServiceDeskRoleName SomeName
Returns the object with ResourceServiceDeskRoleName 'SomeName', if any.
 .EXAMPLE
Get-ResourceServiceDeskRole -ResourceServiceDeskRoleName 'Some Name'
Returns the object with ResourceServiceDeskRoleName 'Some Name', if any.
 .EXAMPLE
Get-ResourceServiceDeskRole -ResourceServiceDeskRoleName 'Some Name' -NotEquals ResourceServiceDeskRoleName
Returns any objects with a ResourceServiceDeskRoleName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ResourceServiceDeskRole -ResourceServiceDeskRoleName SomeName* -Like ResourceServiceDeskRoleName
Returns any object with a ResourceServiceDeskRoleName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ResourceServiceDeskRole -ResourceServiceDeskRoleName SomeName* -NotLike ResourceServiceDeskRoleName
...
# Default
    ...
    [ValidateSet('id', 'ResourceID', 'RoleID', 'Active', 'Default')]
    [String[]]
    $NotEquals,
    ...
    [ValidateSet('id', 'ResourceID', 'RoleID')]
    [String[]]
    $GreaterThan,
