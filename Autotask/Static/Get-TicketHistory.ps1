...
.EXAMPLE
Get-TicketHistory -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-TicketHistory -TicketHistoryName SomeName
Returns the object with TicketHistoryName 'SomeName', if any.
 .EXAMPLE
Get-TicketHistory -TicketHistoryName 'Some Name'
Returns the object with TicketHistoryName 'Some Name', if any.
 .EXAMPLE
Get-TicketHistory -TicketHistoryName 'Some Name' -NotEquals TicketHistoryName
Returns any objects with a TicketHistoryName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-TicketHistory -TicketHistoryName SomeName* -Like TicketHistoryName
Returns any object with a TicketHistoryName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-TicketHistory -TicketHistoryName SomeName* -NotLike TicketHistoryName
