...
.EXAMPLE
Get-ContractRoleCost -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractRoleCost -ContractRoleCostName SomeName
Returns the object with ContractRoleCostName 'SomeName', if any.
 .EXAMPLE
Get-ContractRoleCost -ContractRoleCostName 'Some Name'
Returns the object with ContractRoleCostName 'Some Name', if any.
 .EXAMPLE
Get-ContractRoleCost -ContractRoleCostName 'Some Name' -NotEquals ContractRoleCostName
Returns any objects with a ContractRoleCostName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractRoleCost -ContractRoleCostName SomeName* -Like ContractRoleCostName
Returns any object with a ContractRoleCostName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractRoleCost -ContractRoleCostName SomeName* -NotLike ContractRoleCostName
