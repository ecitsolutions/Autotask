...
#>
Function Get-ServiceCallTicket
{
...
.EXAMPLE
Get-ServiceCallTicket -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ServiceCallTicket -ServiceCallTicketName SomeName
Returns the object with ServiceCallTicketName 'SomeName', if any.
 .EXAMPLE
Get-ServiceCallTicket -ServiceCallTicketName 'Some Name'
Returns the object with ServiceCallTicketName 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTicket -ServiceCallTicketName 'Some Name' -NotEquals ServiceCallTicketName
Returns any objects with a ServiceCallTicketName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTicket -ServiceCallTicketName SomeName* -Like ServiceCallTicketName
Returns any object with a ServiceCallTicketName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ServiceCallTicket -ServiceCallTicketName SomeName* -NotLike ServiceCallTicketName
...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('ServiceCallTicketResource:ServiceCallTicketID')]
    [String]
