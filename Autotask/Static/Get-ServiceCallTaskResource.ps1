...
#>
Function Get-ServiceCallTaskResource
{
...
.EXAMPLE
Get-ServiceCallTaskResource -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ServiceCallTaskResource -ServiceCallTaskResourceName SomeName
Returns the object with ServiceCallTaskResourceName 'SomeName', if any.
 .EXAMPLE
Get-ServiceCallTaskResource -ServiceCallTaskResourceName 'Some Name'
Returns the object with ServiceCallTaskResourceName 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTaskResource -ServiceCallTaskResourceName 'Some Name' -NotEquals ServiceCallTaskResourceName
Returns any objects with a ServiceCallTaskResourceName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTaskResource -ServiceCallTaskResourceName SomeName* -Like ServiceCallTaskResourceName
Returns any object with a ServiceCallTaskResourceName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ServiceCallTaskResource -ServiceCallTaskResourceName SomeName* -NotLike ServiceCallTaskResourceName
