...
#>
Function Get-PurchaseOrderReceive
{
...
.EXAMPLE
Get-PurchaseOrderReceive -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PurchaseOrderReceive -PurchaseOrderReceiveName SomeName
Returns the object with PurchaseOrderReceiveName 'SomeName', if any.
 .EXAMPLE
Get-PurchaseOrderReceive -PurchaseOrderReceiveName 'Some Name'
Returns the object with PurchaseOrderReceiveName 'Some Name', if any.
 .EXAMPLE
Get-PurchaseOrderReceive -PurchaseOrderReceiveName 'Some Name' -NotEquals PurchaseOrderReceiveName
Returns any objects with a PurchaseOrderReceiveName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PurchaseOrderReceive -PurchaseOrderReceiveName SomeName* -Like PurchaseOrderReceiveName
Returns any object with a PurchaseOrderReceiveName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PurchaseOrderReceive -PurchaseOrderReceiveName SomeName* -NotLike PurchaseOrderReceiveName
