...
#>
Function New-ResourceServiceDeskRole
{
...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the ResourceServiceDeskRole with Id number 0 you could write 'New-ResourceServiceDeskRole -Id 0' or you could write 'New-ResourceServiceDeskRole -Filter {Id -eq 0}.

'New-ResourceServiceDeskRole -Id 0,4' could be written as 'New-ResourceServiceDeskRole -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-ResourceServiceDeskRole -ResourceID [Value] -RoleID [Value]
Creates a new [Autotask.ResourceServiceDeskRole] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-ResourceServiceDeskRole -Id 124 | New-ResourceServiceDeskRole 
Copies [Autotask.ResourceServiceDeskRole] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-ResourceServiceDeskRole -Id 124 | New-ResourceServiceDeskRole | Set-ResourceServiceDeskRole -ParameterName <Parameter Value>
Copies [Autotask.ResourceServiceDeskRole] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ResourceServiceDeskRole to modify the object.
 .EXAMPLE
$Result = Get-ResourceServiceDeskRole -Id 124 | New-ResourceServiceDeskRole | Set-ResourceServiceDeskRole -ParameterName <Parameter Value> -Passthru
Copies [Autotask.ResourceServiceDeskRole] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ResourceServiceDeskRole to modify the object and returns the new object.

.LINK
Get-ResourceServiceDeskRole
 .LINK
Set-ResourceServiceDeskRole
