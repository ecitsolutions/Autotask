...
#>
Function Get-ChangeRequestLink
{
...
.EXAMPLE
Get-ChangeRequestLink -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ChangeRequestLink -ChangeRequestLinkName SomeName
Returns the object with ChangeRequestLinkName 'SomeName', if any.
 .EXAMPLE
Get-ChangeRequestLink -ChangeRequestLinkName 'Some Name'
Returns the object with ChangeRequestLinkName 'Some Name', if any.
 .EXAMPLE
Get-ChangeRequestLink -ChangeRequestLinkName 'Some Name' -NotEquals ChangeRequestLinkName
Returns any objects with a ChangeRequestLinkName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ChangeRequestLink -ChangeRequestLinkName SomeName* -Like ChangeRequestLinkName
Returns any object with a ChangeRequestLinkName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ChangeRequestLink -ChangeRequestLinkName SomeName* -NotLike ChangeRequestLinkName
