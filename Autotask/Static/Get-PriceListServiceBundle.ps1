...
#>
Function Get-PriceListServiceBundle
{
...
.EXAMPLE
Get-PriceListServiceBundle -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PriceListServiceBundle -PriceListServiceBundleName SomeName
Returns the object with PriceListServiceBundleName 'SomeName', if any.
 .EXAMPLE
Get-PriceListServiceBundle -PriceListServiceBundleName 'Some Name'
Returns the object with PriceListServiceBundleName 'Some Name', if any.
 .EXAMPLE
Get-PriceListServiceBundle -PriceListServiceBundleName 'Some Name' -NotEquals PriceListServiceBundleName
Returns any objects with a PriceListServiceBundleName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PriceListServiceBundle -PriceListServiceBundleName SomeName* -Like PriceListServiceBundleName
Returns any object with a PriceListServiceBundleName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PriceListServiceBundle -PriceListServiceBundleName SomeName* -NotLike PriceListServiceBundleName
