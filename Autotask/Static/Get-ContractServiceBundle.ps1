...
#>
Function Get-ContractServiceBundle
{
...
.EXAMPLE
Get-ContractServiceBundle -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractServiceBundle -ContractServiceBundleName SomeName
Returns the object with ContractServiceBundleName 'SomeName', if any.
 .EXAMPLE
Get-ContractServiceBundle -ContractServiceBundleName 'Some Name'
Returns the object with ContractServiceBundleName 'Some Name', if any.
 .EXAMPLE
Get-ContractServiceBundle -ContractServiceBundleName 'Some Name' -NotEquals ContractServiceBundleName
Returns any objects with a ContractServiceBundleName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractServiceBundle -ContractServiceBundleName SomeName* -Like ContractServiceBundleName
Returns any object with a ContractServiceBundleName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractServiceBundle -ContractServiceBundleName SomeName* -NotLike ContractServiceBundleName
