...
#>
Function Get-ContractServiceUnit
{
...
.EXAMPLE
Get-ContractServiceUnit -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractServiceUnit -ContractServiceUnitName SomeName
Returns the object with ContractServiceUnitName 'SomeName', if any.
 .EXAMPLE
Get-ContractServiceUnit -ContractServiceUnitName 'Some Name'
Returns the object with ContractServiceUnitName 'Some Name', if any.
 .EXAMPLE
Get-ContractServiceUnit -ContractServiceUnitName 'Some Name' -NotEquals ContractServiceUnitName
Returns any objects with a ContractServiceUnitName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractServiceUnit -ContractServiceUnitName SomeName* -Like ContractServiceUnitName
Returns any object with a ContractServiceUnitName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractServiceUnit -ContractServiceUnitName SomeName* -NotLike ContractServiceUnitName
