...
.EXAMPLE
Get-PriceListRole -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PriceListRole -PriceListRoleName SomeName
Returns the object with PriceListRoleName 'SomeName', if any.
 .EXAMPLE
Get-PriceListRole -PriceListRoleName 'Some Name'
Returns the object with PriceListRoleName 'Some Name', if any.
 .EXAMPLE
Get-PriceListRole -PriceListRoleName 'Some Name' -NotEquals PriceListRoleName
Returns any objects with a PriceListRoleName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PriceListRole -PriceListRoleName SomeName* -Like PriceListRoleName
Returns any object with a PriceListRoleName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PriceListRole -PriceListRoleName SomeName* -NotLike PriceListRoleName
