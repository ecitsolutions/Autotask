...
.EXAMPLE
Get-BusinessDivision -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-BusinessDivision -BusinessDivisionName SomeName
Returns the object with BusinessDivisionName 'SomeName', if any.
 .EXAMPLE
Get-BusinessDivision -BusinessDivisionName 'Some Name'
Returns the object with BusinessDivisionName 'Some Name', if any.
 .EXAMPLE
Get-BusinessDivision -BusinessDivisionName 'Some Name' -NotEquals BusinessDivisionName
Returns any objects with a BusinessDivisionName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-BusinessDivision -BusinessDivisionName SomeName* -Like BusinessDivisionName
Returns any object with a BusinessDivisionName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-BusinessDivision -BusinessDivisionName SomeName* -NotLike BusinessDivisionName
