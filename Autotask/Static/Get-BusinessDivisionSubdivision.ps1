...
#>
Function Get-BusinessDivisionSubdivision
{
...
.EXAMPLE
Get-BusinessDivisionSubdivision -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-BusinessDivisionSubdivision -BusinessDivisionSubdivisionName SomeName
Returns the object with BusinessDivisionSubdivisionName 'SomeName', if any.
 .EXAMPLE
Get-BusinessDivisionSubdivision -BusinessDivisionSubdivisionName 'Some Name'
Returns the object with BusinessDivisionSubdivisionName 'Some Name', if any.
 .EXAMPLE
Get-BusinessDivisionSubdivision -BusinessDivisionSubdivisionName 'Some Name' -NotEquals BusinessDivisionSubdivisionName
Returns any objects with a BusinessDivisionSubdivisionName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-BusinessDivisionSubdivision -BusinessDivisionSubdivisionName SomeName* -Like BusinessDivisionSubdivisionName
Returns any object with a BusinessDivisionSubdivisionName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-BusinessDivisionSubdivision -BusinessDivisionSubdivisionName SomeName* -NotLike BusinessDivisionSubdivisionName
