...
#>
Function Get-ServiceLevelAgreementResults
{
...
.EXAMPLE
Get-ServiceLevelAgreementResults -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ServiceLevelAgreementResults -ServiceLevelAgreementResultsName SomeName
Returns the object with ServiceLevelAgreementResultsName 'SomeName', if any.
 .EXAMPLE
Get-ServiceLevelAgreementResults -ServiceLevelAgreementResultsName 'Some Name'
Returns the object with ServiceLevelAgreementResultsName 'Some Name', if any.
 .EXAMPLE
Get-ServiceLevelAgreementResults -ServiceLevelAgreementResultsName 'Some Name' -NotEquals ServiceLevelAgreementResultsName
Returns any objects with a ServiceLevelAgreementResultsName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ServiceLevelAgreementResults -ServiceLevelAgreementResultsName SomeName* -Like ServiceLevelAgreementResultsName
Returns any object with a ServiceLevelAgreementResultsName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ServiceLevelAgreementResults -ServiceLevelAgreementResultsName SomeName* -NotLike ServiceLevelAgreementResultsName
