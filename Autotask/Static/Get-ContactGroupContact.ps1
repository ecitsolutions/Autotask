...
#>
Function Get-ContactGroupContact
{
...
.EXAMPLE
Get-ContactGroupContact -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContactGroupContact -ContactGroupContactName SomeName
Returns the object with ContactGroupContactName 'SomeName', if any.
 .EXAMPLE
Get-ContactGroupContact -ContactGroupContactName 'Some Name'
Returns the object with ContactGroupContactName 'Some Name', if any.
 .EXAMPLE
Get-ContactGroupContact -ContactGroupContactName 'Some Name' -NotEquals ContactGroupContactName
Returns any objects with a ContactGroupContactName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContactGroupContact -ContactGroupContactName SomeName* -Like ContactGroupContactName
Returns any object with a ContactGroupContactName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContactGroupContact -ContactGroupContactName SomeName* -NotLike ContactGroupContactName
