...
.EXAMPLE
Get-TaskPredecessor -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-TaskPredecessor -TaskPredecessorName SomeName
Returns the object with TaskPredecessorName 'SomeName', if any.
 .EXAMPLE
Get-TaskPredecessor -TaskPredecessorName 'Some Name'
Returns the object with TaskPredecessorName 'Some Name', if any.
 .EXAMPLE
Get-TaskPredecessor -TaskPredecessorName 'Some Name' -NotEquals TaskPredecessorName
Returns any objects with a TaskPredecessorName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-TaskPredecessor -TaskPredecessorName SomeName* -Like TaskPredecessorName
Returns any object with a TaskPredecessorName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-TaskPredecessor -TaskPredecessorName SomeName* -NotLike TaskPredecessorName
