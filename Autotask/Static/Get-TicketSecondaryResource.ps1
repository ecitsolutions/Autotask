...
#>
Function Get-TicketSecondaryResource
{
...
.EXAMPLE
Get-TicketSecondaryResource -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-TicketSecondaryResource -TicketSecondaryResourceName SomeName
Returns the object with TicketSecondaryResourceName 'SomeName', if any.
 .EXAMPLE
Get-TicketSecondaryResource -TicketSecondaryResourceName 'Some Name'
Returns the object with TicketSecondaryResourceName 'Some Name', if any.
 .EXAMPLE
Get-TicketSecondaryResource -TicketSecondaryResourceName 'Some Name' -NotEquals TicketSecondaryResourceName
Returns any objects with a TicketSecondaryResourceName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-TicketSecondaryResource -TicketSecondaryResourceName SomeName* -Like TicketSecondaryResourceName
Returns any object with a TicketSecondaryResourceName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-TicketSecondaryResource -TicketSecondaryResourceName SomeName* -NotLike TicketSecondaryResourceName
...
# Role
    ...
    [ValidateSet('id', 'TicketID', 'ResourceID', 'RoleID')]
    [String[]]
    $NotEquals,
