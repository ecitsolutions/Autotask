...
.EXAMPLE
Get-PriceListProduct -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PriceListProduct -PriceListProductName SomeName
Returns the object with PriceListProductName 'SomeName', if any.
 .EXAMPLE
Get-PriceListProduct -PriceListProductName 'Some Name'
Returns the object with PriceListProductName 'Some Name', if any.
 .EXAMPLE
Get-PriceListProduct -PriceListProductName 'Some Name' -NotEquals PriceListProductName
Returns any objects with a PriceListProductName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PriceListProduct -PriceListProductName SomeName* -Like PriceListProductName
Returns any object with a PriceListProductName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PriceListProduct -PriceListProductName SomeName* -NotLike PriceListProductName
