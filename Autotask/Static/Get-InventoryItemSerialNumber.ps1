...
#>
Function Get-InventoryItemSerialNumber
{
...
.EXAMPLE
Get-InventoryItemSerialNumber -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-InventoryItemSerialNumber -InventoryItemSerialNumberName SomeName
Returns the object with InventoryItemSerialNumberName 'SomeName', if any.
 .EXAMPLE
Get-InventoryItemSerialNumber -InventoryItemSerialNumberName 'Some Name'
Returns the object with InventoryItemSerialNumberName 'Some Name', if any.
 .EXAMPLE
Get-InventoryItemSerialNumber -InventoryItemSerialNumberName 'Some Name' -NotEquals InventoryItemSerialNumberName
Returns any objects with a InventoryItemSerialNumberName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-InventoryItemSerialNumber -InventoryItemSerialNumberName SomeName* -Like InventoryItemSerialNumberName
Returns any object with a InventoryItemSerialNumberName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-InventoryItemSerialNumber -InventoryItemSerialNumberName SomeName* -NotLike InventoryItemSerialNumberName
