...
#>
Function Get-UserDefinedFieldListItem
{
...
.EXAMPLE
Get-UserDefinedFieldListItem -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-UserDefinedFieldListItem -UserDefinedFieldListItemName SomeName
Returns the object with UserDefinedFieldListItemName 'SomeName', if any.
 .EXAMPLE
Get-UserDefinedFieldListItem -UserDefinedFieldListItemName 'Some Name'
Returns the object with UserDefinedFieldListItemName 'Some Name', if any.
 .EXAMPLE
Get-UserDefinedFieldListItem -UserDefinedFieldListItemName 'Some Name' -NotEquals UserDefinedFieldListItemName
Returns any objects with a UserDefinedFieldListItemName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-UserDefinedFieldListItem -UserDefinedFieldListItemName SomeName* -Like UserDefinedFieldListItemName
Returns any object with a UserDefinedFieldListItemName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-UserDefinedFieldListItem -UserDefinedFieldListItemName SomeName* -NotLike UserDefinedFieldListItemName
