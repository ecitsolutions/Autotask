...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('InstalledProductWebhookExcludedResource:WebhookID', 'InstalledProductWebhookField:WebhookID', 'InstalledProductWebhookUdfField:WebhookID', 'WebhookEventErrorLog:ConfigurationItemWebhookID')]
    [string]
