...
#>
Function Get-SubscriptionPeriod
{
...
.EXAMPLE
Get-SubscriptionPeriod -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-SubscriptionPeriod -SubscriptionPeriodName SomeName
Returns the object with SubscriptionPeriodName 'SomeName', if any.
 .EXAMPLE
Get-SubscriptionPeriod -SubscriptionPeriodName 'Some Name'
Returns the object with SubscriptionPeriodName 'Some Name', if any.
 .EXAMPLE
Get-SubscriptionPeriod -SubscriptionPeriodName 'Some Name' -NotEquals SubscriptionPeriodName
Returns any objects with a SubscriptionPeriodName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-SubscriptionPeriod -SubscriptionPeriodName SomeName* -Like SubscriptionPeriodName
Returns any object with a SubscriptionPeriodName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-SubscriptionPeriod -SubscriptionPeriodName SomeName* -NotLike SubscriptionPeriodName
