...
.EXAMPLE
Get-ContractFactor -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractFactor -ContractFactorName SomeName
Returns the object with ContractFactorName 'SomeName', if any.
 .EXAMPLE
Get-ContractFactor -ContractFactorName 'Some Name'
Returns the object with ContractFactorName 'Some Name', if any.
 .EXAMPLE
Get-ContractFactor -ContractFactorName 'Some Name' -NotEquals ContractFactorName
Returns any objects with a ContractFactorName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractFactor -ContractFactorName SomeName* -Like ContractFactorName
Returns any object with a ContractFactorName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractFactor -ContractFactorName SomeName* -NotLike ContractFactorName
