...
#>
Function Get-BusinessDivisionSubdivisionResource
{
...
.EXAMPLE
Get-BusinessDivisionSubdivisionResource -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-BusinessDivisionSubdivisionResource -BusinessDivisionSubdivisionResourceName SomeName
Returns the object with BusinessDivisionSubdivisionResourceName 'SomeName', if any.
 .EXAMPLE
Get-BusinessDivisionSubdivisionResource -BusinessDivisionSubdivisionResourceName 'Some Name'
Returns the object with BusinessDivisionSubdivisionResourceName 'Some Name', if any.
 .EXAMPLE
Get-BusinessDivisionSubdivisionResource -BusinessDivisionSubdivisionResourceName 'Some Name' -NotEquals BusinessDivisionSubdivisionResourceName
Returns any objects with a BusinessDivisionSubdivisionResourceName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-BusinessDivisionSubdivisionResource -BusinessDivisionSubdivisionResourceName SomeName* -Like BusinessDivisionSubdivisionResourceName
Returns any object with a BusinessDivisionSubdivisionResourceName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-BusinessDivisionSubdivisionResource -BusinessDivisionSubdivisionResourceName SomeName* -NotLike BusinessDivisionSubdivisionResourceName
...
# Resource ID
  ...
  Begin
  { 
    $EntityName = 'BusinessDivisionSubdivisionResource'
