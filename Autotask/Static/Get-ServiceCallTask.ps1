...
.EXAMPLE
Get-ServiceCallTask -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ServiceCallTask -ServiceCallTaskName SomeName
Returns the object with ServiceCallTaskName 'SomeName', if any.
 .EXAMPLE
Get-ServiceCallTask -ServiceCallTaskName 'Some Name'
Returns the object with ServiceCallTaskName 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTask -ServiceCallTaskName 'Some Name' -NotEquals ServiceCallTaskName
Returns any objects with a ServiceCallTaskName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ServiceCallTask -ServiceCallTaskName SomeName* -Like ServiceCallTaskName
Returns any object with a ServiceCallTaskName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ServiceCallTask -ServiceCallTaskName SomeName* -NotLike ServiceCallTaskName
...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('ServiceCallTaskResource:ServiceCallTaskID')]
    [String]
