...
#>
Function Get-ResourceRoleDepartment
{
...
.EXAMPLE
Get-ResourceRoleDepartment -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ResourceRoleDepartment -ResourceRoleDepartmentName SomeName
Returns the object with ResourceRoleDepartmentName 'SomeName', if any.
 .EXAMPLE
Get-ResourceRoleDepartment -ResourceRoleDepartmentName 'Some Name'
Returns the object with ResourceRoleDepartmentName 'Some Name', if any.
 .EXAMPLE
Get-ResourceRoleDepartment -ResourceRoleDepartmentName 'Some Name' -NotEquals ResourceRoleDepartmentName
Returns any objects with a ResourceRoleDepartmentName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ResourceRoleDepartment -ResourceRoleDepartmentName SomeName* -Like ResourceRoleDepartmentName
Returns any object with a ResourceRoleDepartmentName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ResourceRoleDepartment -ResourceRoleDepartmentName SomeName* -NotLike ResourceRoleDepartmentName
