...
#>
Function Get-TicketChangeRequestApproval
{
...
.EXAMPLE
Get-TicketChangeRequestApproval -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-TicketChangeRequestApproval -TicketChangeRequestApprovalName SomeName
Returns the object with TicketChangeRequestApprovalName 'SomeName', if any.
 .EXAMPLE
Get-TicketChangeRequestApproval -TicketChangeRequestApprovalName 'Some Name'
Returns the object with TicketChangeRequestApprovalName 'Some Name', if any.
 .EXAMPLE
Get-TicketChangeRequestApproval -TicketChangeRequestApprovalName 'Some Name' -NotEquals TicketChangeRequestApprovalName
Returns any objects with a TicketChangeRequestApprovalName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-TicketChangeRequestApproval -TicketChangeRequestApprovalName SomeName* -Like TicketChangeRequestApprovalName
Returns any object with a TicketChangeRequestApprovalName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-TicketChangeRequestApproval -TicketChangeRequestApprovalName SomeName* -NotLike TicketChangeRequestApprovalName
...
.LINK
New-TicketChangeRequestApproval
 .LINK
