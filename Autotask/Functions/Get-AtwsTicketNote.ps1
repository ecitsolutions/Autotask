...
# Title
    ...
    [ValidateSet('id', 'Title', 'ImpersonatorUpdaterResourceID', 'LastActivityDate', 'CreateDateTime', 'ImpersonatorCreatorResourceID', 'TicketID', 'Publish', 'Description', 'NoteType', 'CreatorResourceID', 'CreatedByContactID')]
    [string[]]
    $NotEquals,
