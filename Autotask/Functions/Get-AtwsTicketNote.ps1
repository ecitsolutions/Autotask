...
# Title
    ...
    [ValidateSet('id', 'ImpersonatorCreatorResourceID', 'NoteType', 'Publish', 'LastActivityDate', 'Description', 'CreatedByContactID', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID', 'CreateDateTime', 'Title', 'TicketID')]
    [string[]]
    $NotEquals,
