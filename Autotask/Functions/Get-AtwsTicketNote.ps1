...
# Title
    ...
    [ValidateSet('Description', 'Publish', 'ImpersonatorUpdaterResourceID', 'NoteType', 'CreatorResourceID', 'CreateDateTime', 'LastActivityDate', 'TicketID', 'Title', 'id', 'ImpersonatorCreatorResourceID', 'CreatedByContactID')]
    [string[]]
    $NotEquals,
