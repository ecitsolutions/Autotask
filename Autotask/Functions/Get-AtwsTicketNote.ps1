...
# Title
    ...
    [ValidateSet('id', 'LastActivityDate', 'Publish', 'CreatedByContactID', 'NoteType', 'Title', 'TicketID', 'ImpersonatorUpdaterResourceID', 'Description', 'CreatorResourceID', 'CreateDateTime', 'ImpersonatorCreatorResourceID')]
    [string[]]
    $NotEquals,
