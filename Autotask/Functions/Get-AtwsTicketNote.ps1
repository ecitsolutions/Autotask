...
# Title
    ...
    [ValidateSet('CreatorResourceID', 'CreateDateTime', 'Description', 'CreatedByContactID', 'Title', 'NoteType', 'ImpersonatorCreatorResourceID', 'ImpersonatorUpdaterResourceID', 'LastActivityDate', 'TicketID', 'Publish', 'id')]
    [string[]]
    $NotEquals,
