...
# Title
    ...
    [ValidateSet('Title', 'LastActivityDate', 'ContractID', 'ImpersonatorUpdaterResourceID', 'Description', 'id', 'CreatorResourceID', 'CreateDateTime', 'ImpersonatorCreatorResourceID')]
    [string[]]
    $NotEquals,
