...
# Title
    ...
    [ValidateSet('Title', 'ImpersonatorUpdaterResourceID', 'Description', 'id', 'ImpersonatorCreatorResourceID', 'CreateDateTime', 'ContractID', 'LastActivityDate', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
