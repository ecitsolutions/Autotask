...
# Title
    ...
    [ValidateSet('Title', 'CreatorResourceID', 'LastActivityDate', 'CreateDateTime', 'ImpersonatorCreatorResourceID', 'ContractID', 'Description', 'id', 'ImpersonatorUpdaterResourceID')]
    [string[]]
    $NotEquals,
