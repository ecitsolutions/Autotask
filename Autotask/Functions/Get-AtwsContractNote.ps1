...
# Create Date Time
    ...
    [ValidateSet('ContractID', 'ImpersonatorCreatorResourceID', 'CreateDateTime', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID', 'Description', 'Title', 'id', 'LastActivityDate')]
    [string[]]
    $NotEquals,
