...
# Title
    ...
    [ValidateSet('id', 'ImpersonatorCreatorResourceID', 'LastActivityDate', 'Description', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID', 'Title', 'CreateDateTime', 'ContractID')]
    [string[]]
    $NotEquals,
