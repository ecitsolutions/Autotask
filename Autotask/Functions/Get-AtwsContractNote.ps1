...
# Title
    ...
    [ValidateSet('Title', 'ContractID', 'ImpersonatorCreatorResourceID', 'Description', 'LastActivityDate', 'CreateDateTime', 'id', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
