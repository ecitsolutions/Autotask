...
# Create Date Time
    ...
    [ValidateSet('ContractID', 'Description', 'CreatorResourceID', 'CreateDateTime', 'ImpersonatorUpdaterResourceID', 'ImpersonatorCreatorResourceID', 'LastActivityDate', 'Title', 'id')]
    [string[]]
    $NotEquals,
