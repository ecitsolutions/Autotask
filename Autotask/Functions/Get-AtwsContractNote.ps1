...
# Title
    ...
    [ValidateSet('CreatorResourceID', 'Description', 'Title', 'ImpersonatorCreatorResourceID', 'ImpersonatorUpdaterResourceID', 'id', 'LastActivityDate', 'CreateDateTime', 'ContractID')]
    [string[]]
    $NotEquals,
