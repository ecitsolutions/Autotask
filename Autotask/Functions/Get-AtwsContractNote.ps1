...
# Title
    ...
    [ValidateSet('ImpersonatorCreatorResourceID', 'id', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID', 'LastActivityDate', 'CreateDateTime', 'ContractID', 'Title', 'Description')]
    [string[]]
    $NotEquals,
