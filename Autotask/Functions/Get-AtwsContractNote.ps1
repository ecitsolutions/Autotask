...
# Title
    ...
    [ValidateSet('LastActivityDate', 'ContractID', 'id', 'ImpersonatorUpdaterResourceID', 'Description', 'ImpersonatorCreatorResourceID', 'Title', 'CreateDateTime', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
