...
#>
Function Remove-AtwsTicketAdditionalInstalledProduct
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsTicketAdditionalInstalledProduct.md')]
  Param
  (
