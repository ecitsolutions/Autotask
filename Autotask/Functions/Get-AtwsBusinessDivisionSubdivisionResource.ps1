...
#>
Function Get-AtwsBusinessDivisionSubdivisionResource
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsBusinessDivisionSubdivisionResource.md')]
  Param
  (
