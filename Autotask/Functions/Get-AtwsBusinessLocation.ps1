...
# WednesdayExtendedHoursStartTime
    ...
    [ValidateSet('HolidayHoursType', 'Address2', 'MondayExtendedHoursStartTime', 'TuesdayBusinessHoursStartTime', 'HolidaySetID', 'FridayBusinessHoursEndTime', 'HolidayHoursEndTime', 'SaturdayBusinessHoursStartTime', 'HolidayExtendedHoursStartTime', 'TuesdayExtendedHoursStartTime', 'FirstDayOfWeek', 'TuesdayBusinessHoursEndTime', 'WednesdayExtendedHoursStartTime', 'TuesdayExtendedHoursEndTime', 'FridayBusinessHoursStartTime', 'SaturdayExtendedHoursEndTime', 'NoHoursOnHolidays', 'id', 'SundayBusinessHoursEndTime', 'SundayExtendedHoursEndTime', 'ThursdayBusinessHoursEndTime', 'FridayExtendedHoursStartTime', 'TimeZoneID', 'DateFormat', 'MondayBusinessHoursEndTime', 'MondayExtendedHoursEndTime', 'FridayExtendedHoursEndTime', 'ThursdayBusinessHoursStartTime', 'Default', 'State', 'Address1', 'Name', 'WednesdayBusinessHoursEndTime', 'HolidayHoursStartTime', 'TimeFormat', 'MondayBusinessHoursStartTime', 'WednesdayExtendedHoursEndTime', 'NumberFormat', 'ThursdayExtendedHoursStartTime', 'SundayExtendedHoursStartTime', 'ThursdayExtendedHoursEndTime', 'CountryID', 'SundayBusinessHoursStartTime', 'SaturdayBusinessHoursEndTime', 'City', 'PostalCode', 'WednesdayBusinessHoursStartTime', 'AdditionalAddressInfo', 'SaturdayExtendedHoursStartTime', 'HolidayExtendedHoursEndTime')]
    [string[]]
    $NotEquals,
