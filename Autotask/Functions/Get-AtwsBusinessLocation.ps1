...
# WednesdayExtendedHoursStartTime
    ...
    [ValidateSet('SundayExtendedHoursEndTime', 'SundayExtendedHoursStartTime', 'HolidayExtendedHoursStartTime', 'SundayBusinessHoursEndTime', 'TuesdayExtendedHoursEndTime', 'HolidayExtendedHoursEndTime', 'ThursdayBusinessHoursEndTime', 'ThursdayExtendedHoursEndTime', 'SaturdayExtendedHoursEndTime', 'AdditionalAddressInfo', 'ThursdayBusinessHoursStartTime', 'State', 'CountryID', 'ThursdayExtendedHoursStartTime', 'FridayExtendedHoursStartTime', 'SaturdayExtendedHoursStartTime', 'MondayBusinessHoursStartTime', 'FridayBusinessHoursEndTime', 'NoHoursOnHolidays', 'Address2', 'City', 'SundayBusinessHoursStartTime', 'HolidaySetID', 'MondayBusinessHoursEndTime', 'SaturdayBusinessHoursEndTime', 'TimeZoneID', 'TuesdayExtendedHoursStartTime', 'TuesdayBusinessHoursEndTime', 'Name', 'PostalCode', 'Default', 'TuesdayBusinessHoursStartTime', 'HolidayHoursEndTime', 'MondayExtendedHoursStartTime', 'FridayBusinessHoursStartTime', 'MondayExtendedHoursEndTime', 'FirstDayOfWeek', 'WednesdayBusinessHoursEndTime', 'SaturdayBusinessHoursStartTime', 'HolidayHoursType', 'TimeFormat', 'HolidayHoursStartTime', 'DateFormat', 'NumberFormat', 'FridayExtendedHoursEndTime', 'Address1', 'WednesdayExtendedHoursEndTime', 'WednesdayExtendedHoursStartTime', 'WednesdayBusinessHoursStartTime', 'id')]
    [string[]]
    $NotEquals,
