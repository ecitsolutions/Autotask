...
# WednesdayExtendedHoursStartTime
    ...
    [ValidateSet('TuesdayBusinessHoursStartTime', 'ThursdayExtendedHoursStartTime', 'id', 'TuesdayExtendedHoursEndTime', 'ThursdayBusinessHoursEndTime', 'Name', 'TimeFormat', 'City', 'SundayBusinessHoursEndTime', 'TuesdayExtendedHoursStartTime', 'FirstDayOfWeek', 'HolidayExtendedHoursEndTime', 'FridayExtendedHoursEndTime', 'PostalCode', 'SaturdayBusinessHoursStartTime', 'SundayBusinessHoursStartTime', 'WednesdayBusinessHoursEndTime', 'MondayExtendedHoursStartTime', 'AdditionalAddressInfo', 'NumberFormat', 'SundayExtendedHoursStartTime', 'HolidaySetID', 'Default', 'FridayBusinessHoursEndTime', 'MondayBusinessHoursEndTime', 'SaturdayExtendedHoursEndTime', 'TimeZoneID', 'DateFormat', 'FridayBusinessHoursStartTime', 'Address2', 'CountryID', 'WednesdayExtendedHoursStartTime', 'TuesdayBusinessHoursEndTime', 'ThursdayExtendedHoursEndTime', 'HolidayHoursStartTime', 'WednesdayExtendedHoursEndTime', 'MondayBusinessHoursStartTime', 'SaturdayExtendedHoursStartTime', 'HolidayHoursType', 'NoHoursOnHolidays', 'SundayExtendedHoursEndTime', 'FridayExtendedHoursStartTime', 'HolidayHoursEndTime', 'SaturdayBusinessHoursEndTime', 'MondayExtendedHoursEndTime', 'ThursdayBusinessHoursStartTime', 'Address1', 'HolidayExtendedHoursStartTime', 'WednesdayBusinessHoursStartTime', 'State')]
    [string[]]
    $NotEquals,
