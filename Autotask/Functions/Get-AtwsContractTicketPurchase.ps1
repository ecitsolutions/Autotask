...
# Tickets Purchased
    ...
    [ValidateSet('PaymentType', 'IsPaid', 'StartDate', 'DatePurchased', 'TicketsUsed', 'PerTicketRate', 'InvoiceNumber', 'ContractID', 'EndDate', 'PaymentNumber', 'Status', 'id', 'TicketsPurchased')]
    [string[]]
    $NotEquals,
