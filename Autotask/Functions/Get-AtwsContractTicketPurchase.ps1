...
# Tickets Purchased
    ...
    [ValidateSet('TicketsPurchased', 'IsPaid', 'Status', 'DatePurchased', 'PaymentNumber', 'TicketsUsed', 'id', 'PerTicketRate', 'ContractID', 'EndDate', 'PaymentType', 'InvoiceNumber', 'StartDate')]
    [string[]]
    $NotEquals,
