...
# Tickets Purchased
    ...
    [ValidateSet('id', 'TicketsUsed', 'IsPaid', 'PaymentType', 'Status', 'InvoiceNumber', 'TicketsPurchased', 'DatePurchased', 'PaymentNumber', 'StartDate', 'EndDate', 'PerTicketRate', 'ContractID')]
    [string[]]
    $NotEquals,
