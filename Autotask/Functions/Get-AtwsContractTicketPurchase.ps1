...
# Tickets Purchased
    ...
    [ValidateSet('PaymentNumber', 'Status', 'TicketsUsed', 'PaymentType', 'InvoiceNumber', 'EndDate', 'id', 'PerTicketRate', 'TicketsPurchased', 'IsPaid', 'StartDate', 'DatePurchased', 'ContractID')]
    [Collections.Generic.List[string]]
    $NotEquals,
