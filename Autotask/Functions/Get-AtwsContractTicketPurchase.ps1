...
# Tickets Purchased
    ...
    [ValidateSet('StartDate', 'Status', 'PaymentNumber', 'id', 'DatePurchased', 'PerTicketRate', 'TicketsPurchased', 'IsPaid', 'InvoiceNumber', 'PaymentType', 'EndDate', 'ContractID', 'TicketsUsed')]
    [string[]]
    $NotEquals,
