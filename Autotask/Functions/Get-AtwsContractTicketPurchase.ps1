...
# Tickets Purchased
    ...
    [ValidateSet('PaymentNumber', 'TicketsPurchased', 'PerTicketRate', 'ContractID', 'IsPaid', 'StartDate', 'PaymentType', 'id', 'DatePurchased', 'EndDate', 'TicketsUsed', 'InvoiceNumber', 'Status')]
    [string[]]
    $NotEquals,
