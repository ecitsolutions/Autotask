...
# Tickets Purchased
    ...
    [ValidateSet('EndDate', 'StartDate', 'InvoiceNumber', 'IsPaid', 'ContractID', 'PaymentNumber', 'PerTicketRate', 'Status', 'TicketsUsed', 'PaymentType', 'TicketsPurchased', 'DatePurchased', 'id')]
    [string[]]
    $NotEquals,
