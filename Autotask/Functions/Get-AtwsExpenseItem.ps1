...
# Work Type
    ...
    [ValidateSet('ExpenseDate', 'PurchaseOrderNumber', 'Destination', 'Description', 'ExpenseCategory', 'Rejected', 'TicketID', 'EntertainmentLocation', 'ExpenseCurrencyID', 'TaskID', 'OdometerEnd', 'Reimbursable', 'WorkType', 'HaveReceipt', 'AccountID', 'Miles', 'GLCode', 'ExpenseReportID', 'ExpenseAmount', 'ProjectID', 'BillableToAccount', 'Origin', 'PaymentType', 'ReceiptAmount', 'ReimbursementAmount', 'OdometerStart', 'ReimbursementCurrencyReimbursementAmount', 'id')]
    [string[]]
    $NotEquals,
