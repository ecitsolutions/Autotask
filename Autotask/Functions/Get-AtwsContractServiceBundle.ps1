...
# Unit Price
    ...
    [ValidateSet('InternalDescription', 'ServiceBundleID', 'ContractID', 'UnitPrice', 'id', 'AdjustedPrice', 'InternalCurrencyUnitPrice', 'QuoteItemID', 'InvoiceDescription', 'InternalCurrencyAdjustedPrice')]
    [string[]]
    $NotEquals,
