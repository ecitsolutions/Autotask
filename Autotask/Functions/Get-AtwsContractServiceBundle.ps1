...
# Unit Price
    ...
    [ValidateSet('InternalCurrencyAdjustedPrice', 'InternalDescription', 'InternalCurrencyUnitPrice', 'UnitPrice', 'ContractID', 'ServiceBundleID', 'id', 'InvoiceDescription', 'QuoteItemID', 'AdjustedPrice')]
    [string[]]
    $NotEquals,
