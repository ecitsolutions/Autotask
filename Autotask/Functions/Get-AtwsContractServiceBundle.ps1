...
# Unit Price
    ...
    [ValidateSet('id', 'ServiceBundleID', 'UnitPrice', 'AdjustedPrice', 'InternalCurrencyUnitPrice', 'InternalCurrencyAdjustedPrice', 'InvoiceDescription', 'InternalDescription', 'QuoteItemID', 'ContractID')]
    [string[]]
    $NotEquals,
