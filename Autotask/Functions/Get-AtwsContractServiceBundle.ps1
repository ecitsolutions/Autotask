...
# Unit Price
    ...
    [ValidateSet('id', 'AdjustedPrice', 'InternalDescription', 'InternalCurrencyUnitPrice', 'InternalCurrencyAdjustedPrice', 'InvoiceDescription', 'ContractID', 'QuoteItemID', 'ServiceBundleID', 'UnitPrice')]
    [string[]]
    $NotEquals,
