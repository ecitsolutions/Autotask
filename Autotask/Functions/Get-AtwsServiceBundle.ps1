...
# update_by_id
    ...
    [ValidateSet('Description', 'Name', 'UnitPrice', 'PeriodType', 'CreateDate', 'IsActive', 'InvoiceDescription', 'UpdateResourceID', 'id', 'LastModifiedDate', 'CreatorResourceID', 'ServiceLevelAgreementID', 'UnitDiscount', 'AllocationCodeID', 'UnitCost', 'PercentageDiscount')]
    [string[]]
    $NotEquals,
