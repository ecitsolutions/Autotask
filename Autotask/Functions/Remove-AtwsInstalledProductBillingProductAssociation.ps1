...
#>
Function Remove-AtwsInstalledProductBillingProductAssociation
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsInstalledProductBillingProductAssociation.md')]
  Param
  (
