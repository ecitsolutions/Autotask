...
# Title
    ...
    [ValidateSet('Publish', 'Title', 'Announce', 'Description', 'id', 'ImpersonatorCreatorResourceID', 'CreatorResourceID', 'LastActivityDate', 'CreateDateTime', 'ProjectID', 'ImpersonatorUpdaterResourceID', 'NoteType')]
    [string[]]
    $NotEquals,
