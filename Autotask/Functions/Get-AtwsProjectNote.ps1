...
# Title
    ...
    [ValidateSet('ImpersonatorUpdaterResourceID', 'id', 'CreatorResourceID', 'Description', 'ProjectID', 'Announce', 'NoteType', 'Publish', 'CreateDateTime', 'CreatedByContactID', 'ImpersonatorCreatorResourceID', 'LastActivityDate', 'Title')]
    [string[]]
    $NotEquals,
