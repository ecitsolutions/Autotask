...
# Title
    ...
    [ValidateSet('ProjectID', 'Description', 'CreateDateTime', 'LastActivityDate', 'Publish', 'NoteType', 'Title', 'ImpersonatorCreatorResourceID', 'id', 'CreatedByContactID', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID', 'Announce')]
    [string[]]
    $NotEquals,
