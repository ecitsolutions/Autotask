...
# Title
    ...
    [ValidateSet('CreatorResourceID', 'Announce', 'Publish', 'id', 'Description', 'LastActivityDate', 'ProjectID', 'CreateDateTime', 'Title', 'ImpersonatorCreatorResourceID', 'CreatedByContactID', 'NoteType', 'ImpersonatorUpdaterResourceID')]
    [string[]]
    $NotEquals,
