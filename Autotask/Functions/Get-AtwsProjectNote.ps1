...
# Title
    ...
    [ValidateSet('Announce', 'NoteType', 'ImpersonatorUpdaterResourceID', 'id', 'CreateDateTime', 'ImpersonatorCreatorResourceID', 'CreatedByContactID', 'LastActivityDate', 'CreatorResourceID', 'Title', 'Publish', 'Description', 'ProjectID')]
    [string[]]
    $NotEquals,
