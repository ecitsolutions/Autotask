...
# Title
    ...
    [ValidateSet('ImpersonatorCreatorResourceID', 'CreateDateTime', 'NoteType', 'Description', 'CreatorResourceID', 'Publish', 'ImpersonatorUpdaterResourceID', 'id', 'LastActivityDate', 'Announce', 'ProjectID', 'Title')]
    [string[]]
    $NotEquals,
