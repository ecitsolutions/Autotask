...
# Time Format
    ...
    [ValidateSet('DateFormat', 'PageNumberFormat', 'DisplayRecurringServiceContractLabor', 'TimeFormat', 'DisplaySeparateLineItemForEachTax', 'ShowVerticalGridLines', 'PaymentTerms', 'Name', 'id', 'GroupBy', 'NumberFormat', 'DisplayTaxCategorySuperscripts', 'DisplayFixedPriceContractLabor', 'CurrencyNegativeFormat', 'CoveredByRecurringServiceFixedPricePerTicketContractLabel', 'DisplayZeroAmountRecurringServicesAndBundles', 'ItemizeServicesAndBundles', 'CurrencyPositiveFormat', 'SortBy', 'ShowGridHeader', 'ItemizeItemsInEachGroup', 'DisplayTaxCategory', 'RateCostExpression', 'NonBillableLaborLabel', 'PageLayout', 'CoveredByBlockRetainerContractLabel')]
    [string[]]
    $NotEquals,
