...
# Time Format
    ...
    [ValidateSet('DisplayTaxCategorySuperscripts', 'NumberFormat', 'GroupBy', 'DisplaySeparateLineItemForEachTax', 'RateCostExpression', 'PaymentTerms', 'CurrencyPositiveFormat', 'ShowVerticalGridLines', 'SortBy', 'CurrencyNegativeFormat', 'ShowGridHeader', 'DateFormat', 'DisplayRecurringServiceContractLabor', 'PageLayout', 'DisplayZeroAmountRecurringServicesAndBundles', 'TimeFormat', 'DisplayFixedPriceContractLabor', 'DisplayTaxCategory', 'id', 'ItemizeItemsInEachGroup', 'PageNumberFormat', 'Name', 'ItemizeServicesAndBundles', 'CoveredByRecurringServiceFixedPricePerTicketContractLabel', 'CoveredByBlockRetainerContractLabel', 'NonBillableLaborLabel')]
    [string[]]
    $NotEquals,
