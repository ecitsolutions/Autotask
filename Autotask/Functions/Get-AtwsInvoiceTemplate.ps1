...
# Time Format
    ...
    [ValidateSet('DisplayTaxCategorySuperscripts', 'NonBillableLaborLabel', 'DateFormat', 'Name', 'CurrencyPositiveFormat', 'ItemizeItemsInEachGroup', 'DisplayFixedPriceContractLabor', 'PageNumberFormat', 'ShowGridHeader', 'DisplayTaxCategory', 'SortBy', 'DisplaySeparateLineItemForEachTax', 'ShowVerticalGridLines', 'NumberFormat', 'GroupBy', 'id', 'CoveredByRecurringServiceFixedPricePerTicketContractLabel', 'DisplayZeroAmountRecurringServicesAndBundles', 'DisplayRecurringServiceContractLabor', 'ItemizeServicesAndBundles', 'CurrencyNegativeFormat', 'PaymentTerms', 'PageLayout', 'TimeFormat', 'RateCostExpression', 'CoveredByBlockRetainerContractLabel')]
    [string[]]
    $NotEquals,
