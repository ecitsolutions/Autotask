...
# Product Unit Cost
    ...
    [ValidateSet('id', 'SalesOrderID', 'Memo', 'UnitCost', 'InternalCurrencyUnitCost', 'Quantity', 'ContractID', 'ProductID', 'InventoryLocationID', 'ProjectID', 'OrderID', 'EstimatedArrivalDate', 'TicketID', 'CostID')]
    [string[]]
    $NotEquals,
