...
# Product Unit Cost
    ...
    [ValidateSet('ContractID', 'Memo', 'EstimatedArrivalDate', 'ProductID', 'InventoryLocationID', 'ProjectID', 'id', 'Quantity', 'TicketID', 'SalesOrderID', 'UnitCost', 'CostID', 'InternalCurrencyUnitCost', 'OrderID')]
    [string[]]
    $NotEquals,
