...
# Type ID
    ...
    [ValidateSet('TypeID', 'StartDateTime', 'ActivityDateTime', 'TaskID', 'DeletedByResourceID', 'HoursWorked', 'EndDateTime', 'id', 'CreatedByResourceID', 'TaskNumber', 'NoteOrAttachmentTitle', 'DeletedDateTime')]
    [string[]]
    $NotEquals,
