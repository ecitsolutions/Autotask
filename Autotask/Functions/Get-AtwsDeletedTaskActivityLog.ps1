...
# Type ID
    ...
    [ValidateSet('CreatedByResourceID', 'DeletedDateTime', 'NoteOrAttachmentTitle', 'EndDateTime', 'StartDateTime', 'ActivityDateTime', 'DeletedByResourceID', 'HoursWorked', 'TaskID', 'TypeID', 'TaskNumber', 'id')]
    [string[]]
    $NotEquals,
