...
# Type ID
    ...
    [ValidateSet('DeletedDateTime', 'id', 'EndDateTime', 'TypeID', 'DeletedByResourceID', 'NoteOrAttachmentTitle', 'TaskID', 'HoursWorked', 'CreatedByResourceID', 'ActivityDateTime', 'TaskNumber', 'StartDateTime')]
    [string[]]
    $NotEquals,
