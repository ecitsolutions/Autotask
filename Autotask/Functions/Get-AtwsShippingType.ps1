...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsShippingType.md')]
  Param
  (
...
# shipping_type_name
    ...
    [ValidateSet('AllocationCodeID', 'Description', 'id', 'IsActive', 'Name')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('AllocationCodeID', 'Description', 'id', 'Name')]
    [string[]]
    $GreaterThan,
