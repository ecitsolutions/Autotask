...
# Type ID
    ...
    [ValidateSet('TypeID', 'StartDateTime', 'ActivityDateTime', 'TicketNumber', 'DeletedByResourceID', 'TicketID', 'EndDateTime', 'id', 'CreatedByResourceID', 'HoursWorked', 'NoteOrAttachmentTitle', 'DeletedDateTime')]
    [string[]]
    $NotEquals,
