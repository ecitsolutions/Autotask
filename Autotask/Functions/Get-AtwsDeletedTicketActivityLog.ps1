...
# Type ID
    ...
    [ValidateSet('DeletedDateTime', 'TypeID', 'HoursWorked', 'StartDateTime', 'CreatedByResourceID', 'TicketNumber', 'id', 'TicketID', 'DeletedByResourceID', 'ActivityDateTime', 'EndDateTime', 'NoteOrAttachmentTitle')]
    [string[]]
    $NotEquals,
