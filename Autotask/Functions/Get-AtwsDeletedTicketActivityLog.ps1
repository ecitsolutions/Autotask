...
# Type ID
    ...
    [ValidateSet('TypeID', 'TicketNumber', 'TicketID', 'ActivityDateTime', 'DeletedByResourceID', 'DeletedDateTime', 'NoteOrAttachmentTitle', 'CreatedByResourceID', 'EndDateTime', 'StartDateTime', 'id', 'HoursWorked')]
    [string[]]
    $NotEquals,
