...
# Type ID
    ...
    [ValidateSet('TicketID', 'NoteOrAttachmentTitle', 'EndDateTime', 'StartDateTime', 'ActivityDateTime', 'id', 'DeletedByResourceID', 'HoursWorked', 'TypeID', 'DeletedDateTime', 'CreatedByResourceID', 'TicketNumber')]
    [string[]]
    $NotEquals,
