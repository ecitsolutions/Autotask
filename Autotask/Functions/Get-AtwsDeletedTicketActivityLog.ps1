...
# Type ID
    ...
    [ValidateSet('TicketID', 'id', 'DeletedByResourceID', 'TypeID', 'StartDateTime', 'DeletedDateTime', 'ActivityDateTime', 'HoursWorked', 'CreatedByResourceID', 'EndDateTime', 'NoteOrAttachmentTitle', 'TicketNumber')]
    [string[]]
    $NotEquals,
