...
# Ticket ID
    ...
    [ValidateSet('id', 'ResolutionPlanResourceID', 'FirstResponseInitiatingResourceID', 'ResolutionPlanMet', 'LastModifiedDateTime', 'LastModifiedByResourceID', 'FirstResponseMet', 'ResolutionMet', 'ServiceLevelAgreementName', 'ResolutionElapsedHours', 'CreateDateTime', 'TicketID', 'FirstResponseElapsedHours', 'FirstResponseResourceID', 'ResolutionResourceID', 'ResolutionPlanElapsedHours', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
