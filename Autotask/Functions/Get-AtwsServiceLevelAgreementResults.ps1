...
# Ticket ID
    ...
    [ValidateSet('CreatorResourceID', 'LastModifiedDateTime', 'id', 'ServiceLevelAgreementName', 'ResolutionResourceID', 'FirstResponseInitiatingResourceID', 'ResolutionElapsedHours', 'CreateDateTime', 'FirstResponseMet', 'TicketID', 'ResolutionMet', 'ResolutionPlanMet', 'ResolutionPlanResourceID', 'FirstResponseResourceID', 'FirstResponseElapsedHours', 'LastModifiedByResourceID', 'ResolutionPlanElapsedHours')]
    [string[]]
    $NotEquals,
