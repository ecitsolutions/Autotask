...
# WebServiceDate
    ...
    [ValidateSet('LineItemID', 'ProjectCostID', 'TotalAmount', 'LineItemFullDescription', 'id', 'InstalledProductID', 'AllocationCodeID', 'InternalCurrencyRate', 'Quantity', 'TaskID', 'OurCost', 'ExpenseItemID', 'ItemDate', 'SubType', 'VendorID', 'TimeEntryID', 'ServiceID', 'TaxDollars', 'LineItemGroupDescription', 'PostedOnTime', 'Description', 'PurchaseOrderNumber', 'Rate', 'WebServiceDate', 'PostedDate', 'BusinessDivisionSubdivisionID', 'ContractID', 'InvoiceID', 'ServiceBundleID', 'ProjectID', 'RoleID', 'AccountID', 'MilestoneID', 'AccountManagerWhenApprovedID', 'TicketID', 'TicketCostID', 'Type', 'InternalCurrencyTotalAmount', 'ExtendedPrice', 'NonBillable', 'ItemName', 'ContractCostID', 'ItemApproverID', 'InternalCurrencyTaxDollars', 'InternalCurrencyExtendedPrice')]
    [string[]]
    $NotEquals,
