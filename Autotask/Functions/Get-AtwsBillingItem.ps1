...
# WebServiceDate
    ...
    [ValidateSet('PurchaseOrderNumber', 'ProjectID', 'RoleID', 'AccountManagerWhenApprovedID', 'InternalCurrencyTotalAmount', 'InternalCurrencyRate', 'ServiceBundleID', 'ItemDate', 'TaxDollars', 'InvoiceID', 'ProjectCostID', 'VendorID', 'id', 'InternalCurrencyExtendedPrice', 'BusinessDivisionSubdivisionID', 'InternalCurrencyTaxDollars', 'ItemApproverID', 'LineItemFullDescription', 'TaskID', 'Quantity', 'LineItemGroupDescription', 'PostedDate', 'NonBillable', 'Rate', 'ExpenseItemID', 'SubType', 'InstalledProductID', 'TotalAmount', 'LineItemID', 'ItemName', 'TimeEntryID', 'OurCost', 'TicketID', 'ContractCostID', 'AccountID', 'AllocationCodeID', 'TicketCostID', 'Description', 'PostedOnTime', 'ContractID', 'WebServiceDate', 'Type', 'MilestoneID', 'ServiceID', 'ExtendedPrice')]
    [string[]]
    $NotEquals,
