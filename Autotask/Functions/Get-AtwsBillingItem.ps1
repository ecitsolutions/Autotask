...
# WebServiceDate
    ...
    [ValidateSet('TotalAmount', 'ItemDate', 'InternalCurrencyTaxDollars', 'ItemApproverID', 'ProjectID', 'TicketID', 'VendorID', 'TaxDollars', 'BusinessDivisionSubdivisionID', 'PostedDate', 'ProjectCostID', 'PostedOnTime', 'LineItemFullDescription', 'ServiceID', 'ItemName', 'AllocationCodeID', 'TimeEntryID', 'InternalCurrencyTotalAmount', 'ExpenseItemID', 'NonBillable', 'Type', 'ContractID', 'TicketCostID', 'Description', 'InternalCurrencyExtendedPrice', 'PurchaseOrderNumber', 'OurCost', 'ServiceBundleID', 'SubType', 'ExtendedPrice', 'InvoiceID', 'RoleID', 'TaskID', 'InstalledProductID', 'MilestoneID', 'InternalCurrencyRate', 'ContractCostID', 'LineItemID', 'WebServiceDate', 'AccountID', 'Rate', 'LineItemGroupDescription', 'AccountManagerWhenApprovedID', 'Quantity', 'id')]
    [string[]]
    $NotEquals,
