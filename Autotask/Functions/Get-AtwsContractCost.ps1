...
# Unit Quantity
    ...
    [ValidateSet('StatusLastModifiedBy', 'AllocationCodeID', 'Notes', 'BusinessDivisionSubdivisionID', 'InternalPurchaseOrderNumber', 'id', 'BillableToAccount', 'BillableAmount', 'ExtendedCost', 'StatusLastModifiedDate', 'DatePurchased', 'ProductID', 'CreateDate', 'UnitCost', 'Description', 'InternalCurrencyUnitPrice', 'UnitPrice', 'ContractID', 'ContractServiceID', 'InternalCurrencyBillableAmount', 'CreatorResourceID', 'UnitQuantity', 'Status', 'CostType', 'PurchaseOrderNumber', 'Name', 'ContractServiceBundleID', 'Billed')]
    [string[]]
    $NotEquals,
