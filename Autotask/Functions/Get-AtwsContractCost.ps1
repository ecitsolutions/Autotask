...
# Unit Quantity
    ...
    [ValidateSet('InternalPurchaseOrderNumber', 'Description', 'StatusLastModifiedBy', 'CreatorResourceID', 'Billed', 'UnitQuantity', 'ContractServiceID', 'BusinessDivisionSubdivisionID', 'ProductID', 'CreateDate', 'UnitCost', 'DatePurchased', 'ContractServiceBundleID', 'Name', 'UnitPrice', 'ContractID', 'InternalCurrencyBillableAmount', 'BillableToAccount', 'StatusLastModifiedDate', 'Notes', 'CostType', 'InternalCurrencyUnitPrice', 'BillableAmount', 'PurchaseOrderNumber', 'Status', 'id', 'AllocationCodeID', 'ExtendedCost')]
    [string[]]
    $NotEquals,
