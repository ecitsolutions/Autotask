...
# Unit Quantity
    ...
    [ValidateSet('InternalPurchaseOrderNumber', 'BusinessDivisionSubdivisionID', 'PurchaseOrderNumber', 'ExtendedCost', 'CreatorResourceID', 'id', 'CostType', 'CreateDate', 'Notes', 'DatePurchased', 'ProductID', 'ContractServiceID', 'Status', 'StatusLastModifiedBy', 'InternalCurrencyBillableAmount', 'StatusLastModifiedDate', 'UnitCost', 'InternalCurrencyUnitPrice', 'BillableAmount', 'Name', 'ContractServiceBundleID', 'Description', 'Billed', 'UnitPrice', 'BillableToAccount', 'AllocationCodeID', 'ContractID', 'UnitQuantity')]
    [Collections.Generic.List[string]]
    $NotEquals,
