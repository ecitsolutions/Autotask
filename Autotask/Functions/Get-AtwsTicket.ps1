...
# Ticket Title
    ...
    [ValidateSet('ChangeApprovalType', 'FirstResponseInitiatingResourceID', 'LastActivityDate', 'Status', 'Title', 'AccountPhysicalLocationID', 'ProblemTicketId', 'CompletedByResourceID', 'CreatorType', 'CreatorResourceID', 'Resolution', 'id', 'FirstResponseDueDateTime', 'Description', 'ChangeApprovalStatus', 'Source', 'PurchaseOrderNumber', 'ContractID', 'TicketNumber', 'ChangeInfoField2', 'OpportunityId', 'IssueType', 'ContractServiceBundleID', 'PreviousServiceThermometerRating', 'FirstResponseAssignedResourceID', 'CreatedByContactID', 'HoursToBeScheduled', 'ResolutionPlanDateTime', 'CreateDate', 'DueDateTime', 'ResolutionPlanDueDateTime', 'ChangeApprovalBoard', 'SubIssueType', 'ImpersonatorCreatorResourceID', 'BusinessDivisionSubdivisionID', 'AssignedResourceID', 'TicketCategory', 'ApiVendorID', 'AssignedResourceRoleID', 'RmaType', 'ResolvedDateTime', 'InstalledProductID', 'ProjectID', 'ChangeInfoField5', 'LastTrackedModificationDateTime', 'ServiceLevelAgreementHasBeenMet', 'ContractServiceID', 'AllocationCodeID', 'ServiceLevelAgreementID', 'MonitorTypeID', 'ChangeInfoField4', 'FirstResponseDateTime', 'LastCustomerVisibleActivityDateTime', 'ServiceThermometerTemperature', 'ResolvedDueDateTime', 'ContactID', 'LastCustomerNotificationDateTime', 'AEMAlertID', 'ServiceLevelAgreementPausedNextEventHours', 'MonitorID', 'ExternalID', 'ChangeInfoField3', 'LastActivityResourceID', 'AccountID', 'Priority', 'TicketType', 'ChangeInfoField1', 'CompletedDate', 'QueueID', 'CurrentServiceThermometerRating', 'EstimatedHours', 'RmaStatus', 'LastActivityPersonType', '')]
    [string[]]
    $NotEquals,
