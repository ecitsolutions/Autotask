...
# Ticket Title
    ...
    [ValidateSet('FirstResponseInitiatingResourceID', 'AssignedResourceRoleID', 'OpportunityId', 'AEMAlertID', 'ChangeInfoField4', 'ProblemTicketId', 'FirstResponseDateTime', 'ResolutionPlanDateTime', 'InstalledProductID', 'RmaStatus', 'ContractID', 'ChangeApprovalType', 'CompletedDate', 'LastCustomerVisibleActivityDateTime', 'MonitorID', 'CompletedByResourceID', 'LastActivityResourceID', 'ChangeInfoField5', 'LastTrackedModificationDateTime', 'ServiceThermometerTemperature', 'QueueID', 'HoursToBeScheduled', 'ResolvedDueDateTime', 'CurrentServiceThermometerRating', 'ContactID', 'SubIssueType', 'ChangeInfoField1', 'TicketCategory', 'Source', 'CreateDate', 'AllocationCodeID', 'MonitorTypeID', 'Title', 'ChangeApprovalStatus', 'BusinessDivisionSubdivisionID', 'id', 'PreviousServiceThermometerRating', 'DueDateTime', 'LastActivityDate', 'PurchaseOrderNumber', 'ExternalID', 'ResolvedDateTime', 'ServiceLevelAgreementHasBeenMet', 'CreatedByContactID', 'ContractServiceID', 'RmaType', 'FirstResponseDueDateTime', 'EstimatedHours', 'ResolutionPlanDueDateTime', 'TicketType', 'Description', 'TicketNumber', 'AccountPhysicalLocationID', 'CreatorResourceID', 'ServiceLevelAgreementPausedNextEventHours', 'FirstResponseAssignedResourceID', 'Priority', 'ChangeInfoField3', 'ChangeInfoField2', 'ApiVendorID', 'CreatorType', 'Resolution', 'ServiceLevelAgreementID', 'AccountID', 'ContractServiceBundleID', 'LastCustomerNotificationDateTime', 'ProjectID', 'ChangeApprovalBoard', 'AssignedResourceID', 'Status', 'LastActivityPersonType', 'ImpersonatorCreatorResourceID', 'IssueType', '')]
    [string[]]
    $NotEquals,
