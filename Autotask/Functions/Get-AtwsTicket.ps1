...
# Ticket Title
    ...
    [ValidateSet('MonitorTypeID', 'IssueType', 'CreatorResourceID', 'CreatorType', 'ChangeInfoField4', 'ResolvedDateTime', 'id', 'ExternalID', 'RmaStatus', 'RmaType', 'TicketNumber', 'Resolution', 'AccountPhysicalLocationID', 'FirstResponseDateTime', 'FirstResponseInitiatingResourceID', 'ContractServiceBundleID', 'OpportunityId', 'InstalledProductID', 'Source', 'AccountID', 'ServiceLevelAgreementHasBeenMet', 'ResolutionPlanDueDateTime', 'LastActivityResourceID', 'LastTrackedModificationDateTime', 'ServiceLevelAgreementID', 'AllocationCodeID', 'ProjectID', 'CreateDate', 'CompletedByResourceID', 'Description', 'Priority', 'PreviousServiceThermometerRating', 'EstimatedHours', 'Status', 'CompletedDate', 'ContractServiceID', 'MonitorID', 'AssignedResourceID', 'ServiceLevelAgreementPausedNextEventHours', 'ChangeInfoField1', 'Title', 'HoursToBeScheduled', 'DueDateTime', 'ApiVendorID', 'TicketCategory', 'LastActivityPersonType', 'ChangeApprovalStatus', 'TicketType', 'ContractID', 'BusinessDivisionSubdivisionID', 'ImpersonatorCreatorResourceID', 'ContactID', 'CreatedByContactID', 'LastActivityDate', 'ProblemTicketId', 'ServiceThermometerTemperature', 'ChangeInfoField2', 'ChangeInfoField3', 'SubIssueType', 'PurchaseOrderNumber', 'QueueID', 'FirstResponseAssignedResourceID', 'AssignedResourceRoleID', 'ChangeInfoField5', 'LastCustomerNotificationDateTime', 'CurrentServiceThermometerRating', 'ResolutionPlanDateTime', 'ChangeApprovalType', 'ChangeApprovalBoard', 'ResolvedDueDateTime', 'AEMAlertID', 'FirstResponseDueDateTime', 'LastCustomerVisibleActivityDateTime', '')]
    [string[]]
    $NotEquals,
