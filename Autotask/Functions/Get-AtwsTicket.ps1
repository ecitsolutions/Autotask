...
# Ticket Title
    ...
    [ValidateSet('OpportunityId', 'id', 'AllocationCodeID', 'LastTrackedModificationDateTime', 'Status', 'CurrentServiceThermometerRating', 'InstalledProductID', 'Title', 'TicketCategory', 'ResolvedDueDateTime', 'ExternalID', 'ServiceLevelAgreementID', 'RmaType', 'CreateDate', 'ResolutionPlanDateTime', 'FirstResponseDateTime', 'DueDateTime', 'ImpersonatorCreatorResourceID', 'ServiceLevelAgreementPausedNextEventHours', 'ChangeApprovalBoard', 'ProblemTicketId', 'FirstResponseDueDateTime', 'IssueType', 'Description', 'AEMAlertID', 'AssignedResourceID', 'ChangeInfoField1', 'LastActivityResourceID', 'ContractID', 'EstimatedHours', 'MonitorID', 'FirstResponseAssignedResourceID', 'ResolutionPlanDueDateTime', 'CreatedByContactID', 'AssignedResourceRoleID', 'ContractServiceBundleID', 'ServiceLevelAgreementHasBeenMet', 'LastActivityDate', 'Resolution', 'ContractServiceID', 'CompletedByResourceID', 'HoursToBeScheduled', 'ChangeApprovalStatus', 'ChangeInfoField4', 'ChangeInfoField5', 'PreviousServiceThermometerRating', 'ProjectID', 'CompletedDate', 'AccountID', 'ResolvedDateTime', 'ChangeInfoField3', 'Priority', 'CreatorResourceID', 'LastCustomerNotificationDateTime', 'ServiceThermometerTemperature', 'TicketType', 'ChangeApprovalType', 'SubIssueType', 'CreatorType', 'AccountPhysicalLocationID', 'LastCustomerVisibleActivityDateTime', 'TicketNumber', 'FirstResponseInitiatingResourceID', 'QueueID', 'Source', 'RmaStatus', 'MonitorTypeID', 'ApiVendorID', 'ContactID', 'BusinessDivisionSubdivisionID', 'PurchaseOrderNumber', 'ChangeInfoField2', 'LastActivityPersonType', '')]
    [string[]]
    $NotEquals,
