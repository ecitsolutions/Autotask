...
# Ticket Title
    ...
    [ValidateSet('Description', 'Status', 'LastCustomerNotificationDateTime', 'FirstResponseAssignedResourceID', 'CreatedByContactID', 'ContractServiceID', 'ChangeApprovalBoard', 'HoursToBeScheduled', 'RmaStatus', 'LastActivityPersonType', 'id', 'AccountPhysicalLocationID', 'CompletedDate', 'LastCustomerVisibleActivityDateTime', 'BusinessDivisionSubdivisionID', 'ProjectID', 'CurrentServiceThermometerRating', 'ExternalID', 'ChangeInfoField3', 'Source', 'TicketCategory', 'EstimatedHours', 'CreatorType', 'AllocationCodeID', 'ServiceLevelAgreementID', 'CreatorResourceID', 'MonitorID', 'QueueID', 'Title', 'DueDateTime', 'LastActivityDate', 'PreviousServiceThermometerRating', 'ResolutionPlanDueDateTime', 'TicketNumber', 'PurchaseOrderNumber', 'AssignedResourceID', 'MonitorTypeID', 'ChangeInfoField4', 'ResolvedDueDateTime', 'InstalledProductID', 'ChangeApprovalStatus', 'AccountID', 'SubIssueType', 'LastTrackedModificationDateTime', 'FirstResponseInitiatingResourceID', 'ProblemTicketId', 'ChangeApprovalType', 'OpportunityId', 'CompletedByResourceID', 'ApiVendorID', 'AssignedResourceRoleID', 'ChangeInfoField5', 'ContractServiceBundleID', 'Priority', 'ChangeInfoField2', 'ContactID', 'FirstResponseDateTime', 'ResolvedDateTime', 'ServiceLevelAgreementHasBeenMet', 'TicketType', 'ServiceThermometerTemperature', 'ImpersonatorCreatorResourceID', 'IssueType', 'RmaType', 'ServiceLevelAgreementPausedNextEventHours', 'Resolution', 'AEMAlertID', 'ContractID', 'FirstResponseDueDateTime', 'CreateDate', 'ChangeInfoField1', 'LastActivityResourceID', 'ResolutionPlanDateTime', '')]
    [string[]]
    $NotEquals,
