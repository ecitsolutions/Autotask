...
#>
Function Remove-AtwsInstalledProductWebhookExcludedResource
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsInstalledProductWebhookExcludedResource.md')]
  Param
  (
