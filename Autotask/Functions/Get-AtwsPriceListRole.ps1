...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsPriceListRole.md')]
  Param
  (
...
# Uses Internal Currency Price
    ...
    [ValidateSet('CurrencyID', 'HourlyRate', 'id', 'RoleID', 'UsesInternalCurrencyPrice')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('CurrencyID', 'HourlyRate', 'id', 'RoleID')]
    [string[]]
    $GreaterThan,
