...
# Time Entry
    ...
    [ValidateSet('id', 'RecipientDisplayName', 'OpportunityID', 'TemplateName', 'EntityNumber', 'NotificationSentTime', 'InitiatingResourceID', 'AccountID', 'TimeEntryID', 'TaskID', 'IsActive', 'EntityTitle', 'IsTemplateJob', 'ProjectID', 'IsDeleted', 'RecipientEmailAddress', 'InitiatingContactID', 'QuoteID', 'TicketID', 'NotificationHistoryTypeID')]
    [string[]]
    $NotEquals,
