...
# Time Entry
    ...
    [ValidateSet('RecipientDisplayName', 'IsTemplateJob', 'IsDeleted', 'EntityNumber', 'InitiatingResourceID', 'TimeEntryID', 'IsActive', 'AccountID', 'NotificationSentTime', 'ProjectID', 'OpportunityID', 'TicketID', 'id', 'TaskID', 'RecipientEmailAddress', 'NotificationHistoryTypeID', 'TemplateName', 'EntityTitle', 'QuoteID', 'InitiatingContactID')]
    [string[]]
    $NotEquals,
