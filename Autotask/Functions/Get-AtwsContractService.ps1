...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsContractService.md')]
  Param
  (
...
# Unit Price
    ...
    [ValidateSet('AdjustedPrice', 'ContractID', 'id', 'InternalCurrencyAdjustedPrice', 'InternalCurrencyUnitPrice', 'InternalDescription', 'InvoiceDescription', 'QuoteItemID', 'ServiceID', 'UnitCost', 'UnitPrice')]
    [string[]]
    $NotEquals,
