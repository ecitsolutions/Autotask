...
# Unit Price
    ...
    [ValidateSet('ServiceID', 'UnitCost', 'id', 'InvoiceDescription', 'QuoteItemID', 'UnitPrice', 'InternalCurrencyAdjustedPrice', 'AdjustedPrice', 'InternalDescription', 'ContractID', 'InternalCurrencyUnitPrice')]
    [string[]]
    $NotEquals,
