...
# Unit Price
    ...
    [ValidateSet('AdjustedPrice', 'InternalCurrencyAdjustedPrice', 'id', 'InternalDescription', 'InvoiceDescription', 'ContractID', 'InternalCurrencyUnitPrice', 'UnitCost', 'QuoteItemID', 'ServiceID', 'UnitPrice')]
    [string[]]
    $NotEquals,
