...
# Unit Price
    ...
    [ValidateSet('InvoiceDescription', 'UnitPrice', 'InternalCurrencyUnitPrice', 'QuoteItemID', 'UnitCost', 'AdjustedPrice', 'ContractID', 'ServiceID', 'id', 'InternalCurrencyAdjustedPrice', 'InternalDescription')]
    [string[]]
    $NotEquals,
