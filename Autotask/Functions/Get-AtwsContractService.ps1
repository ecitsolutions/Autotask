...
# Unit Price
    ...
    [ValidateSet('UnitCost', 'InvoiceDescription', 'ServiceID', 'ContractID', 'InternalDescription', 'UnitPrice', 'AdjustedPrice', 'QuoteItemID', 'InternalCurrencyUnitPrice', 'id', 'InternalCurrencyAdjustedPrice')]
    [string[]]
    $NotEquals,
