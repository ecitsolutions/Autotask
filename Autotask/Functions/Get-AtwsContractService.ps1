...
# Unit Price
    ...
    [ValidateSet('InternalDescription', 'QuoteItemID', 'InternalCurrencyUnitPrice', 'ContractID', 'id', 'ServiceID', 'AdjustedPrice', 'UnitPrice', 'InternalCurrencyAdjustedPrice', 'UnitCost', 'InvoiceDescription')]
    [Collections.Generic.List[string]]
    $NotEquals,
