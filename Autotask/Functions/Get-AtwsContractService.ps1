...
# Unit Price
    ...
    [ValidateSet('id', 'UnitCost', 'UnitPrice', 'AdjustedPrice', 'InternalCurrencyUnitPrice', 'ServiceID', 'InvoiceDescription', 'InternalCurrencyAdjustedPrice', 'InternalDescription', 'QuoteItemID', 'ContractID')]
    [string[]]
    $NotEquals,
