...
# Unit Price
    ...
    [ValidateSet('id', 'UnitCost', 'ServiceID', 'AdjustedPrice', 'InternalDescription', 'InternalCurrencyAdjustedPrice', 'InvoiceDescription', 'ContractID', 'QuoteItemID', 'InternalCurrencyUnitPrice', 'UnitPrice')]
    [string[]]
    $NotEquals,
