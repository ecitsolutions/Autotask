...
# Unit Price
    ...
    [ValidateSet('id', 'ServiceID', 'UnitCost', 'ContractID', 'UnitPrice', 'InternalDescription', 'InternalCurrencyAdjustedPrice', 'AdjustedPrice', 'InternalCurrencyUnitPrice', 'InvoiceDescription', 'QuoteItemID')]
    [string[]]
    $NotEquals,
