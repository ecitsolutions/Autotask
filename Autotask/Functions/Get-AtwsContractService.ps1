...
# Unit Price
    ...
    [ValidateSet('InternalDescription', 'UnitCost', 'ServiceID', 'UnitPrice', 'ContractID', 'InternalCurrencyUnitPrice', 'InternalCurrencyAdjustedPrice', 'id', 'InvoiceDescription', 'QuoteItemID', 'AdjustedPrice')]
    [string[]]
    $NotEquals,
