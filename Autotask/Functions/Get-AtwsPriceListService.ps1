...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsPriceListService.md')]
  Param
  (
...
# Uses Internal Currency Price
    ...
    [ValidateSet('CurrencyID', 'id', 'ServiceID', 'UnitPrice', 'UsesInternalCurrencyPrice')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('CurrencyID', 'id', 'ServiceID', 'UnitPrice')]
    [string[]]
    $GreaterThan,
