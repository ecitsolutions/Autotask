...
# Vendor Invoice Number
    ...
    [ValidateSet('VendorID', 'InternalCurrencyFreight', 'SubmitDateTime', 'ShipToName', 'ImpersonatorCreatorResourceID', 'ShipToAddress1', 'PaymentTerm', 'UseItemDescriptionsFrom', 'ShowEachTaxInGroup', 'id', 'ShippingDate', 'CancelDateTime', 'ShippingType', 'Freight', 'Fax', 'ShipToState', 'ShipToAddress2', 'PurchaseForAccountID', 'PurchaseOrderTemplateID', 'VendorInvoiceNumber', 'CreatorResourceID', 'Phone', 'ShowTaxCategory', 'GeneralMemo', 'Status', 'CreateDateTime', 'ShipToPostalCode', 'TaxGroup', 'PurchaseOrderNumber', 'ShipToCity', 'ExternalPONumber', 'LatestEstimatedArrivalDate')]
    [string[]]
    $NotEquals,
