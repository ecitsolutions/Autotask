...
# Vendor Invoice Number
    ...
    [ValidateSet('ShowTaxCategory', 'TaxGroup', 'ShipToAddress2', 'ImpersonatorCreatorResourceID', 'GeneralMemo', 'ShippingType', 'CreatorResourceID', 'Fax', 'ShipToName', 'ShipToPostalCode', 'Status', 'Phone', 'UseItemDescriptionsFrom', 'ShipToState', 'ShippingDate', 'InternalCurrencyFreight', 'ShowEachTaxInGroup', 'id', 'Freight', 'LatestEstimatedArrivalDate', 'ShipToCity', 'ShipToAddress1', 'CreateDateTime', 'SubmitDateTime', 'PurchaseForAccountID', 'VendorID', 'CancelDateTime', 'ExternalPONumber', 'VendorInvoiceNumber', 'PaymentTerm')]
    [string[]]
    $NotEquals,
