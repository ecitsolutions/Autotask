...
#>
Function New-AtwsServiceCallTaskResource
{
...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the ServiceCallTaskResource with Id number 0 you could write 'New-AtwsServiceCallTaskResource -Id 0' or you could write 'New-AtwsServiceCallTaskResource -Filter {Id -eq 0}.

'New-AtwsServiceCallTaskResource -Id 0,4' could be written as 'New-AtwsServiceCallTaskResource -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/New-AtwsServiceCallTaskResource.md')]
  Param
  (
