...
# Reserved
    ...
    [ValidateSet('ImpersonatorCreatorResourceID', 'Reserved', 'ReferenceNumber', 'Bin', 'InventoryLocationID', 'QuantityMinimum', 'QuantityMaximum', 'id', 'BackOrder', 'Picked', 'OnOrder', 'ProductID', 'QuantityOnHand')]
    [string[]]
    $NotEquals,
