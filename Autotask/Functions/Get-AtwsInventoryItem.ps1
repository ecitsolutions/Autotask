...
# Reserved
    ...
    [ValidateSet('QuantityMaximum', 'OnOrder', 'Reserved', 'id', 'ImpersonatorCreatorResourceID', 'Picked', 'ProductID', 'ReferenceNumber', 'BackOrder', 'QuantityOnHand', 'Bin', 'InventoryLocationID', 'QuantityMinimum')]
    [string[]]
    $NotEquals,
