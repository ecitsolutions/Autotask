...
# Reserved
    ...
    [ValidateSet('QuantityMaximum', 'QuantityMinimum', 'InventoryLocationID', 'Reserved', 'BackOrder', 'OnOrder', 'ProductID', 'QuantityOnHand', 'Picked', 'id', 'ImpersonatorCreatorResourceID', 'ReferenceNumber', 'Bin')]
    [string[]]
    $NotEquals,
