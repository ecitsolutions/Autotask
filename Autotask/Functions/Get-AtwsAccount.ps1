...
# Web
    ...
    [ValidateSet('LastActivityDate', 'ClientPortalActive', 'TaxID', 'id', 'CreatedByResourceID', 'Country', 'TaskFireActive', 'City', 'BillToAccountPhysicalLocationID', 'InvoiceMethod', 'Active', 'BillToAttention', 'AccountNumber', 'BillToAddress1', 'PostalCode', 'AlternatePhone1', 'AccountType', 'QuoteTemplateID', 'CreateDate', 'BillToAdditionalAddressInformation', 'TaxRegionID', 'MarketSegmentID', 'OwnerResourceID', 'CurrencyID', 'BillToZipCode', 'BillToAddressToUse', 'EnabledForComanaged', 'ImpersonatorCreatorResourceID', 'WebAddress', 'AssetValue', 'LastTrackedModifiedDateTime', 'Phone', 'InvoiceTemplateID', 'ParentAccountID', 'TaxExempt', 'BillToCountryID', 'InvoiceNonContractItemsToParentAccount', 'BillToAddress2', 'SICCode', 'CountryID', 'AlternatePhone2', 'SurveyAccountRating', 'AdditionalAddressInformation', 'BillToCity', 'StockMarket', 'CompetitorID', 'KeyAccountIcon', 'InvoiceEmailMessageID', 'Address2', 'QuoteEmailMessageID', 'Fax', 'StockSymbol', 'ApiVendorID', 'Address1', 'AccountName', 'TerritoryID', 'State', 'BillToState', '')]
    [string[]]
    $NotEquals,
