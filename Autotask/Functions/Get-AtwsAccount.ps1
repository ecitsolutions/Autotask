...
# Web
    ...
    [ValidateSet('BillToZipCode', 'QuoteTemplateID', 'AccountNumber', 'Country', 'QuoteEmailMessageID', 'InvoiceNonContractItemsToParentAccount', 'WebAddress', 'TaxID', 'BillToAttention', 'InvoiceTemplateID', 'CreatedByResourceID', 'Active', 'Address1', 'AccountType', 'BillToCountryID', 'TerritoryID', 'AlternatePhone2', 'State', 'SICCode', 'CountryID', 'BillToCity', 'id', 'LastTrackedModifiedDateTime', 'Address2', 'OwnerResourceID', 'BillToAddressToUse', 'ApiVendorID', 'EnabledForComanaged', 'ImpersonatorCreatorResourceID', 'BillToAddress2', 'PostalCode', 'BillToState', 'AdditionalAddressInformation', 'TaskFireActive', 'SurveyAccountRating', 'TaxRegionID', 'TaxExempt', 'BillToAddress1', 'ClientPortalActive', 'CompetitorID', 'City', 'InvoiceEmailMessageID', 'KeyAccountIcon', 'BillToAccountPhysicalLocationID', 'CurrencyID', 'Phone', 'AlternatePhone1', 'InvoiceMethod', 'Fax', 'AccountName', 'StockSymbol', 'CreateDate', 'MarketSegmentID', 'StockMarket', 'BillToAdditionalAddressInformation', 'LastActivityDate', 'ParentAccountID', 'AssetValue', '')]
    [string[]]
    $NotEquals,
