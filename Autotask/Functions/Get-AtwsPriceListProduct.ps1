...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsPriceListProduct.md')]
  Param
  (
...
# Uses Internal Currency Price
    ...
    [ValidateSet('CurrencyID', 'id', 'ProductID', 'UnitPrice', 'UsesInternalCurrencyPrice')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('CurrencyID', 'id', 'ProductID', 'UnitPrice')]
    [string[]]
    $GreaterThan,
