...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsChecklistLibrary.md')]
  Param
  (
...
# Name
    ...
    [ValidateSet('Active', 'Description', 'EntityType', 'id', 'Name')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('Description', 'EntityType', 'id', 'Name')]
    [string[]]
    $GreaterThan,
