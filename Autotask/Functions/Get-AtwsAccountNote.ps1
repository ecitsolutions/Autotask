...
# StartDate
    ...
    [ValidateSet('OpportunityID', 'ImpersonatorCreatorResourceID', 'AssignedResourceID', 'StartDateTime', 'EndDateTime', 'Note', 'LastModifiedDate', 'AccountID', 'ImpersonatorUpdaterResourceID', 'ActionType', 'CompletedDateTime', 'id', 'Name', 'ContactID', 'CreateDateTime')]
    [string[]]
    $NotEquals,
