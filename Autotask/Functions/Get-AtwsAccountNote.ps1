...
# StartDate
    ...
    [ValidateSet('ImpersonatorUpdaterResourceID', 'EndDateTime', 'id', 'Note', 'AccountID', 'LastModifiedDate', 'ImpersonatorCreatorResourceID', 'CreateDateTime', 'CompletedDateTime', 'StartDateTime', 'Name', 'OpportunityID', 'AssignedResourceID', 'ActionType', 'ContactID')]
    [string[]]
    $NotEquals,
