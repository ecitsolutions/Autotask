...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the Holiday with Id number 0 you could write 'New-AtwsHoliday -Id 0' or you could write 'New-AtwsHoliday -Filter {Id -eq 0}.

'New-AtwsHoliday -Id 0,4' could be written as 'New-AtwsHoliday -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
Copies [Autotask.Holiday] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-AtwsHoliday -Id 124 | New-AtwsHoliday | Set-AtwsHoliday -ParameterName <Parameter Value>
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/New-AtwsHoliday.md')]
  Param
  (
