...
# Title
    ...
    [ValidateSet('Title', 'CreateDateTime', 'Description', 'id', 'ImpersonatorCreatorResourceID', 'NoteType', 'InstalledProductID', 'LastActivityDate', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
