...
# Title
    ...
    [ValidateSet('CreatorResourceID', 'Description', 'ImpersonatorUpdaterResourceID', 'CreateDateTime', 'id', 'Title', 'LastActivityDate', 'InstalledProductID', 'ImpersonatorCreatorResourceID', 'NoteType')]
    [string[]]
    $NotEquals,
