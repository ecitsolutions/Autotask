...
# Title
    ...
    [ValidateSet('Description', 'LastActivityDate', 'NoteType', 'Title', 'ImpersonatorUpdaterResourceID', 'InstalledProductID', 'ImpersonatorCreatorResourceID', 'id', 'CreateDateTime', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
