...
# Title
    ...
    [ValidateSet('id', 'NoteType', 'Title', 'ImpersonatorUpdaterResourceID', 'LastActivityDate', 'CreateDateTime', 'ImpersonatorCreatorResourceID', 'InstalledProductID', 'Description', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
