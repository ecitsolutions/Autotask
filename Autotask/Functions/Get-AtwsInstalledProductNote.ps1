...
# Title
    ...
    [ValidateSet('InstalledProductID', 'LastActivityDate', 'NoteType', 'Title', 'ImpersonatorUpdaterResourceID', 'Description', 'id', 'CreatorResourceID', 'CreateDateTime', 'ImpersonatorCreatorResourceID')]
    [string[]]
    $NotEquals,
