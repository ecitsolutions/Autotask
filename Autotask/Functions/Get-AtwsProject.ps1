...
# Type
    ...
    [ValidateSet('LaborEstimatedMarginPercentage', 'ProjectCostEstimatedMarginPercentage', 'id', 'LaborEstimatedCosts', 'ProjectCostsBudget', 'ProjectCostsRevenue', 'LastActivityResourceID', 'LaborEstimatedRevenue', 'StatusDetail', 'CompanyOwnerResourceID', 'ChangeOrdersRevenue', 'ActualHours', 'LastActivityPersonType', 'OriginalEstimatedRevenue', 'EndDateTime', 'BusinessDivisionSubdivisionID', 'Description', 'ActualBilledHours', 'CreatorResourceID', 'Status', 'ChangeOrdersBudget', 'ProjectName', 'ContractID', 'StatusDateTime', 'EstimatedSalesCost', 'CreateDateTime', 'ImpersonatorCreatorResourceID', 'Duration', 'ProjectLeadResourceID', 'ProjectNumber', 'AccountID', 'LineOfBusiness', 'OpportunityID', 'CompletedPercentage', 'ExtPNumber', 'LastActivityDateTime', 'Type', 'ExtProjectType', 'EstimatedTime', 'SGDA', 'Department', 'PurchaseOrderNumber', 'CompletedDateTime', 'StartDateTime')]
    [string[]]
    $NotEquals,
