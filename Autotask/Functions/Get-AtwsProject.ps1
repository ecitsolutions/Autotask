...
# Type
    ...
    [ValidateSet('EstimatedTime', 'LastActivityResourceID', 'CompletedDateTime', 'ProjectCostsBudget', 'LaborEstimatedRevenue', 'ContractID', 'EstimatedSalesCost', 'ChangeOrdersBudget', 'OriginalEstimatedRevenue', 'StatusDetail', 'Duration', 'id', 'BusinessDivisionSubdivisionID', 'LaborEstimatedCosts', 'PurchaseOrderNumber', 'ProjectName', 'OpportunityID', 'ImpersonatorCreatorResourceID', 'ChangeOrdersRevenue', 'CreateDateTime', 'Department', 'ProjectNumber', 'ActualHours', 'ExtProjectType', 'LaborEstimatedMarginPercentage', 'CompanyOwnerResourceID', 'ProjectCostsRevenue', 'StatusDateTime', 'Status', 'ExtPNumber', 'ProjectLeadResourceID', 'ActualBilledHours', 'ProjectCostEstimatedMarginPercentage', 'CreatorResourceID', 'AccountID', 'SGDA', 'LastActivityDateTime', 'Description', 'LastActivityPersonType', 'LineOfBusiness', 'CompletedPercentage', 'StartDateTime', 'Type', 'EndDateTime')]
    [string[]]
    $NotEquals,
