...
# Type
    ...
    [ValidateSet('ProjectCostsRevenue', 'BusinessDivisionSubdivisionID', 'ExtProjectType', 'LaborEstimatedRevenue', 'ProjectCostsBudget', 'StatusDateTime', 'id', 'ChangeOrdersBudget', 'ChangeOrdersRevenue', 'PurchaseOrderNumber', 'Department', 'ActualBilledHours', 'StatusDetail', 'ProjectName', 'SGDA', 'AccountID', 'ProjectLeadResourceID', 'Status', 'CompletedPercentage', 'ProjectNumber', 'Type', 'LaborEstimatedCosts', 'OpportunityID', 'EndDateTime', 'CompanyOwnerResourceID', 'CreateDateTime', 'LineOfBusiness', 'CompletedDateTime', 'EstimatedSalesCost', 'Description', 'StartDateTime', 'EstimatedTime', 'LastActivityResourceID', 'LaborEstimatedMarginPercentage', 'ContractID', 'LastActivityPersonType', 'ActualHours', 'ExtPNumber', 'OriginalEstimatedRevenue', 'CreatorResourceID', 'ProjectCostEstimatedMarginPercentage', 'Duration', 'ImpersonatorCreatorResourceID', 'LastActivityDateTime')]
    [string[]]
    $NotEquals,
