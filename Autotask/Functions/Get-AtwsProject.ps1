...
# Type
    ...
    [ValidateSet('EndDateTime', 'CompanyOwnerResourceID', 'Duration', 'ProjectCostsBudget', 'CreateDateTime', 'Department', 'ActualHours', 'CreatorResourceID', 'CompletedDateTime', 'ProjectNumber', 'ActualBilledHours', 'ProjectCostEstimatedMarginPercentage', 'Type', 'ProjectLeadResourceID', 'LaborEstimatedCosts', 'ProjectCostsRevenue', 'Description', 'EstimatedSalesCost', 'ExtProjectType', 'Status', 'PurchaseOrderNumber', 'StatusDateTime', 'CompletedPercentage', 'ChangeOrdersBudget', 'LastActivityPersonType', 'LastActivityResourceID', 'LastActivityDateTime', 'LaborEstimatedMarginPercentage', 'EstimatedTime', 'OpportunityID', 'LineOfBusiness', 'StatusDetail', 'LaborEstimatedRevenue', 'ProjectName', 'SGDA', 'AccountID', 'OriginalEstimatedRevenue', 'StartDateTime', 'BusinessDivisionSubdivisionID', 'ChangeOrdersRevenue', 'ContractID', 'ImpersonatorCreatorResourceID', 'ExtPNumber', 'id')]
    [string[]]
    $NotEquals,
