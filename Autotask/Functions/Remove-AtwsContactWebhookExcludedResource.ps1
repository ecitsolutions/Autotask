...
#>
Function Remove-AtwsContactWebhookExcludedResource
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsContactWebhookExcludedResource.md')]
  Param
  (
