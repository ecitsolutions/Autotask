...
# Unit Quantity
    ...
    [ValidateSet('InternalPurchaseOrderNumber', 'Description', 'StatusLastModifiedBy', 'CreatorResourceID', 'Billed', 'UnitQuantity', 'ContractServiceID', 'BusinessDivisionSubdivisionID', 'ProductID', 'InternalCurrencyUnitPrice', 'CreateDate', 'DatePurchased', 'ContractServiceBundleID', 'Name', 'UnitPrice', 'InternalCurrencyBillableAmount', 'ProjectID', 'BillableToAccount', 'StatusLastModifiedDate', 'Notes', 'CostType', 'UnitCost', 'BillableAmount', 'PurchaseOrderNumber', 'Status', 'id', 'AllocationCodeID', 'ExtendedCost', 'EstimatedCost')]
    [string[]]
    $NotEquals,
