...
# Phase Title
    ...
    [ValidateSet('PhaseNumber', 'LastActivityDateTime', 'Scheduled', 'StartDate', 'ParentPhaseID', 'Title', 'CreateDate', 'EstimatedHours', 'id', 'DueDate', 'Description', 'CreatorResourceID', 'ProjectID', 'ExternalID')]
    [string[]]
    $NotEquals,
