...
# Phase Title
    ...
    [ValidateSet('ParentPhaseID', 'Description', 'Scheduled', 'EstimatedHours', 'ExternalID', 'LastActivityDateTime', 'CreateDate', 'ProjectID', 'id', 'CreatorResourceID', 'DueDate', 'PhaseNumber', 'Title', 'StartDate')]
    [string[]]
    $NotEquals,
