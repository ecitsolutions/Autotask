...
# Phase Title
    ...
    [ValidateSet('StartDate', 'CreateDate', 'PhaseNumber', 'LastActivityDateTime', 'Scheduled', 'ParentPhaseID', 'DueDate', 'CreatorResourceID', 'Title', 'ExternalID', 'id', 'EstimatedHours', 'Description', 'ProjectID')]
    [string[]]
    $NotEquals,
