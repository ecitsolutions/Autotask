...
# Phase Title
    ...
    [ValidateSet('CreatorResourceID', 'id', 'Description', 'ParentPhaseID', 'ProjectID', 'EstimatedHours', 'DueDate', 'CreateDate', 'Title', 'ExternalID', 'StartDate', 'LastActivityDateTime', 'Scheduled', 'PhaseNumber')]
    [string[]]
    $NotEquals,
