...
# Work Type ID
    ...
    [ValidateSet('EstimatedHours', 'Description', 'BusinessDivisionSubdivisionID', 'TicketTypeID', 'IssueTypeID', 'Priority', 'SubIssueTypeID', 'Status', 'id', 'QueueID', 'Resolution', 'ServiceLevelAgreementID', 'WorkTypeID', 'TicketCategoryID', 'PurchaseOrderNumber', 'SourceID', 'Title')]
    [string[]]
    $NotEquals,
