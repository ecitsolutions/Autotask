...
# tax_region_id
    ...
    [ValidateSet('Comment', 'TaxGroup', 'ExternalQuoteNumber', 'PrimaryQuote', 'Name', 'LastModifiedBy', 'ApprovalStatusChangedByResourceID', 'ProposalProjectID', 'CreatorResourceID', 'ApprovalStatus', 'AccountID', 'ExtApprovalResponseSignature', 'QuoteTemplateID', 'ContactID', 'ShipToLocationID', 'eQuoteActive', 'BillToLocationID', 'LastActivityDate', 'QuoteNumber', 'GroupByID', 'ApprovalStatusChangedDate', 'ShowEachTaxInGroup', 'id', 'SoldToLocationID', 'ExpirationDate', 'CreateDate', 'PurchaseOrderNumber', 'CalculateTaxSeparately', 'ShippingType', 'EffectiveDate', 'ExtApprovalResponseDate', 'ExtApprovalContactResponse', 'Description', 'GroupByProductCategory', 'PaymentType', 'ImpersonatorCreatorResourceID', 'PaymentTerm', 'OpportunityID', 'ShowTaxCategory')]
    [string[]]
    $NotEquals,
