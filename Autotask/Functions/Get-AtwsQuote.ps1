...
# tax_region_id
    ...
    [ValidateSet('QuoteTemplateID', 'ShipToLocationID', 'TaxGroup', 'ShowEachTaxInGroup', 'LastModifiedBy', 'Description', 'ApprovalStatusChangedByResourceID', 'CreatorResourceID', 'GroupByProductCategory', 'PrimaryQuote', 'id', 'OpportunityID', 'Comment', 'Name', 'QuoteNumber', 'ApprovalStatusChangedDate', 'CreateDate', 'AccountID', 'eQuoteActive', 'LastActivityDate', 'ExtApprovalContactResponse', 'GroupByID', 'ContactID', 'ExpirationDate', 'BillToLocationID', 'ImpersonatorCreatorResourceID', 'ProposalProjectID', 'EffectiveDate', 'CalculateTaxSeparately', 'ShowTaxCategory', 'ExternalQuoteNumber', 'PaymentType', 'SoldToLocationID', 'ExtApprovalResponseDate', 'ExtApprovalResponseSignature', 'PurchaseOrderNumber', 'ShippingType', 'ApprovalStatus', 'PaymentTerm')]
    [string[]]
    $NotEquals,
