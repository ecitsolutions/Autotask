...
# Udf Type
    ...
    [ValidateSet('IsRequired', 'IsActive', 'IsProtected', 'id', 'SortOrder', 'Description', 'CrmToProjectUdfId', 'Name', 'MergeVariableName', 'NumberOfDecimalPlaces', 'DataType', 'IsPrivate', 'CreateDate', 'DisplayFormat', 'IsVisibleToClientPortal', 'UdfType', 'IsFieldMapping', 'DefaultValue', 'IsEncrypted')]
    [string[]]
    $NotEquals,
