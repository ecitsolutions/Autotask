...
# Udf Type
    ...
    [ValidateSet('Description', 'Name', 'IsFieldMapping', 'DefaultValue', 'SortOrder', 'IsEncrypted', 'CreateDate', 'IsActive', 'IsPrivate', 'IsProtected', 'id', 'IsVisibleToClientPortal', 'NumberOfDecimalPlaces', 'IsRequired', 'CrmToProjectUdfId', 'MergeVariableName', 'DataType', 'UdfType', 'DisplayFormat')]
    [string[]]
    $NotEquals,
