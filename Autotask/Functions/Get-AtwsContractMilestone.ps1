...
# Title
    ...
    [ValidateSet('id', 'DateDue', 'Description', 'Title', 'CreateDate', 'IsInitialPayment', 'InternalCurrencyAmount', 'Amount', 'Status', 'BusinessDivisionSubdivisionID', 'ContractID', 'AllocationCodeID', 'CreatorResourceID')]
    [string[]]
    $NotEquals,
