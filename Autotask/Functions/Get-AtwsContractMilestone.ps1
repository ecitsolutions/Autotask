...
# Title
    ...
    [ValidateSet('CreatorResourceID', 'id', 'Description', 'InternalCurrencyAmount', 'Status', 'AllocationCodeID', 'IsInitialPayment', 'CreateDate', 'Title', 'DateDue', 'BusinessDivisionSubdivisionID', 'Amount', 'ContractID')]
    [string[]]
    $NotEquals,
