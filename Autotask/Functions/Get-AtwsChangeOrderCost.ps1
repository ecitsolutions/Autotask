...
# Unit Quantity
    ...
    [ValidateSet('StatusLastModifiedBy', 'Notes', 'BusinessDivisionSubdivisionID', 'InternalPurchaseOrderNumber', 'ChangeOrderHours', 'AllocationCodeID', 'BillableToAccount', 'BillableAmount', 'ExtendedCost', 'StatusLastModifiedDate', 'DatePurchased', 'TaskID', 'ProductID', 'id', 'CreateDate', 'UnitCost', 'Description', 'InternalCurrencyUnitPrice', 'UnitPrice', 'ContractServiceID', 'InternalCurrencyBillableAmount', 'CreatorResourceID', 'UnitQuantity', 'Status', 'CostType', 'PurchaseOrderNumber', 'Name', 'ContractServiceBundleID', 'Billed')]
    [string[]]
    $NotEquals,
