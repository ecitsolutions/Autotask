...
# Unit Quantity
    ...
    [ValidateSet('InternalCurrencyUnitPrice', 'DatePurchased', 'InternalPurchaseOrderNumber', 'StatusLastModifiedDate', 'Name', 'CreatorResourceID', 'BusinessDivisionSubdivisionID', 'StatusLastModifiedBy', 'Status', 'CostType', 'UnitQuantity', 'BillableAmount', 'ProductID', 'ContractServiceID', 'id', 'UnitCost', 'CreateDate', 'PurchaseOrderNumber', 'ExtendedCost', 'AllocationCodeID', 'Notes', 'Description', 'InternalCurrencyBillableAmount', 'Billed', 'ContractServiceBundleID', 'BillableToAccount', 'TaskID', 'ChangeOrderHours', 'UnitPrice')]
    [string[]]
    $NotEquals,
