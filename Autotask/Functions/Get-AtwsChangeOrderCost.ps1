...
# Unit Quantity
    ...
    [ValidateSet('CreateDate', 'InternalPurchaseOrderNumber', 'Description', 'StatusLastModifiedBy', 'CreatorResourceID', 'ChangeOrderHours', 'Billed', 'ExtendedCost', 'UnitQuantity', 'TaskID', 'ContractServiceID', 'ProductID', 'Name', 'UnitCost', 'DatePurchased', 'ContractServiceBundleID', 'BusinessDivisionSubdivisionID', 'UnitPrice', 'BillableToAccount', 'StatusLastModifiedDate', 'Notes', 'CostType', 'InternalCurrencyUnitPrice', 'BillableAmount', 'PurchaseOrderNumber', 'Status', 'id', 'AllocationCodeID', 'InternalCurrencyBillableAmount')]
    [string[]]
    $NotEquals,
