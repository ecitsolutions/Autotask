...
#>
Function New-AtwsServiceCallTask
{
...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the ServiceCallTask with Id number 0 you could write 'New-AtwsServiceCallTask -Id 0' or you could write 'New-AtwsServiceCallTask -Filter {Id -eq 0}.

'New-AtwsServiceCallTask -Id 0,4' could be written as 'New-AtwsServiceCallTask -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
Copies [Autotask.ServiceCallTask] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-AtwsServiceCallTask -Id 124 | New-AtwsServiceCallTask | Set-AtwsServiceCallTask -ParameterName 'Parameter Value'
Copies [Autotask.ServiceCallTask] by Id 124 to a new object through the Web Services API, passes the new object to the Set-AtwsServiceCallTask to modify the object.
 .EXAMPLE
$result = Get-AtwsServiceCallTask -Id 124 | New-AtwsServiceCallTask | Set-AtwsServiceCallTask -ParameterName 'Parameter Value' -Passthru
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/New-AtwsServiceCallTask.md')]
  Param
  (
