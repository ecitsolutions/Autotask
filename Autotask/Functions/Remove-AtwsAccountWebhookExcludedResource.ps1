...
#>
Function Remove-AtwsAccountWebhookExcludedResource
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsAccountWebhookExcludedResource.md')]
  Param
  (
