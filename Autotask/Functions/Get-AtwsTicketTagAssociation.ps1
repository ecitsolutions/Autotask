...
#>
Function Get-AtwsTicketTagAssociation
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsTicketTagAssociation.md')]
  Param
  (
