...
# Web Service Use Date
    ...
    [ValidateSet('id', 'PaidDate', 'TotalTaxValue', 'VoidedDate', 'FromDate', 'CreateDateTime', 'OrderNumber', 'AccountID', 'BatchID', 'TaxGroup', 'InvoiceEditorTemplateID', 'TaxRegionName', 'ToDate', 'DueDate', 'VoidedByResourceID', 'PaymentTerm', 'IsVoided', 'Comments', 'InvoiceTotal', 'InvoiceDateTime', 'CreatorResourceID', 'InvoiceNumber', 'WebServiceDate')]
    [string[]]
    $NotEquals,
