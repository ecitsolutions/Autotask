...
# Web Service Use Date
    ...
    [ValidateSet('CreatorResourceID', 'WebServiceDate', 'InvoiceTotal', 'id', 'DueDate', 'BatchID', 'Comments', 'AccountID', 'InvoiceNumber', 'FromDate', 'OrderNumber', 'ToDate', 'CreateDateTime', 'InvoiceEditorTemplateID', 'TotalTaxValue', 'InvoiceDateTime', 'PaidDate', 'PaymentTerm', 'IsVoided', 'TaxRegionName', 'VoidedByResourceID', 'TaxGroup', 'VoidedDate')]
    [string[]]
    $NotEquals,
