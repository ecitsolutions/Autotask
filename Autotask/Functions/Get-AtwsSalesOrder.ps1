...
# Title
    ...
    [ValidateSet('PromisedDueDate', 'OwnerResourceID', 'BillToAddress2', 'ShipToCountry', 'BillToPostalCode', 'BillToCountryID', 'ShipToAddress2', 'ImpersonatorCreatorResourceID', 'OpportunityID', 'Title', 'BillToState', 'BillToAddress1', 'AdditionalShipToAddressInformation', 'ShipToCountryID', 'ShipToPostalCode', 'SalesOrderDate', 'AccountID', 'ShipToState', 'BusinessDivisionSubdivisionID', 'AdditionalBillToAddressInformation', 'ShipToAddress1', 'ShipToCity', 'Status', 'id', 'BillToCity', 'Contact', 'BillToCountry')]
    [string[]]
    $NotEquals,
