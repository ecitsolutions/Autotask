...
# Vendor Account ID
    ...
    [ValidateSet('VendorAccountID', 'ContractID', 'id', 'ApproveAndPostDate', 'BusinessDivisionSubdivisionID', 'StartDate', 'Cost', 'Price', 'ServiceID', 'Units', 'ContractServiceID', 'EndDate', 'InternalCurrencyPrice')]
    [string[]]
    $NotEquals,
