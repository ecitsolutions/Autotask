...
# Vendor Account ID
    ...
    [ValidateSet('Cost', 'ApproveAndPostDate', 'id', 'InternalCurrencyPrice', 'ServiceID', 'Price', 'VendorAccountID', 'BusinessDivisionSubdivisionID', 'Units', 'StartDate', 'ContractServiceID', 'EndDate', 'ContractID')]
    [string[]]
    $NotEquals,
