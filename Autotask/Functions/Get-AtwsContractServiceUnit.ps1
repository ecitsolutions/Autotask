...
# Vendor Account ID
    ...
    [ValidateSet('VendorAccountID', 'StartDate', 'Price', 'Cost', 'ContractID', 'ApproveAndPostDate', 'InternalCurrencyPrice', 'ServiceID', 'EndDate', 'BusinessDivisionSubdivisionID', 'Units', 'id', 'ContractServiceID')]
    [string[]]
    $NotEquals,
