...
# Vendor Account ID
    ...
    [ValidateSet('EndDate', 'StartDate', 'Cost', 'BusinessDivisionSubdivisionID', 'Units', 'ContractID', 'ContractServiceID', 'id', 'InternalCurrencyPrice', 'VendorAccountID', 'ApproveAndPostDate', 'Price', 'ServiceID')]
    [string[]]
    $NotEquals,
