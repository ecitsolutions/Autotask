...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsResourceRoleQueue.md')]
  Param
  (
...
# Resource ID
    ...
    [ValidateSet('Active', 'Default', 'id', 'QueueID', 'ResourceID', 'RoleID')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('id', 'QueueID', 'ResourceID', 'RoleID')]
    [string[]]
    $GreaterThan,
