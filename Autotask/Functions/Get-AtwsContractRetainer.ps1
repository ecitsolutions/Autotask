...
# Status
    ...
    [ValidateSet('AmountApproved', 'IsPaid', 'DatePurchased', 'PaymentNumber', 'InternalCurrencyAmount', 'Amount', 'paymentID', 'Status', 'id', 'ContractID', 'EndDate', 'InternalCurrencyAmountApproved', 'InvoiceNumber', 'StartDate')]
    [string[]]
    $NotEquals,
