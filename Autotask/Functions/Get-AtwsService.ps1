...
# Vendor Account ID
    ...
    [ValidateSet('CreatorResourceID', 'IsActive', 'id', 'Description', 'Name', 'LastModifiedDate', 'VendorAccountID', 'PeriodType', 'CreateDate', 'AllocationCodeID', 'UpdateResourceID', 'UnitPrice', 'InvoiceDescription', 'MarkupRate', 'UnitCost', 'ServiceLevelAgreementID')]
    [string[]]
    $NotEquals,
