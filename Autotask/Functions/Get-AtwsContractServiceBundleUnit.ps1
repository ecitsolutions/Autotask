...
# units
    ...
    [ValidateSet('ServiceBundleID', 'Cost', 'BusinessDivisionSubdivisionID', 'ContractID', 'EndDate', 'StartDate', 'Units', 'id', 'InternalCurrencyPrice', 'Price', 'ApproveAndPostDate', 'ContractServiceBundleID')]
    [string[]]
    $NotEquals,
