...
# units
    ...
    [ValidateSet('id', 'ServiceBundleID', 'ContractServiceBundleID', 'InternalCurrencyPrice', 'StartDate', 'Units', 'Price', 'ApproveAndPostDate', 'EndDate', 'Cost', 'ContractID', 'BusinessDivisionSubdivisionID')]
    [string[]]
    $NotEquals,
