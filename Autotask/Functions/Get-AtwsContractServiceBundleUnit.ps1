...
# units
    ...
    [ValidateSet('InternalCurrencyPrice', 'ApproveAndPostDate', 'StartDate', 'Units', 'ContractServiceBundleID', 'ContractID', 'Cost', 'ServiceBundleID', 'EndDate', 'id', 'Price', 'BusinessDivisionSubdivisionID')]
    [string[]]
    $NotEquals,
