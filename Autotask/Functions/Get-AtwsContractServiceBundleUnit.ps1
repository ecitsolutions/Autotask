...
# units
    ...
    [ValidateSet('BusinessDivisionSubdivisionID', 'id', 'StartDate', 'InternalCurrencyPrice', 'Units', 'Price', 'ApproveAndPostDate', 'ContractServiceBundleID', 'ServiceBundleID', 'ContractID', 'Cost', 'EndDate')]
    [string[]]
    $NotEquals,
