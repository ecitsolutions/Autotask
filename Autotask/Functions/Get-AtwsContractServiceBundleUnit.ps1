...
# units
    ...
    [ValidateSet('InternalCurrencyPrice', 'Price', 'ContractServiceBundleID', 'StartDate', 'EndDate', 'ContractID', 'Units', 'BusinessDivisionSubdivisionID', 'ApproveAndPostDate', 'id', 'Cost', 'ServiceBundleID')]
    [string[]]
    $NotEquals,
