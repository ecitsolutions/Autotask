...
# Title
    ...
    [ValidateSet('Title', 'Description', 'Publish', 'NoteType', 'CreatorResourceID', 'LastActivityDate', 'CreateDateTime', 'id', 'ImpersonatorUpdaterResourceID', 'TaskID', 'ImpersonatorCreatorResourceID')]
    [string[]]
    $NotEquals,
