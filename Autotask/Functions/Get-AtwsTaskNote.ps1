...
# Title
    ...
    [ValidateSet('ImpersonatorCreatorResourceID', 'CreateDateTime', 'NoteType', 'Description', 'CreatorResourceID', 'Publish', 'ImpersonatorUpdaterResourceID', 'id', 'LastActivityDate', 'TaskID', 'Title')]
    [string[]]
    $NotEquals,
