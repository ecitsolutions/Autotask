...
# Title
    ...
    [ValidateSet('Description', 'Publish', 'ImpersonatorUpdaterResourceID', 'NoteType', 'CreatorResourceID', 'Title', 'LastActivityDate', 'CreateDateTime', 'TaskID', 'id', 'ImpersonatorCreatorResourceID', 'CreatedByContactID')]
    [string[]]
    $NotEquals,
