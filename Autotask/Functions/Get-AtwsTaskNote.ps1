...
# Title
    ...
    [ValidateSet('Title', 'ImpersonatorUpdaterResourceID', 'Description', 'id', 'Publish', 'CreateDateTime', 'TaskID', 'ImpersonatorCreatorResourceID', 'CreatedByContactID', 'LastActivityDate', 'CreatorResourceID', 'NoteType')]
    [string[]]
    $NotEquals,
