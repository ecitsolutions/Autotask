...
# Title
    ...
    [ValidateSet('ImpersonatorUpdaterResourceID', 'CreatedByContactID', 'Description', 'CreateDateTime', 'LastActivityDate', 'NoteType', 'Publish', 'CreatorResourceID', 'id', 'Title', 'ImpersonatorCreatorResourceID', 'TaskID')]
    [Collections.Generic.List[string]]
    $NotEquals,
