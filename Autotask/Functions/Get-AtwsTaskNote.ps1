...
# Title
    ...
    [ValidateSet('id', 'Title', 'ImpersonatorUpdaterResourceID', 'LastActivityDate', 'TaskID', 'ImpersonatorCreatorResourceID', 'CreateDateTime', 'Publish', 'Description', 'NoteType', 'CreatorResourceID', 'CreatedByContactID')]
    [string[]]
    $NotEquals,
