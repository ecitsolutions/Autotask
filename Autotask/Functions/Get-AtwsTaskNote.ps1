...
# Title
    ...
    [ValidateSet('LastActivityDate', 'Publish', 'NoteType', 'ImpersonatorCreatorResourceID', 'Title', 'ImpersonatorUpdaterResourceID', 'Description', 'TaskID', 'id', 'CreateDateTime', 'CreatorResourceID', 'CreatedByContactID')]
    [string[]]
    $NotEquals,
