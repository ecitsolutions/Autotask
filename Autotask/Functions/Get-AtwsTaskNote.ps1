...
# Title
    ...
    [ValidateSet('Publish', 'Title', 'Description', 'id', 'ImpersonatorCreatorResourceID', 'CreatorResourceID', 'LastActivityDate', 'CreateDateTime', 'TaskID', 'ImpersonatorUpdaterResourceID', 'NoteType')]
    [string[]]
    $NotEquals,
