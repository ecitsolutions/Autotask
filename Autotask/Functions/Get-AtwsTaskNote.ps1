...
# Title
    ...
    [ValidateSet('id', 'ImpersonatorCreatorResourceID', 'NoteType', 'Publish', 'LastActivityDate', 'Description', 'CreatedByContactID', 'TaskID', 'CreatorResourceID', 'CreateDateTime', 'Title', 'ImpersonatorUpdaterResourceID')]
    [string[]]
    $NotEquals,
