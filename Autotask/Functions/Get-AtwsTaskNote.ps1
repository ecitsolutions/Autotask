...
# Title
    ...
    [ValidateSet('CreatedByContactID', 'TaskID', 'ImpersonatorUpdaterResourceID', 'CreatorResourceID', 'Description', 'CreateDateTime', 'Publish', 'id', 'LastActivityDate', 'NoteType', 'Title', 'ImpersonatorCreatorResourceID')]
    [string[]]
    $NotEquals,
