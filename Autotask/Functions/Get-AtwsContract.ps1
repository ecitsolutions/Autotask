...
# Time Reporting Requires Start and Stop Times
    ...
    [ValidateSet('EndDate', 'ContractName', 'Description', 'OpportunityID', 'InternalCurrencyOverageBillingRate', 'BillToAccountContactID', 'SetupFee', 'BillToAccountID', 'ContactName', 'IsDefaultContract', 'ContractNumber', 'BusinessDivisionSubdivisionID', 'ServiceLevelAgreementID', 'AccountID', 'OverageBillingRate', 'SetupFeeAllocationCodeID', 'ContactID', 'id', 'Status', 'TimeReportingRequiresStartAndStopTimes', 'EstimatedRevenue', 'EstimatedHours', 'ContractCategory', 'ExclusionContractID', 'Compliance', 'ContractPeriodType', 'ContractExclusionSetID', 'PurchaseOrderNumber', 'RenewedContractID', 'StartDate', 'BillingPreference', 'InternalCurrencySetupFee', 'EstimatedCost', 'ContractType', '')]
    [string[]]
    $NotEquals,
