...
# Status
    ...
    [ValidateSet('CanceledByResource', 'EndDateTime', 'CanceledDateTime', 'CancelationNoticeHours', 'AccountID', 'Duration', 'Complete', 'ImpersonatorCreatorResourceID', 'Description', 'CreateDateTime', 'AccountPhysicalLocationID', 'id', 'LastModifiedDateTime', 'StartDateTime', 'CreatorResourceID', 'Status')]
    [string[]]
    $NotEquals,
