...
# Status
    ...
    [ValidateSet('Description', 'StartDateTime', 'CanceledDateTime', 'EndDateTime', 'AccountID', 'Status', 'id', 'CanceledByResource', 'ImpersonatorCreatorResourceID', 'CreatorResourceID', 'CreateDateTime', 'AccountPhysicalLocationID', 'Complete', 'CancelationNoticeHours', 'LastModifiedDateTime', 'Duration')]
    [string[]]
    $NotEquals,
