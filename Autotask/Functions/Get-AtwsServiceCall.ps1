...
# Status
    ...
    [ValidateSet('CreatorResourceID', 'LastModifiedDateTime', 'id', 'Description', 'Status', 'Complete', 'CanceledDateTime', 'AccountPhysicalLocationID', 'ImpersonatorCreatorResourceID', 'CreateDateTime', 'StartDateTime', 'CancelationNoticeHours', 'EndDateTime', 'AccountID', 'CanceledByResource', 'Duration')]
    [string[]]
    $NotEquals,
