...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsResourceRoleDepartment.md')]
  Param
  (
...
# Role ID
    ...
    [ValidateSet('Active', 'Default', 'DepartmentID', 'DepartmentLead', 'id', 'ResourceID', 'RoleID')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('DepartmentID', 'id', 'ResourceID', 'RoleID')]
    [string[]]
    $GreaterThan,
