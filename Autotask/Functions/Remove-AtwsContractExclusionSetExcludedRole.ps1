...
#>
Function Remove-AtwsContractExclusionSetExcludedRole
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsContractExclusionSetExcludedRole.md')]
  Param
  (
