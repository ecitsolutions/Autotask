...
# Warranty Expiration Date
    ...
    [ValidateSet('RMMDeviceAuditSoftwareStatusID', 'RMMDeviceAuditArchitectureID', 'RMMDeviceAuditSNMPName', 'RMMDeviceAuditAntivirusStatusID', 'RMMDeviceAuditMobileNumber', 'DattoRemoteIP', 'AccountPhysicalLocationID', 'DattoDrivesErrors', 'DattoKernelVersionID', 'ReferenceTitle', 'RMMDeviceAuditBackupStatusID', 'DattoPercentageUsed', 'RMMDeviceAuditMacAddress', 'RMMDeviceAuditDomainID', 'CreateDate', 'RMMDeviceAuditManufacturerID', 'RMMDeviceAuditModelID', 'ProductID', 'RMMDeviceAuditDescription', 'RMMDeviceAuditHostname', 'DattoOffsiteUsedBytes', 'RMMDeviceAuditServicePackID', 'RMMDeviceAuditLastUser', 'DattoNumberOfVolumes', 'Type', 'Location', 'InstalledByID', 'DattoNumberOfAgents', 'RMMDeviceAuditDisplayAdaptorID', 'RMMOpenAlertCount', 'RMMDeviceAuditMobileNetworkOperatorID', 'LastModifiedTime', 'ParentInstalledProductID', 'MonthlyCost', 'RMMDeviceID', 'DattoNumberOfDrives', 'DattoProtectedKilobytes', 'DattoNICSpeedKilobitsPerSecond', 'VendorID', 'ServiceID', 'RMMDeviceAuditMissingPatchCount', 'ServiceBundleID', 'AccountID', 'PerUseCost', 'SourceCostType', 'InstallDate', 'SetupFee', 'Active', 'DattoDeviceMemoryMegabytes', 'LastActivityPersonID', 'RMMDeviceAuditIPAddress', 'DattoUsedKilobytes', 'InstalledProductCategoryID', 'RMMDeviceAuditSNMPContact', 'DattoUptimeSeconds', 'ApiVendorID', 'HourlyCost', 'RMMDeviceAuditDeviceTypeID', 'ReferenceNumber', 'DattoZFSVersionID', 'RMMDeviceAuditSNMPLocation', 'ContactID', 'WarrantyExpirationDate', 'RMMDeviceAuditPatchStatusID', 'Notes', 'NumberOfUsers', 'ServiceLevelAgreementID', 'RMMDeviceAuditOperatingSystem', 'ContractServiceBundleID', 'DeviceNetworkingID', 'DattoHostname', 'RMMDeviceAuditMemoryBytes', 'RMMDeviceAuditProcessorID', 'LastActivityPersonType', 'DattoAvailableKilobytes', 'RMMDeviceAuditStorageBytes', 'DailyCost', 'DattoSerialNumber', 'InstalledByContactID', 'ContractServiceID', 'SerialNumber', 'DattoLastCheckInDateTime', 'id', 'DattoInternalIP', 'RMMDeviceAuditMotherboardID', 'CreatedByPersonID', 'RMMDeviceAuditExternalIPAddress', 'ImpersonatorCreatorResourceID', 'DattoOSVersionID', 'ContractID', 'SourceCostID', 'RMMDeviceUID', '')]
    [string[]]
    $NotEquals,
