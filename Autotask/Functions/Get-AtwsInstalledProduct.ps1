...
# Warranty Expiration Date
    ...
    [ValidateSet('AccountPhysicalLocationID', 'ReferenceTitle', 'RMMDeviceID', 'RMMDeviceAuditSNMPName', 'DattoDrivesErrors', 'DattoZFSVersionID', 'InstalledByContactID', 'RMMDeviceAuditPatchStatusID', 'RMMDeviceAuditMotherboardID', 'DattoHostname', 'DattoRemoteIP', 'ContractID', 'Type', 'DattoSerialNumber', 'VendorID', 'DattoNumberOfVolumes', 'SetupFee', 'DattoNICSpeedKilobitsPerSecond', 'SourceCostType', 'RMMDeviceAuditIPAddress', 'CreateDate', 'SourceCostID', 'SerialNumber', 'ProductID', 'PerUseCost', 'RMMDeviceAuditOperatingSystem', 'RMMDeviceAuditAntivirusStatusID', 'RMMDeviceAuditMemoryBytes', 'ImpersonatorCreatorResourceID', 'RMMDeviceAuditModelID', 'RMMDeviceAuditManufacturerID', 'DattoAvailableKilobytes', 'DailyCost', 'DattoNumberOfDrives', 'ContactID', 'RMMDeviceAuditSoftwareStatusID', 'DattoUsedKilobytes', 'ServiceLevelAgreementID', 'RMMDeviceAuditDomainID', 'RMMDeviceAuditMacAddress', 'Notes', 'RMMDeviceAuditDeviceTypeID', 'MonthlyCost', 'DattoDeviceMemoryMegabytes', 'RMMDeviceAuditMobileNumber', 'ServiceBundleID', 'RMMDeviceAuditDescription', 'RMMDeviceAuditExternalIPAddress', 'id', 'DattoKernelVersionID', 'RMMDeviceAuditMissingPatchCount', 'DattoInternalIP', 'RMMOpenAlertCount', 'WarrantyExpirationDate', 'RMMDeviceAuditSNMPContact', 'RMMDeviceUID', 'ContractServiceID', 'RMMDeviceAuditLastUser', 'DattoOSVersionID', 'LastModifiedTime', 'DattoPercentageUsed', 'CreatedByPersonID', 'ContractServiceBundleID', 'Location', 'RMMDeviceAuditHostname', 'RMMDeviceAuditStorageBytes', 'RMMDeviceAuditBackupStatusID', 'ServiceID', 'InstallDate', 'DattoProtectedKilobytes', 'ParentInstalledProductID', 'DattoNumberOfAgents', 'LastActivityPersonID', 'ApiVendorID', 'DeviceNetworkingID', 'HourlyCost', 'DattoOffsiteUsedBytes', 'AccountID', 'RMMDeviceAuditArchitectureID', 'RMMDeviceAuditProcessorID', 'InstalledByID', 'ReferenceNumber', 'RMMDeviceAuditDisplayAdaptorID', 'NumberOfUsers', 'DattoLastCheckInDateTime', 'InstalledProductCategoryID', 'RMMDeviceAuditSNMPLocation', 'RMMDeviceAuditMobileNetworkOperatorID', 'Active', 'RMMDeviceAuditServicePackID', 'DattoUptimeSeconds', 'LastActivityPersonType', '')]
    [string[]]
    $NotEquals,
