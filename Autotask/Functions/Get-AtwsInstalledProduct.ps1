...
# Warranty Expiration Date
    ...
    [ValidateSet('WarrantyExpirationDate', 'RMMDeviceAuditSNMPName', 'DattoRemoteIP', 'DeviceNetworkingID', 'NumberOfUsers', 'ImpersonatorCreatorResourceID', 'RMMDeviceAuditDeviceTypeID', 'RMMDeviceAuditIPAddress', 'DattoOffsiteUsedBytes', 'RMMDeviceAuditOperatingSystem', 'DattoDrivesErrors', 'id', 'RMMDeviceAuditDomainID', 'SerialNumber', 'RMMDeviceAuditSNMPContact', 'RMMDeviceAuditMobileNumber', 'PerUseCost', 'AccountPhysicalLocationID', 'RMMDeviceAuditModelID', 'ContractID', 'DattoNICSpeedKilobitsPerSecond', 'DattoHostname', 'RMMDeviceAuditAntivirusStatusID', 'SourceCostID', 'RMMDeviceAuditSNMPLocation', 'ContractServiceBundleID', 'CreatedByPersonID', 'RMMDeviceAuditProcessorID', 'DattoLastCheckInDateTime', 'ReferenceNumber', 'RMMOpenAlertCount', 'SourceCostType', 'RMMDeviceAuditMobileNetworkOperatorID', 'RMMDeviceAuditArchitectureID', 'RMMDeviceAuditBackupStatusID', 'DattoKernelVersionID', 'RMMDeviceUID', 'RMMDeviceAuditSoftwareStatusID', 'DattoSerialNumber', 'RMMDeviceAuditManufacturerID', 'ParentInstalledProductID', 'ContractServiceID', 'ApiVendorID', 'RMMDeviceAuditStorageBytes', 'HourlyCost', 'LastModifiedTime', 'RMMDeviceAuditMissingPatchCount', 'RMMDeviceAuditMemoryBytes', 'DailyCost', 'InstalledByID', 'InstalledProductCategoryID', 'Notes', 'RMMDeviceAuditLastUser', 'CreateDate', 'RMMDeviceAuditPatchStatusID', 'DattoNumberOfDrives', 'ServiceLevelAgreementID', 'InstalledByContactID', 'Active', 'DattoZFSVersionID', 'DattoUsedKilobytes', 'LastActivityPersonID', 'ContactID', 'ReferenceTitle', 'DattoPercentageUsed', 'RMMDeviceAuditExternalIPAddress', 'Type', 'ServiceBundleID', 'MonthlyCost', 'RMMDeviceAuditDisplayAdaptorID', 'DattoOSVersionID', 'ServiceID', 'RMMDeviceID', 'DattoNumberOfVolumes', 'AccountID', 'RMMDeviceAuditMotherboardID', 'RMMDeviceAuditServicePackID', 'DattoProtectedKilobytes', 'VendorID', 'ProductID', 'DattoAvailableKilobytes', 'RMMDeviceAuditDescription', 'DattoNumberOfAgents', 'DattoInternalIP', 'RMMDeviceAuditMacAddress', 'InstallDate', 'DattoDeviceMemoryMegabytes', 'SetupFee', 'Location', 'LastActivityPersonType', 'DattoUptimeSeconds', 'RMMDeviceAuditHostname', '')]
    [string[]]
    $NotEquals,
