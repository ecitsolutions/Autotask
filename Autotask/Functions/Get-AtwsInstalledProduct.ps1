...
# Warranty Expiration Date
    ...
    [ValidateSet('NumberOfUsers', 'RMMDeviceAuditModelID', 'LastActivityPersonID', 'PerUseCost', 'ContractServiceID', 'ContactID', 'LastModifiedTime', 'RMMDeviceAuditProcessorID', 'DattoNumberOfAgents', 'RMMDeviceAuditDeviceTypeID', 'InstalledByID', 'InstalledProductCategoryID', 'DattoOffsiteUsedBytes', 'RMMDeviceAuditAntivirusStatusID', 'Type', 'DattoNICSpeedKilobitsPerSecond', 'DattoLastCheckInDateTime', 'ServiceLevelAgreementID', 'ApiVendorID', 'MonthlyCost', 'RMMDeviceAuditBackupStatusID', 'ImpersonatorCreatorResourceID', 'ServiceBundleID', 'DattoZFSVersionID', 'DattoDrivesErrors', 'RMMDeviceAuditMissingPatchCount', 'HourlyCost', 'DattoRemoteIP', 'ParentInstalledProductID', 'RMMDeviceAuditSNMPContact', 'RMMOpenAlertCount', 'RMMDeviceAuditPatchStatusID', 'DailyCost', 'InstallDate', 'DattoAvailableKilobytes', 'RMMDeviceAuditArchitectureID', 'Active', 'DattoPercentageUsed', 'RMMDeviceUID', 'RMMDeviceAuditOperatingSystem', 'DattoDeviceMemoryMegabytes', 'RMMDeviceAuditMotherboardID', 'SetupFee', 'ReferenceTitle', 'RMMDeviceID', 'DattoNumberOfDrives', 'DattoOSVersionID', 'DattoInternalIP', 'RMMDeviceAuditMemoryBytes', 'ContractServiceBundleID', 'VendorID', 'RMMDeviceAuditManufacturerID', 'RMMDeviceAuditMobileNetworkOperatorID', 'RMMDeviceAuditDisplayAdaptorID', 'RMMDeviceAuditLastUser', 'RMMDeviceAuditSNMPLocation', 'RMMDeviceAuditDescription', 'RMMDeviceAuditSNMPName', 'id', 'DeviceNetworkingID', 'AccountPhysicalLocationID', 'ProductID', 'InstalledByContactID', 'Notes', 'SourceCostType', 'WarrantyExpirationDate', 'DattoNumberOfVolumes', 'ContractID', 'DattoUptimeSeconds', 'DattoSerialNumber', 'DattoKernelVersionID', 'AccountID', 'CreateDate', 'DattoUsedKilobytes', 'RMMDeviceAuditDomainID', 'RMMDeviceAuditMobileNumber', 'LastActivityPersonType', 'Location', 'RMMDeviceAuditStorageBytes', 'RMMDeviceAuditServicePackID', 'CreatedByPersonID', 'RMMDeviceAuditSoftwareStatusID', 'RMMDeviceAuditHostname', 'DattoProtectedKilobytes', 'SourceCostID', 'RMMDeviceAuditMacAddress', 'ReferenceNumber', 'RMMDeviceAuditIPAddress', 'RMMDeviceAuditExternalIPAddress', 'SerialNumber', 'DattoHostname', 'ServiceID', '')]
    [string[]]
    $NotEquals,
