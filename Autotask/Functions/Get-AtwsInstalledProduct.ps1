...
# Warranty Expiration Date
    ...
    [ValidateSet('SerialNumber', 'DattoUptimeSeconds', 'Notes', 'RMMDeviceAuditArchitectureID', 'NumberOfUsers', 'DattoInternalIP', 'CreatedByPersonID', 'ParentInstalledProductID', 'InstallDate', 'DattoOffsiteUsedBytes', 'RMMDeviceAuditAntivirusStatusID', 'DattoNumberOfDrives', 'RMMDeviceAuditSNMPContact', 'DattoKernelVersionID', 'RMMDeviceAuditExternalIPAddress', 'SourceCostType', 'ImpersonatorCreatorResourceID', 'ServiceLevelAgreementID', 'RMMDeviceAuditMotherboardID', 'CreateDate', 'Location', 'DattoNumberOfVolumes', 'RMMDeviceAuditDeviceTypeID', 'ContractServiceID', 'MonthlyCost', 'ReferenceNumber', 'HourlyCost', 'SourceCostID', 'DeviceNetworkingID', 'InstalledByContactID', 'DattoAvailableKilobytes', 'ProductID', 'ServiceBundleID', 'LastActivityPersonType', 'Active', 'RMMDeviceAuditModelID', 'DattoDrivesErrors', 'RMMDeviceAuditDisplayAdaptorID', 'RMMDeviceAuditProcessorID', 'DattoPercentageUsed', 'ContractID', 'RMMDeviceAuditHostname', 'RMMDeviceAuditDescription', 'DattoRemoteIP', 'InstalledProductCategoryID', 'ContractServiceBundleID', 'RMMDeviceAuditMobileNetworkOperatorID', 'LastActivityPersonID', 'DailyCost', 'DattoNICSpeedKilobitsPerSecond', 'RMMDeviceID', 'DattoNumberOfAgents', 'RMMDeviceAuditOperatingSystem', 'RMMDeviceAuditSNMPName', 'DattoProtectedKilobytes', 'DattoOSVersionID', 'RMMDeviceAuditMobileNumber', 'id', 'VendorID', 'DattoLastCheckInDateTime', 'AccountID', 'PerUseCost', 'RMMDeviceAuditDomainID', 'RMMDeviceAuditBackupStatusID', 'LastModifiedTime', 'RMMDeviceAuditServicePackID', 'InstalledByID', 'RMMDeviceAuditStorageBytes', 'RMMDeviceAuditPatchStatusID', 'ReferenceTitle', 'DattoZFSVersionID', 'WarrantyExpirationDate', 'AccountPhysicalLocationID', 'RMMDeviceAuditLastUser', 'RMMDeviceUID', 'DattoUsedKilobytes', 'RMMDeviceAuditManufacturerID', 'SetupFee', 'ApiVendorID', 'RMMDeviceAuditIPAddress', 'RMMDeviceAuditMissingPatchCount', 'ContactID', 'RMMDeviceAuditMemoryBytes', 'ServiceID', 'Type', 'DattoHostname', 'RMMDeviceAuditSNMPLocation', 'DattoSerialNumber', 'RMMOpenAlertCount', 'RMMDeviceAuditMacAddress', 'DattoDeviceMemoryMegabytes', 'RMMDeviceAuditSoftwareStatusID', '')]
    [string[]]
    $NotEquals,
