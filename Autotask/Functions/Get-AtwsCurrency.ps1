...
# Update Resource ID
    ...
    [ValidateSet('Name', 'IsInternalCurrency', 'Description', 'CurrencyPositiveFormat', 'Active', 'UpdateResourceId', 'CurrencyNegativeFormat', 'DisplaySymbol', 'id', 'LastModifiedDateTime', 'ExchangeRate')]
    [string[]]
    $NotEquals,
