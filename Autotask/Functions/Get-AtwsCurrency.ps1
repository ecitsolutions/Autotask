...
# Update Resource ID
    ...
    [ValidateSet('ExchangeRate', 'LastModifiedDateTime', 'Name', 'CurrencyNegativeFormat', 'Active', 'UpdateResourceId', 'IsInternalCurrency', 'Description', 'id', 'CurrencyPositiveFormat', 'DisplaySymbol')]
    [string[]]
    $NotEquals,
