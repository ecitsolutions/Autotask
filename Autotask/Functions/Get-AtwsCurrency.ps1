...
# Update Resource ID
    ...
    [ValidateSet('Description', 'IsInternalCurrency', 'UpdateResourceId', 'ExchangeRate', 'DisplaySymbol', 'Name', 'CurrencyPositiveFormat', 'Active', 'LastModifiedDateTime', 'id', 'CurrencyNegativeFormat')]
    [string[]]
    $NotEquals,
