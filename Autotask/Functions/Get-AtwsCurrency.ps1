...
# Update Resource ID
    ...
    [ValidateSet('CurrencyPositiveFormat', 'id', 'IsInternalCurrency', 'UpdateResourceId', 'DisplaySymbol', 'Name', 'Active', 'Description', 'ExchangeRate', 'CurrencyNegativeFormat', 'LastModifiedDateTime')]
    [string[]]
    $NotEquals,
