...
# Update Resource ID
    ...
    [ValidateSet('Active', 'Description', 'id', 'UpdateResourceId', 'DisplaySymbol', 'ExchangeRate', 'CurrencyPositiveFormat', 'CurrencyNegativeFormat', 'LastModifiedDateTime', 'Name', 'IsInternalCurrency')]
    [string[]]
    $NotEquals,
