...
# Update Resource ID
    ...
    [ValidateSet('Description', 'UpdateResourceId', 'CurrencyPositiveFormat', 'Name', 'DisplaySymbol', 'IsInternalCurrency', 'ExchangeRate', 'Active', 'CurrencyNegativeFormat', 'id', 'LastModifiedDateTime')]
    [string[]]
    $NotEquals,
