...
# Tax Region ID
    ...
    [ValidateSet('Name', 'Primary', 'Fax', 'TaxRegionID', 'Description', 'RoundtripDistance', 'OverrideAccountTaxSettings', 'AccountID', 'Address1', 'City', 'Address2', 'Phone', 'PostalCode', 'State', 'CountryID', 'id', 'IsTaxExempt', 'Active', 'AlternatePhone1', 'AlternatePhone2')]
    [string[]]
    $NotEquals,
