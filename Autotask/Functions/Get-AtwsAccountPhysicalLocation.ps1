...
# Tax Region ID
    ...
    [ValidateSet('CountryID', 'Name', 'AlternatePhone1', 'TaxRegionID', 'Address1', 'State', 'Address2', 'Fax', 'AccountID', 'Active', 'OverrideAccountTaxSettings', 'id', 'AlternatePhone2', 'PostalCode', 'IsTaxExempt', 'Phone', 'City', 'Description', 'Primary', 'RoundtripDistance')]
    [string[]]
    $NotEquals,
