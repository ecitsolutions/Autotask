...
# Ticket
    ...
    [ValidateSet('OpportunityID', 'ImpersonatorCreatorResourceID', 'StartDateTime', 'EndDateTime', 'CreateDateTime', 'AccountID', 'CompletedDate', 'AssignedToResourceID', 'ActionType', 'CreatorResourceID', 'LastModifiedDate', 'id', 'ContractID', 'ActivityDescription', 'TicketID', 'ContactID')]
    [string[]]
    $NotEquals,
