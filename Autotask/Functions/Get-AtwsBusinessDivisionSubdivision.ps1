...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsBusinessDivisionSubdivision.md')]
  Param
  (
...
# Business Division ID
    ...
    [ValidateSet('Active', 'BusinessDivisionID', 'BusinessSubdivisionID', 'id')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('BusinessDivisionID', 'BusinessSubdivisionID', 'id')]
    [string[]]
    $GreaterThan,
