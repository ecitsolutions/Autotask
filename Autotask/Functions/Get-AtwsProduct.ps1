...
# Vendor Product Number
    ...
    [ValidateSet('Serialized', 'DefaultInstalledProductCategoryID', 'ExternalProductID', 'ManufacturerName', 'BillingType', 'ImpersonatorCreatorResourceID', 'Link', 'Description', 'VendorProductNumber', 'ProductAllocationCodeID', 'InternalProductID', 'Name', 'UnitPrice', 'EligibleForRma', 'id', 'DoesNotRequireProcurement', 'PriceCostMethod', 'PeriodType', 'ProductCategory', 'UnitCost', 'Active', 'MarkupRate', 'DefaultVendorID', 'ManufacturerProductName', 'CostAllocationCodeID', 'MSRP', 'SKU')]
    [string[]]
    $NotEquals,
