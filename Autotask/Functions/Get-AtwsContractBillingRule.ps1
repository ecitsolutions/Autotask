...
# Start Date
    ...
    [ValidateSet('EndDate', 'MaximumUnits', 'ContractID', 'CreateChargesAsBillable', 'Active', 'ProductID', 'InvoiceDescription', 'DailyProratedPrice', 'DetermineUnits', 'id', 'IncludeItemsInChargeDescription', 'DailyProratedCost', 'MinimumUnits', 'ExecutionMethod', 'EnableDailyProrating', 'StartDate')]
    [string[]]
    $NotEquals,
