...
# Start Date
    ...
    [ValidateSet('id', 'MaximumUnits', 'DetermineUnits', 'IncludeItemsInChargeDescription', 'DailyProratedPrice', 'ProductID', 'DailyProratedCost', 'InvoiceDescription', 'CreateChargesAsBillable', 'MinimumUnits', 'EnableDailyProrating', 'ContractID', 'ExecutionMethod', 'EndDate', 'Active', 'StartDate')]
    [string[]]
    $NotEquals,
