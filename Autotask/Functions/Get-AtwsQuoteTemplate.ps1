...
# Show Vertical Grid Lines
    ...
    [ValidateSet('LastActivityBy', 'Description', 'Name', 'CreatedBy', 'CurrencyPositiveFormat', 'DisplayTaxCategorySuperscripts', 'PageNumberFormat', 'CreateDate', 'PageLayout', 'Active', 'NumberFormat', 'ShowTaxCategory', 'id', 'DateFormat', 'CalculateTaxSeparately', 'ShowGridHeader', 'ShowVerticalGridLines', 'ShowEachTaxInGroup', 'CurrencyNegativeFormat', 'DisplayCurrencySymbol', 'LastActivityDate')]
    [string[]]
    $NotEquals,
