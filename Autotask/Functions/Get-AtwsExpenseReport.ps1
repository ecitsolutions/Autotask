...
# Period Ending
    ...
    [ValidateSet('CashAdvanceAmount', 'id', 'SubmitDate', 'ExpenseTotal', 'ReimbursementCurrencyID', 'Status', 'WeekEnding', 'ReimbursementCurrencyAmountDue', 'ApprovedDate', 'DepartmentNumber', 'BusinessDivisionSubdivisionID', 'ApproverID', 'Name', 'RejectionReason', 'Submit', 'QuickBooksReferenceNumber', 'ReimbursementCurrencyCashAdvanceAmount', 'AmountDue', 'SubmitterID')]
    [string[]]
    $NotEquals,
