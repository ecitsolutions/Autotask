...
# Yearly Revenue
    ...
    [ValidateSet('TechnicalAssessmentScore', 'CreateDate', 'RelationshipAssessmentScore', 'Market', 'Cost', 'LeadReferral', 'SalesProcessPercentComplete', 'BusinessDivisionSubdivisionID', 'AdvancedField5', 'Title', 'AdvancedField1', 'Barriers', 'Rating', 'Probability', 'CreatorResourceID', 'PromisedFulfillmentDate', 'DateStamp', 'PrimaryCompetitor', 'AssessmentScore', 'LossReasonDetail', 'TotalAmountMonths', 'AdvancedField3', 'OwnerResourceID', 'YearlyCost', 'Description', 'UseQuoteTotals', 'OnetimeCost', 'Status', 'QuarterlyRevenue', 'SalesOrderID', 'AdvancedField4', 'YearlyRevenue', 'LossReason', 'ProjectedCloseDate', 'AccountID', 'LostDate', 'OnetimeRevenue', 'RevenueSpread', 'WinReason', 'ThroughDate', 'ProductID', 'RevenueSpreadUnit', 'NextStep', 'LastActivity', 'PromotionName', 'ProjectedLiveDate', 'MonthlyCost', 'Amount', 'ContactID', 'ClosedDate', 'MonthlyRevenue', 'Stage', 'AdvancedField2', 'WinReasonDetail', 'SemiannualCost', 'QuarterlyCost', 'OpportunityCategoryID', 'HelpNeeded', 'SemiannualRevenue', 'ImpersonatorCreatorResourceID', 'id')]
    [string[]]
    $NotEquals,
