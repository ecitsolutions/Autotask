...
# Yearly Revenue
    ...
    [ValidateSet('RelationshipAssessmentScore', 'SalesProcessPercentComplete', 'Stage', 'ClosedDate', 'Market', 'AssessmentScore', 'AdvancedField4', 'AdvancedField3', 'PromotionName', 'LostDate', 'TechnicalAssessmentScore', 'Description', 'RevenueSpread', 'YearlyRevenue', 'Cost', 'id', 'OnetimeCost', 'LeadReferral', 'OnetimeRevenue', 'ContactID', 'LastActivity', 'AdvancedField1', 'SemiannualRevenue', 'Probability', 'TotalAmountMonths', 'BusinessDivisionSubdivisionID', 'OwnerResourceID', 'WinReasonDetail', 'HelpNeeded', 'Barriers', 'RevenueSpreadUnit', 'LossReason', 'NextStep', 'PromisedFulfillmentDate', 'WinReason', 'LossReasonDetail', 'ProductID', 'AdvancedField2', 'ImpersonatorCreatorResourceID', 'OpportunityCategoryID', 'CreateDate', 'Status', 'Title', 'UseQuoteTotals', 'MonthlyRevenue', 'CreatorResourceID', 'AccountID', 'SalesOrderID', 'Amount', 'MonthlyCost', 'ProjectedLiveDate', 'AdvancedField5', 'ThroughDate', 'PrimaryCompetitor', 'QuarterlyCost', 'Rating', 'ProjectedCloseDate', 'QuarterlyRevenue', 'SemiannualCost', 'DateStamp', 'YearlyCost')]
    [string[]]
    $NotEquals,
