...
# Yearly Revenue
    ...
    [ValidateSet('ClosedDate', 'Rating', 'YearlyRevenue', 'Title', 'Market', 'Amount', 'SemiannualRevenue', 'PromisedFulfillmentDate', 'BusinessDivisionSubdivisionID', 'PromotionName', 'AdvancedField1', 'MonthlyRevenue', 'TotalAmountMonths', 'HelpNeeded', 'QuarterlyCost', 'LossReasonDetail', 'ProductID', 'LostDate', 'Cost', 'Probability', 'Barriers', 'YearlyCost', 'CreateDate', 'DateStamp', 'SemiannualCost', 'OwnerResourceID', 'Stage', 'ProjectedCloseDate', 'ContactID', 'CreatorResourceID', 'Status', 'OnetimeCost', 'NextStep', 'WinReasonDetail', 'AssessmentScore', 'SalesOrderID', 'AdvancedField5', 'WinReason', 'ImpersonatorCreatorResourceID', 'ProjectedLiveDate', 'ThroughDate', 'AdvancedField4', 'Description', 'AccountID', 'OnetimeRevenue', 'RelationshipAssessmentScore', 'id', 'RevenueSpreadUnit', 'QuarterlyRevenue', 'TechnicalAssessmentScore', 'RevenueSpread', 'UseQuoteTotals', 'AdvancedField3', 'MonthlyCost', 'LastActivity', 'OpportunityCategoryID', 'SalesProcessPercentComplete', 'LeadReferral', 'AdvancedField2', 'LossReason', 'PrimaryCompetitor')]
    [string[]]
    $NotEquals,
