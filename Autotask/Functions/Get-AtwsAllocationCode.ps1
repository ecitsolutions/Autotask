...
# Use Type
    ...
    [ValidateSet('Description', 'Name', 'ExternalNumber', 'IsExcludedFromNewContracts', 'Taxable', 'Active', 'AllocationCodeType', 'TaxCategoryID', 'MarkupRate', 'UseType', 'id', 'GeneralLedgerCode', 'Type', 'UnitPrice', 'UnitCost', 'Department', 'AfterHoursWorkType')]
    [string[]]
    $NotEquals,
