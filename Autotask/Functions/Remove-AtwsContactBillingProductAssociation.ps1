...
#>
Function Remove-AtwsContactBillingProductAssociation
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsContactBillingProductAssociation.md')]
  Param
  (
