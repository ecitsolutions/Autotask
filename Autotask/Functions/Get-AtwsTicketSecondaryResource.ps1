...
#>
Function Get-AtwsTicketSecondaryResource
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsTicketSecondaryResource.md')]
  Param
  (
...
# Ticket
    ...
    [ValidateSet('id', 'ResourceID', 'RoleID', 'TicketID')]
    [string[]]
    $NotEquals,
