...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsContractExclusionSetExcludedRole.md')]
  Param
  (
...
# Contract Exclusion Set Excluded Role ID
    ...
    [ValidateSet('ContractExclusionSetID', 'ExcludedRoleID', 'id')]
    [string[]]
    $NotEquals,
