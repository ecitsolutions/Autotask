...
#>
Function Remove-AtwsInstalledProductCategoryUdfAssociation
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Remove-AtwsInstalledProductCategoryUdfAssociation.md')]
  Param
  (
