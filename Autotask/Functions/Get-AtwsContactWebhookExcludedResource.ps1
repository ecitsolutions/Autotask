...
#>
Function Get-AtwsContactWebhookExcludedResource
{
...
#>
  ...
  HelpURI='https://github.com/ecitsolutions/Autotask/blob/master/Docs/Get-AtwsContactWebhookExcludedResource.md')]
  Param
  (
