...
Returns any object with a DeletedTicketActivityLogName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-AtwsDeletedTicketActivityLog -T <PickList Label>
Returns any DeletedTicketActivityLogs with property T equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-AtwsDeletedTicketActivityLog -T <PickList Label> -NotEquals T 
Returns any DeletedTicketActivityLogs with property T NOT equal to the <PickList Label>.
 .EXAMPLE
Get-AtwsDeletedTicketActivityLog -T <PickList Label1>, <PickList Label2>
Returns any DeletedTicketActivityLogs with property T equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-AtwsDeletedTicketActivityLog -T <PickList Label1>, <PickList Label2> -NotEquals T
Returns any DeletedTicketActivityLogs with property T NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-AtwsDeletedTicketActivityLog -Id 1234 -DeletedTicketActivityLogName SomeName* -T <PickList Label1>, <PickList Label2> -Like DeletedTicketActivityLogName -NotEquals T -GreaterThan Id
An example of a more complex query. This command returns any DeletedTicketActivityLogs with Id GREATER THAN 1234, a DeletedTicketActivityLogName that matches the simple pattern SomeName* AND that has a T that is NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
