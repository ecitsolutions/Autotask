...
#>
Function Get-PriceListWorkTypeModifier
{
...
.EXAMPLE
Get-PriceListWorkTypeModifier -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PriceListWorkTypeModifier -PriceListWorkTypeModifierName SomeName
Returns the object with PriceListWorkTypeModifierName 'SomeName', if any.
 .EXAMPLE
Get-PriceListWorkTypeModifier -PriceListWorkTypeModifierName 'Some Name'
Returns the object with PriceListWorkTypeModifierName 'Some Name', if any.
 .EXAMPLE
Get-PriceListWorkTypeModifier -PriceListWorkTypeModifierName 'Some Name' -NotEquals PriceListWorkTypeModifierName
Returns any objects with a PriceListWorkTypeModifierName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PriceListWorkTypeModifier -PriceListWorkTypeModifierName SomeName* -Like PriceListWorkTypeModifierName
Returns any object with a PriceListWorkTypeModifierName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PriceListWorkTypeModifier -PriceListWorkTypeModifierName SomeName* -NotLike PriceListWorkTypeModifierName
Returns any object with a PriceListWorkTypeModifierName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PriceListWorkTypeModifier -M <PickList Label>
Returns any PriceListWorkTypeModifiers with property M equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-PriceListWorkTypeModifier -M <PickList Label> -NotEquals M 
Returns any PriceListWorkTypeModifiers with property M NOT equal to the <PickList Label>.
 .EXAMPLE
Get-PriceListWorkTypeModifier -M <PickList Label1>, <PickList Label2>
Returns any PriceListWorkTypeModifiers with property M equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-PriceListWorkTypeModifier -M <PickList Label1>, <PickList Label2> -NotEquals M
Returns any PriceListWorkTypeModifiers with property M NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-PriceListWorkTypeModifier -Id 1234 -PriceListWorkTypeModifierName SomeName* -M <PickList Label1>, <PickList Label2> -Like PriceListWorkTypeModifierName -NotEquals M -GreaterThan Id
An example of a more complex query. This command returns any PriceListWorkTypeModifiers with Id GREATER THAN 1234, a PriceListWorkTypeModifierName that matches the simple pattern SomeName* AND that has a M that is NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.

.LINK
Set-PriceListWorkTypeModifier
...
# Uses Internal Currency Price
    ...
    [ValidateSet('id', 'WorkTypeModifierID', 'CurrencyID')]
    [String[]]
    $GreaterThan,
