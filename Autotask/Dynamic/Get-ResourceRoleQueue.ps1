...
#>
Function Get-ResourceRoleQueue
{
...
.EXAMPLE
Get-ResourceRoleQueue -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ResourceRoleQueue -ResourceRoleQueueName SomeName
Returns the object with ResourceRoleQueueName 'SomeName', if any.
 .EXAMPLE
Get-ResourceRoleQueue -ResourceRoleQueueName 'Some Name'
Returns the object with ResourceRoleQueueName 'Some Name', if any.
 .EXAMPLE
Get-ResourceRoleQueue -ResourceRoleQueueName 'Some Name' -NotEquals ResourceRoleQueueName
Returns any objects with a ResourceRoleQueueName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ResourceRoleQueue -ResourceRoleQueueName SomeName* -Like ResourceRoleQueueName
Returns any object with a ResourceRoleQueueName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ResourceRoleQueue -ResourceRoleQueueName SomeName* -NotLike ResourceRoleQueueName
