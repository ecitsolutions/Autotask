...
#>
Function Get-AtwsContactWebhookField
{
...
Returns any object with a ContactWebhookFieldName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-AtwsContactWebhookField -F <PickList Label>
Returns any ContactWebhookFields with property F equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-AtwsContactWebhookField -F <PickList Label> -NotEquals F 
Returns any ContactWebhookFields with property F NOT equal to the <PickList Label>.
 .EXAMPLE
Get-AtwsContactWebhookField -F <PickList Label1>, <PickList Label2>
Returns any ContactWebhookFields with property F equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-AtwsContactWebhookField -F <PickList Label1>, <PickList Label2> -NotEquals F
Returns any ContactWebhookFields with property F NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-AtwsContactWebhookField -Id 1234 -ContactWebhookFieldName SomeName* -F <PickList Label1>, <PickList Label2> -Like ContactWebhookFieldName -NotEquals F -GreaterThan Id
An example of a more complex query. This command returns any ContactWebhookFields with Id GREATER THAN 1234, a ContactWebhookFieldName that matches the simple pattern SomeName* AND that has a F that is NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
