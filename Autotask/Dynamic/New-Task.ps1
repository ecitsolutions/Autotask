...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the Task with Id number 0 you could write 'New-Task -Id 0' or you could write 'New-Task -Filter {Id -eq 0}.

'New-Task -Id 0,4' could be written as 'New-Task -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-Task -ProjectID [Value] -Status [Value] -TaskType [Value] -Title [Value]
Creates a new [Autotask.Task] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-Task -Id 124 | New-Task 
Copies [Autotask.Task] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-Task -Id 124 | New-Task | Set-Task -ParameterName <Parameter Value>
Copies [Autotask.Task] by Id 124 to a new object through the Web Services API, passes the new object to the Set-Task to modify the object.
 .EXAMPLE
$Result = Get-Task -Id 124 | New-Task | Set-Task -ParameterName <Parameter Value> -Passthru
Copies [Autotask.Task] by Id 124 to a new object through the Web Services API, passes the new object to the Set-Task to modify the object and returns the new object.
