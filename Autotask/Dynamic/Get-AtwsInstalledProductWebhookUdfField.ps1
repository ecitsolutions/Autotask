...
Returns any object with a InstalledProductWebhookUdfFieldName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-AtwsInstalledProductWebhookUdfField -U <PickList Label>
Returns any InstalledProductWebhookUdfFields with property U equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-AtwsInstalledProductWebhookUdfField -U <PickList Label> -NotEquals U 
Returns any InstalledProductWebhookUdfFields with property U NOT equal to the <PickList Label>.
 .EXAMPLE
Get-AtwsInstalledProductWebhookUdfField -U <PickList Label1>, <PickList Label2>
Returns any InstalledProductWebhookUdfFields with property U equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-AtwsInstalledProductWebhookUdfField -U <PickList Label1>, <PickList Label2> -NotEquals U
Returns any InstalledProductWebhookUdfFields with property U NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-AtwsInstalledProductWebhookUdfField -Id 1234 -InstalledProductWebhookUdfFieldName SomeName* -U <PickList Label1>, <PickList Label2> -Like InstalledProductWebhookUdfFieldName -NotEquals U -GreaterThan Id
An example of a more complex query. This command returns any InstalledProductWebhookUdfFields with Id GREATER THAN 1234, a InstalledProductWebhookUdfFieldName that matches the simple pattern SomeName* AND that has a U that is NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
