...
.EXAMPLE
Get-WorkTypeModifier -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-WorkTypeModifier -WorkTypeModifierName SomeName
Returns the object with WorkTypeModifierName 'SomeName', if any.
 .EXAMPLE
Get-WorkTypeModifier -WorkTypeModifierName 'Some Name'
Returns the object with WorkTypeModifierName 'Some Name', if any.
 .EXAMPLE
Get-WorkTypeModifier -WorkTypeModifierName 'Some Name' -NotEquals WorkTypeModifierName
Returns any objects with a WorkTypeModifierName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-WorkTypeModifier -WorkTypeModifierName SomeName* -Like WorkTypeModifierName
Returns any object with a WorkTypeModifierName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-WorkTypeModifier -WorkTypeModifierName SomeName* -NotLike WorkTypeModifierName
