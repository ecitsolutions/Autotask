...
.EXAMPLE
Get-NotificationHistory -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryName SomeName
Returns the object with NotificationHistoryName 'SomeName', if any.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryName 'Some Name'
Returns the object with NotificationHistoryName 'Some Name', if any.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryName 'Some Name' -NotEquals NotificationHistoryName
Returns any objects with a NotificationHistoryName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryName SomeName* -Like NotificationHistoryName
Returns any object with a NotificationHistoryName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryName SomeName* -NotLike NotificationHistoryName
Returns any object with a NotificationHistoryName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryTypeID <PickList Label>
Returns any NotificationHistorys with property NotificationHistoryTypeID equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryTypeID <PickList Label> -NotEquals NotificationHistoryTypeID 
Returns any NotificationHistorys with property NotificationHistoryTypeID NOT equal to the <PickList Label>.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryTypeID <PickList Label1>, <PickList Label2>
Returns any NotificationHistorys with property NotificationHistoryTypeID equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-NotificationHistory -NotificationHistoryTypeID <PickList Label1>, <PickList Label2> -NotEquals NotificationHistoryTypeID
Returns any NotificationHistorys with property NotificationHistoryTypeID NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-NotificationHistory -Id 1234 -NotificationHistoryName SomeName* -NotificationHistoryTypeID <PickList Label1>, <PickList Label2> -Like NotificationHistoryName -NotEquals NotificationHistoryTypeID -GreaterThan Id
