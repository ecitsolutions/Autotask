...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('Project:CreatorResourceID', 'Project:ProjectLeadResourceID', 'Project:CompanyOwnerResourceID', 'Project:LastActivityResourceID', 'Invoice:CreatorResourceID', 'Invoice:VoidedByResourceID', 'PurchaseOrderReceive:ReceivedByResourceID', 'BillingItemApprovalLevel:ApprovalResourceID', 'Service:CreatorResourceID', 'Service:UpdateResourceID', 'Account:OwnerResourceID', 'AccountTeam:ResourceID', 'NotificationHistory:InitiatingResourceID', 'Opportunity:OwnerResourceID', 'TaskNote:CreatorResourceID', 'TaskNote:ImpersonatorCreatorResourceID', 'TaskNote:ImpersonatorUpdaterResourceID', 'AttachmentInfo:AttachedByResourceID', 'ResourceServiceDeskRole:ResourceID', 'ContractNote:CreatorResourceID', 'ContractNote:ImpersonatorCreatorResourceID', 'ContractNote:ImpersonatorUpdaterResourceID', 'TaskSecondaryResource:ResourceID', 'ResourceRole:ResourceID', 'BillingItem:ItemApproverID', 'BillingItem:AccountManagerWhenApprovedID', 'ContractMilestone:CreatorResourceID', 'InstalledProduct:InstalledByID', 'InstalledProduct:LastActivityPersonID', 'TicketCost:CreatorResourceID', 'InventoryTransfer:TransferByResourceID', 'PurchaseOrder:CreatorResourceID', 'Appointment:ResourceID', 'Appointment:CreatorResourceID', 'ResourceRoleDepartment:ResourceID', 'ProjectCost:CreatorResourceID', 'TicketChecklistItem:CompletedByResourceID', 'Currency:UpdateResourceId', 'TicketSecondaryResource:ResourceID', 'Ticket:AssignedResourceID', 'Ticket:CreatorResourceID', 'Ticket:CompletedByResourceID', 'Ticket:LastActivityResourceID', 'BusinessDivisionSubdivisionResource:ResourceID', 'ServiceLevelAgreementResults:FirstResponseInitiatingResourceID', 'ServiceLevelAgreementResults:FirstResponseResourceID', 'ServiceLevelAgreementResults:ResolutionPlanResourceID', 'ServiceLevelAgreementResults:ResolutionResourceID', 'ServiceCallTaskResource:ResourceID', 'Phase:CreatorResourceID', 'ContractCost:CreatorResourceID', 'TicketNote:CreatorResourceID', 'TicketNote:ImpersonatorCreatorResourceID', 'TicketNote:ImpersonatorUpdaterResourceID', 'InventoryLocation:ResourceID', 'TicketChangeRequestApproval:ResourceID', 'AccountNote:AssignedResourceID', 'AccountNote:ImpersonatorCreatorResourceID', 'AccountNote:ImpersonatorUpdaterResourceID', 'ServiceCallTicketResource:ResourceID', 'ExpenseReport:SubmitterID', 'ExpenseReport:ApproverID', 'Quote:CreatorResourceID', 'Quote:LastModifiedBy', 'TicketHistory:ResourceID', 'ProjectNote:CreatorResourceID', 'ProjectNote:ImpersonatorCreatorResourceID', 'ProjectNote:ImpersonatorUpdaterResourceID', 'QuoteTemplate:CreatedBy', 'QuoteTemplate:LastActivityBy', 'TimeEntry:ResourceID', 'TimeEntry:BillingApprovalResourceID', 'TimeEntry:ImpersonatorCreatorResourceID', 'TimeEntry:ImpersonatorUpdaterResourceID', 'ResourceSkill:ResourceID', 'ResourceRoleQueue:ResourceID', 'AccountToDo:AssignedToResourceID', 'AccountToDo:CreatorResourceID', 'ContractRoleCost:ResourceID', 'Task:AssignedResourceID', 'Task:CreatorResourceID', 'Task:CompletedByResourceID', 'Task:LastActivityResourceID', 'SalesOrder:OwnerResourceID', 'ServiceBundle:CreatorResourceID', 'ServiceBundle:UpdateResourceID')]
    [String]
