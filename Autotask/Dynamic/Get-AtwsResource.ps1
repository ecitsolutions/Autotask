...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('SalesOrder:OwnerResourceID', 'InstalledProduct:InstalledByID', 'InstalledProduct:LastActivityPersonID', 'Project:CreatorResourceID', 'Project:ProjectLeadResourceID', 'Project:CompanyOwnerResourceID', 'Project:LastActivityResourceID', 'Invoice:CreatorResourceID', 'Invoice:VoidedByResourceID', 'Service:CreatorResourceID', 'Service:UpdateResourceID', 'BillingItemApprovalLevel:ApprovalResourceID', 'TicketChangeRequestApproval:ResourceID', 'Account:OwnerResourceID', 'AccountTeam:ResourceID', 'Ticket:AssignedResourceID', 'Ticket:CreatorResourceID', 'Ticket:CompletedByResourceID', 'Ticket:LastActivityResourceID', 'TaskNote:CreatorResourceID', 'TaskNote:ImpersonatorCreatorResourceID', 'TaskNote:ImpersonatorUpdaterResourceID', 'AttachmentInfo:AttachedByResourceID', 'ResourceServiceDeskRole:ResourceID', 'Currency:UpdateResourceId', 'BusinessDivisionSubdivisionResource:ResourceID', 'NotificationHistory:InitiatingResourceID', 'PurchaseOrderReceive:ReceivedByResourceID', 'ContractNote:CreatorResourceID', 'ContractNote:ImpersonatorCreatorResourceID', 'ContractNote:ImpersonatorUpdaterResourceID', 'TaskSecondaryResource:ResourceID', 'QuoteTemplate:CreatedBy', 'QuoteTemplate:LastActivityBy', 'ResourceRole:ResourceID', 'ServiceBundle:CreatorResourceID', 'ServiceBundle:UpdateResourceID', 'BillingItem:ItemApproverID', 'BillingItem:AccountManagerWhenApprovedID', 'ServiceCallTaskResource:ResourceID', 'ContractMilestone:CreatorResourceID', 'TicketCost:CreatorResourceID', 'PurchaseOrder:CreatorResourceID', 'Appointment:ResourceID', 'Appointment:CreatorResourceID', 'AccountNote:AssignedResourceID', 'AccountNote:ImpersonatorCreatorResourceID', 'AccountNote:ImpersonatorUpdaterResourceID', 'ProjectCost:CreatorResourceID', 'TicketChecklistItem:CompletedByResourceID', 'ServiceLevelAgreementResults:FirstResponseInitiatingResourceID', 'ServiceLevelAgreementResults:FirstResponseResourceID', 'ServiceLevelAgreementResults:ResolutionPlanResourceID', 'ServiceLevelAgreementResults:ResolutionResourceID', 'Phase:CreatorResourceID', 'ContractCost:CreatorResourceID', 'TicketSecondaryResource:ResourceID', 'TicketNote:CreatorResourceID', 'TicketNote:ImpersonatorCreatorResourceID', 'TicketNote:ImpersonatorUpdaterResourceID', 'InventoryLocation:ResourceID', 'ServiceCallTicketResource:ResourceID', 'ExpenseReport:SubmitterID', 'ExpenseReport:ApproverID', 'Quote:CreatorResourceID', 'Quote:LastModifiedBy', 'AccountToDo:AssignedToResourceID', 'AccountToDo:CreatorResourceID', 'ProjectNote:CreatorResourceID', 'ProjectNote:ImpersonatorCreatorResourceID', 'ProjectNote:ImpersonatorUpdaterResourceID', 'TicketHistory:ResourceID', 'TimeEntry:ResourceID', 'TimeEntry:BillingApprovalResourceID', 'TimeEntry:ImpersonatorCreatorResourceID', 'TimeEntry:ImpersonatorUpdaterResourceID', 'Opportunity:OwnerResourceID', 'ResourceSkill:ResourceID', 'ResourceRoleQueue:ResourceID', 'ContractRoleCost:ResourceID', 'Task:AssignedResourceID', 'Task:CreatorResourceID', 'Task:CompletedByResourceID', 'Task:LastActivityResourceID', 'InventoryTransfer:TransferByResourceID', 'ResourceRoleDepartment:ResourceID')]
    [String]
