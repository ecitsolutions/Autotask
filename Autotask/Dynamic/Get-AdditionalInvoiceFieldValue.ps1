...
#>
Function Get-AdditionalInvoiceFieldValue
{
...
.EXAMPLE
Get-AdditionalInvoiceFieldValue -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -AdditionalInvoiceFieldValueName SomeName
Returns the object with AdditionalInvoiceFieldValueName 'SomeName', if any.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -AdditionalInvoiceFieldValueName 'Some Name'
Returns the object with AdditionalInvoiceFieldValueName 'Some Name', if any.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -AdditionalInvoiceFieldValueName 'Some Name' -NotEquals AdditionalInvoiceFieldValueName
Returns any objects with a AdditionalInvoiceFieldValueName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -AdditionalInvoiceFieldValueName SomeName* -Like AdditionalInvoiceFieldValueName
Returns any object with a AdditionalInvoiceFieldValueName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -AdditionalInvoiceFieldValueName SomeName* -NotLike AdditionalInvoiceFieldValueName
Returns any object with a AdditionalInvoiceFieldValueName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -A <PickList Label>
Returns any AdditionalInvoiceFieldValues with property A equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -A <PickList Label> -NotEquals A 
Returns any AdditionalInvoiceFieldValues with property A NOT equal to the <PickList Label>.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -A <PickList Label1>, <PickList Label2>
Returns any AdditionalInvoiceFieldValues with property A equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -A <PickList Label1>, <PickList Label2> -NotEquals A
Returns any AdditionalInvoiceFieldValues with property A NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-AdditionalInvoiceFieldValue -Id 1234 -AdditionalInvoiceFieldValueName SomeName* -A <PickList Label1>, <PickList Label2> -Like AdditionalInvoiceFieldValueName -NotEquals A -GreaterThan Id
