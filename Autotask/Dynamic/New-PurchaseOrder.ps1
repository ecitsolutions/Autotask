...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the PurchaseOrder with Id number 0 you could write 'New-PurchaseOrder -Id 0' or you could write 'New-PurchaseOrder -Filter {Id -eq 0}.

'New-PurchaseOrder -Id 0,4' could be written as 'New-PurchaseOrder -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-PurchaseOrder -VendorID [Value] -Status [Value] -ShipToName [Value] -ShipToAddress1 [Value] -ShipToCity [Value] -ShipToState [Value] -ShipToPostalCode [Value]
Creates a new [Autotask.PurchaseOrder] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-PurchaseOrder -Id 124 | New-PurchaseOrder 
Copies [Autotask.PurchaseOrder] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-PurchaseOrder -Id 124 | New-PurchaseOrder | Set-PurchaseOrder -ParameterName <Parameter Value>
Copies [Autotask.PurchaseOrder] by Id 124 to a new object through the Web Services API, passes the new object to the Set-PurchaseOrder to modify the object.
 .EXAMPLE
$Result = Get-PurchaseOrder -Id 124 | New-PurchaseOrder | Set-PurchaseOrder -ParameterName <Parameter Value> -Passthru
Copies [Autotask.PurchaseOrder] by Id 124 to a new object through the Web Services API, passes the new object to the Set-PurchaseOrder to modify the object and returns the new object.
