...
#>
Function Set-ContractMilestone
{
...
.EXAMPLE
Set-ContractMilestone -InputObject $ContractMilestone [-ParameterName] [Parameter value]
Passes one or more [Autotask.ContractMilestone] object(s) as a variable to the function and sets the property by name 'ParameterName' on ALL the objects before they are passed to the Autotask Web Service API and updated.
 .EXAMPLE
$ContractMilestone | Set-ContractMilestone -ParameterName <Parameter value>
Same as the first example, but now the objects are passed to the funtion through the pipeline, not passed as a parameter. The end result is identical.
 .EXAMPLE
Get-ContractMilestone -Id 0 | Set-ContractMilestone -ParameterName <Parameter value>
Gets the instance with Id 0 directly from the Web Services API, modifies a parameter and updates Autotask. This approach works with all valid parameters for the Get function.
 .EXAMPLE
Get-ContractMilestone -Id 0,4,8 | Set-ContractMilestone -ParameterName <Parameter value>
Gets multiple instances by Id, modifies them all and updates Autotask.
 .EXAMPLE
$Result = Get-ContractMilestone -Id 0,4,8 | Set-ContractMilestone -ParameterName <Parameter value> -PassThru
