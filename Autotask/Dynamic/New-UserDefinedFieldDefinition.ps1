...
#>
Function New-UserDefinedFieldDefinition
{
...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the UserDefinedFieldDefinition with Id number 0 you could write 'New-UserDefinedFieldDefinition -Id 0' or you could write 'New-UserDefinedFieldDefinition -Filter {Id -eq 0}.

'New-UserDefinedFieldDefinition -Id 0,4' could be written as 'New-UserDefinedFieldDefinition -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-UserDefinedFieldDefinition -Name [Value] -UdfType [Value] -DataType [Value]
Creates a new [Autotask.UserDefinedFieldDefinition] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-UserDefinedFieldDefinition -Id 124 | New-UserDefinedFieldDefinition 
Copies [Autotask.UserDefinedFieldDefinition] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-UserDefinedFieldDefinition -Id 124 | New-UserDefinedFieldDefinition | Set-UserDefinedFieldDefinition -ParameterName <Parameter Value>
Copies [Autotask.UserDefinedFieldDefinition] by Id 124 to a new object through the Web Services API, passes the new object to the Set-UserDefinedFieldDefinition to modify the object.
 .EXAMPLE
$Result = Get-UserDefinedFieldDefinition -Id 124 | New-UserDefinedFieldDefinition | Set-UserDefinedFieldDefinition -ParameterName <Parameter Value> -Passthru
Copies [Autotask.UserDefinedFieldDefinition] by Id 124 to a new object through the Web Services API, passes the new object to the Set-UserDefinedFieldDefinition to modify the object and returns the new object.

.LINK
Get-UserDefinedFieldDefinition
 .LINK
Set-UserDefinedFieldDefinition
