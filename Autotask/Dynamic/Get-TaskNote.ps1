...
# Follow this external ID and return any external objects
    ...
    [Alias('GetRef')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('CreatorResourceID', 'TaskID', 'ImpersonatorCreatorResourceID', 'ImpersonatorUpdaterResourceID')]
    [String]
