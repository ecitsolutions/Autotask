...
#>
Function New-ContractMilestone
{
...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the ContractMilestone with Id number 0 you could write 'New-ContractMilestone -Id 0' or you could write 'New-ContractMilestone -Filter {Id -eq 0}.

'New-ContractMilestone -Id 0,4' could be written as 'New-ContractMilestone -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-ContractMilestone -Status [Value] -DateDue [Value] -Amount [Value] -Title [Value] -ContractID [Value] -IsInitialPayment [Value]
Creates a new [Autotask.ContractMilestone] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-ContractMilestone -Id 124 | New-ContractMilestone 
Copies [Autotask.ContractMilestone] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-ContractMilestone -Id 124 | New-ContractMilestone | Set-ContractMilestone -ParameterName <Parameter Value>
Copies [Autotask.ContractMilestone] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ContractMilestone to modify the object.
 .EXAMPLE
$Result = Get-ContractMilestone -Id 124 | New-ContractMilestone | Set-ContractMilestone -ParameterName <Parameter Value> -Passthru
Copies [Autotask.ContractMilestone] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ContractMilestone to modify the object and returns the new object.

.LINK
Get-ContractMilestone
 .LINK
