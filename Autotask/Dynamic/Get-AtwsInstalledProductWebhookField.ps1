...
#>
Function Get-AtwsInstalledProductWebhookField
{
...
Returns any object with a InstalledProductWebhookFieldName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-AtwsInstalledProductWebhookField -F <PickList Label>
Returns any InstalledProductWebhookFields with property F equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-AtwsInstalledProductWebhookField -F <PickList Label> -NotEquals F 
Returns any InstalledProductWebhookFields with property F NOT equal to the <PickList Label>.
 .EXAMPLE
Get-AtwsInstalledProductWebhookField -F <PickList Label1>, <PickList Label2>
Returns any InstalledProductWebhookFields with property F equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-AtwsInstalledProductWebhookField -F <PickList Label1>, <PickList Label2> -NotEquals F
Returns any InstalledProductWebhookFields with property F NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-AtwsInstalledProductWebhookField -Id 1234 -InstalledProductWebhookFieldName SomeName* -F <PickList Label1>, <PickList Label2> -Like InstalledProductWebhookFieldName -NotEquals F -GreaterThan Id
An example of a more complex query. This command returns any InstalledProductWebhookFields with Id GREATER THAN 1234, a InstalledProductWebhookFieldName that matches the simple pattern SomeName* AND that has a F that is NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
