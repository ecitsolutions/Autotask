...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the ContractRetainer with Id number 0 you could write 'New-ContractRetainer -Id 0' or you could write 'New-ContractRetainer -Filter {Id -eq 0}.

'New-ContractRetainer -Id 0,4' could be written as 'New-ContractRetainer -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-ContractRetainer -ContractID [Value] -Status [Value] -DatePurchased [Value] -StartDate [Value] -EndDate [Value] -Amount [Value]
Creates a new [Autotask.ContractRetainer] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-ContractRetainer -Id 124 | New-ContractRetainer 
Copies [Autotask.ContractRetainer] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-ContractRetainer -Id 124 | New-ContractRetainer | Set-ContractRetainer -ParameterName <Parameter Value>
Copies [Autotask.ContractRetainer] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ContractRetainer to modify the object.
 .EXAMPLE
$Result = Get-ContractRetainer -Id 124 | New-ContractRetainer | Set-ContractRetainer -ParameterName <Parameter Value> -Passthru
Copies [Autotask.ContractRetainer] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ContractRetainer to modify the object and returns the new object.

.LINK
Get-ContractRetainer
 .LINK
Set-ContractRetainer
