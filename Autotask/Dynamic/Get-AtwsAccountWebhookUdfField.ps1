...
#>
Function Get-AtwsAccountWebhookUdfField
{
...
Returns any object with a AccountWebhookUdfFieldName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-AtwsAccountWebhookUdfField -U <PickList Label>
Returns any AccountWebhookUdfFields with property U equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-AtwsAccountWebhookUdfField -U <PickList Label> -NotEquals U 
Returns any AccountWebhookUdfFields with property U NOT equal to the <PickList Label>.
 .EXAMPLE
Get-AtwsAccountWebhookUdfField -U <PickList Label1>, <PickList Label2>
Returns any AccountWebhookUdfFields with property U equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-AtwsAccountWebhookUdfField -U <PickList Label1>, <PickList Label2> -NotEquals U
Returns any AccountWebhookUdfFields with property U NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-AtwsAccountWebhookUdfField -Id 1234 -AccountWebhookUdfFieldName SomeName* -U <PickList Label1>, <PickList Label2> -Like AccountWebhookUdfFieldName -NotEquals U -GreaterThan Id
An example of a more complex query. This command returns any AccountWebhookUdfFields with Id GREATER THAN 1234, a AccountWebhookUdfFieldName that matches the simple pattern SomeName* AND that has a U that is NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
...
# UDF Field ID
    ...
    [ArgumentCompleter({
      ...
      Get-AtwsPicklistValue -Entity AccountWebhookUdfField -FieldName UdfFieldID -Label
    })]
    [ValidateScript({
      $set = Get-AtwsPicklistValue -Entity AccountWebhookUdfField -FieldName UdfFieldID -Label
