...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the ProjectNote with Id number 0 you could write 'New-ProjectNote -Id 0' or you could write 'New-ProjectNote -Filter {Id -eq 0}.

'New-ProjectNote -Id 0,4' could be written as 'New-ProjectNote -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-ProjectNote -Description [Value] -NoteType [Value] -Publish [Value] -ProjectID [Value] -Title [Value] -Announce [Value]
Creates a new [Autotask.ProjectNote] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-ProjectNote -Id 124 | New-ProjectNote 
Copies [Autotask.ProjectNote] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-ProjectNote -Id 124 | New-ProjectNote | Set-ProjectNote -ParameterName <Parameter Value>
Copies [Autotask.ProjectNote] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ProjectNote to modify the object.
 .EXAMPLE
$Result = Get-ProjectNote -Id 124 | New-ProjectNote | Set-ProjectNote -ParameterName <Parameter Value> -Passthru
Copies [Autotask.ProjectNote] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ProjectNote to modify the object and returns the new object.
