...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('PriceListService:ServiceID', 'ContractService:ServiceID', 'BillingItem:ServiceID', 'InstalledProduct:ServiceID', 'ContractServiceUnit:ServiceID', 'ContractServiceAdjustment:ServiceID', 'ServiceBundleService:ServiceID', 'QuoteItem:ServiceID')]
    [String]
