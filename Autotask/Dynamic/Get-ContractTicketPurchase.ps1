...
#>
Function Get-ContractTicketPurchase
{
...
.EXAMPLE
Get-ContractTicketPurchase -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractTicketPurchase -ContractTicketPurchaseName SomeName
Returns the object with ContractTicketPurchaseName 'SomeName', if any.
 .EXAMPLE
Get-ContractTicketPurchase -ContractTicketPurchaseName 'Some Name'
Returns the object with ContractTicketPurchaseName 'Some Name', if any.
 .EXAMPLE
Get-ContractTicketPurchase -ContractTicketPurchaseName 'Some Name' -NotEquals ContractTicketPurchaseName
Returns any objects with a ContractTicketPurchaseName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractTicketPurchase -ContractTicketPurchaseName SomeName* -Like ContractTicketPurchaseName
Returns any object with a ContractTicketPurchaseName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractTicketPurchase -ContractTicketPurchaseName SomeName* -NotLike ContractTicketPurchaseName
Returns any object with a ContractTicketPurchaseName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractTicketPurchase -IsPaid <PickList Label>
Returns any ContractTicketPurchases with property IsPaid equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-ContractTicketPurchase -IsPaid <PickList Label> -NotEquals IsPaid 
Returns any ContractTicketPurchases with property IsPaid NOT equal to the <PickList Label>.
 .EXAMPLE
Get-ContractTicketPurchase -IsPaid <PickList Label1>, <PickList Label2>
Returns any ContractTicketPurchases with property IsPaid equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-ContractTicketPurchase -IsPaid <PickList Label1>, <PickList Label2> -NotEquals IsPaid
Returns any ContractTicketPurchases with property IsPaid NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-ContractTicketPurchase -Id 1234 -ContractTicketPurchaseName SomeName* -IsPaid <PickList Label1>, <PickList Label2> -Like ContractTicketPurchaseName -NotEquals IsPaid -GreaterThan Id
