...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('SalesOrder:AccountID', 'InstalledProduct:AccountID', 'InstalledProduct:VendorID', 'Project:AccountID', 'Invoice:AccountID', 'Service:VendorAccountID', 'Contact:AccountID', 'Account:ParentAccountID', 'AccountTeam:AccountID', 'Ticket:AccountID', 'Product:DefaultVendorID', 'Contract:AccountID', 'Contract:BillToAccountID', 'NotificationHistory:AccountID', 'ServiceCall:AccountID', 'Subscription:VendorID', 'BillingItem:AccountID', 'BillingItem:VendorID', 'ContractServiceUnit:VendorAccountID', 'AccountPhysicalLocation:AccountID', 'PurchaseOrder:VendorID', 'PurchaseOrder:PurchaseForAccountID', 'AccountNote:AccountID', 'ProductVendor:VendorID', 'ExpenseItem:AccountID', 'AccountAlert:AccountID', 'AccountLocation:AccountID', 'Quote:AccountID', 'AccountToDo:AccountID', 'Opportunity:AccountID', 'SurveyResults:AccountID')]
    [String]
