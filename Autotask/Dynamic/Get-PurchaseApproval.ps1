...
.EXAMPLE
Get-PurchaseApproval -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PurchaseApproval -PurchaseApprovalName SomeName
Returns the object with PurchaseApprovalName 'SomeName', if any.
 .EXAMPLE
Get-PurchaseApproval -PurchaseApprovalName 'Some Name'
Returns the object with PurchaseApprovalName 'Some Name', if any.
 .EXAMPLE
Get-PurchaseApproval -PurchaseApprovalName 'Some Name' -NotEquals PurchaseApprovalName
Returns any objects with a PurchaseApprovalName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PurchaseApproval -PurchaseApprovalName SomeName* -Like PurchaseApprovalName
Returns any object with a PurchaseApprovalName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PurchaseApproval -PurchaseApprovalName SomeName* -NotLike PurchaseApprovalName
