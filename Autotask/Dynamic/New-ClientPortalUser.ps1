...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the ClientPortalUser with Id number 0 you could write 'New-ClientPortalUser -Id 0' or you could write 'New-ClientPortalUser -Filter {Id -eq 0}.

'New-ClientPortalUser -Id 0,4' could be written as 'New-ClientPortalUser -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-ClientPortalUser -SecurityLevel [Value] -ContactID [Value] -DateFormat [Value] -TimeFormat [Value] -NumberFormat [Value] -UserName [Value] -ClientPortalActive [Value]
Creates a new [Autotask.ClientPortalUser] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-ClientPortalUser -Id 124 | New-ClientPortalUser 
Copies [Autotask.ClientPortalUser] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-ClientPortalUser -Id 124 | New-ClientPortalUser | Set-ClientPortalUser -ParameterName <Parameter Value>
Copies [Autotask.ClientPortalUser] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ClientPortalUser to modify the object.
 .EXAMPLE
$Result = Get-ClientPortalUser -Id 124 | New-ClientPortalUser | Set-ClientPortalUser -ParameterName <Parameter Value> -Passthru
Copies [Autotask.ClientPortalUser] by Id 124 to a new object through the Web Services API, passes the new object to the Set-ClientPortalUser to modify the object and returns the new object.

.LINK
Get-ClientPortalUser
 .LINK
Set-ClientPortalUser
