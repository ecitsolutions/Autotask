...
.EXAMPLE
Get-ClientPortalUser -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ClientPortalUser -ClientPortalUserName SomeName
Returns the object with ClientPortalUserName 'SomeName', if any.
 .EXAMPLE
Get-ClientPortalUser -ClientPortalUserName 'Some Name'
Returns the object with ClientPortalUserName 'Some Name', if any.
 .EXAMPLE
Get-ClientPortalUser -ClientPortalUserName 'Some Name' -NotEquals ClientPortalUserName
Returns any objects with a ClientPortalUserName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ClientPortalUser -ClientPortalUserName SomeName* -Like ClientPortalUserName
Returns any object with a ClientPortalUserName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ClientPortalUser -ClientPortalUserName SomeName* -NotLike ClientPortalUserName
Returns any object with a ClientPortalUserName that DOES NOT match the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ClientPortalUser -SecurityLevel <PickList Label>
Returns any ClientPortalUsers with property SecurityLevel equal to the <PickList Label>. '-PickList' is any parameter on .
 .EXAMPLE
Get-ClientPortalUser -SecurityLevel <PickList Label> -NotEquals SecurityLevel 
Returns any ClientPortalUsers with property SecurityLevel NOT equal to the <PickList Label>.
 .EXAMPLE
Get-ClientPortalUser -SecurityLevel <PickList Label1>, <PickList Label2>
Returns any ClientPortalUsers with property SecurityLevel equal to EITHER <PickList Label1> OR <PickList Label2>.
 .EXAMPLE
Get-ClientPortalUser -SecurityLevel <PickList Label1>, <PickList Label2> -NotEquals SecurityLevel
Returns any ClientPortalUsers with property SecurityLevel NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
 .EXAMPLE
Get-ClientPortalUser -Id 1234 -ClientPortalUserName SomeName* -SecurityLevel <PickList Label1>, <PickList Label2> -Like ClientPortalUserName -NotEquals SecurityLevel -GreaterThan Id
