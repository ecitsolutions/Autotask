...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the TaxCategory with Id number 0 you could write 'New-TaxCategory -Id 0' or you could write 'New-TaxCategory -Filter {Id -eq 0}.

'New-TaxCategory -Id 0,4' could be written as 'New-TaxCategory -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-TaxCategory -Name [Value]
Creates a new [Autotask.TaxCategory] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-TaxCategory -Id 124 | New-TaxCategory 
Copies [Autotask.TaxCategory] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-TaxCategory -Id 124 | New-TaxCategory | Set-TaxCategory -ParameterName <Parameter Value>
Copies [Autotask.TaxCategory] by Id 124 to a new object through the Web Services API, passes the new object to the Set-TaxCategory to modify the object.
 .EXAMPLE
$Result = Get-TaxCategory -Id 124 | New-TaxCategory | Set-TaxCategory -ParameterName <Parameter Value> -Passthru
Copies [Autotask.TaxCategory] by Id 124 to a new object through the Web Services API, passes the new object to the Set-TaxCategory to modify the object and returns the new object.
