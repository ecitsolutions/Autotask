...
#>
Function Get-InstalledProductType
{
...
.EXAMPLE
Get-InstalledProductType -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-InstalledProductType -InstalledProductTypeName SomeName
Returns the object with InstalledProductTypeName 'SomeName', if any.
 .EXAMPLE
Get-InstalledProductType -InstalledProductTypeName 'Some Name'
Returns the object with InstalledProductTypeName 'Some Name', if any.
 .EXAMPLE
Get-InstalledProductType -InstalledProductTypeName 'Some Name' -NotEquals InstalledProductTypeName
Returns any objects with a InstalledProductTypeName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-InstalledProductType -InstalledProductTypeName SomeName* -Like InstalledProductTypeName
Returns any object with a InstalledProductTypeName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-InstalledProductType -InstalledProductTypeName SomeName* -NotLike InstalledProductTypeName
