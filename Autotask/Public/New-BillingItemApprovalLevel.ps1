...
#>
Function New-BillingItemApprovalLevel
{
...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the BillingItemApprovalLevel with Id number 0 you could write 'New-BillingItemApprovalLevel -Id 0' or you could write 'New-BillingItemApprovalLevel -Filter {Id -eq 0}.

'New-BillingItemApprovalLevel -Id 0,4' could be written as 'New-BillingItemApprovalLevel -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-BillingItemApprovalLevel -TimeEntryID [Value] -ApprovalResourceID [Value] -ApprovalDateTime [Value] -ApprovalLevel [Value]
Creates a new [Autotask.BillingItemApprovalLevel] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-BillingItemApprovalLevel -Id 124 | New-BillingItemApprovalLevel 
Copies [Autotask.BillingItemApprovalLevel] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-BillingItemApprovalLevel -Id 124 | New-BillingItemApprovalLevel | Set-BillingItemApprovalLevel -ParameterName <Parameter Value>
Copies [Autotask.BillingItemApprovalLevel] by Id 124 to a new object through the Web Services API, passes the new object to the Set-BillingItemApprovalLevel to modify the object.
 .EXAMPLE
$Result = Get-BillingItemApprovalLevel -Id 124 | New-BillingItemApprovalLevel | Set-BillingItemApprovalLevel -ParameterName <Parameter Value> -Passthru
Copies [Autotask.BillingItemApprovalLevel] by Id 124 to a new object through the Web Services API, passes the new object to the Set-BillingItemApprovalLevel to modify the object and returns the new object.

.LINK
Get-BillingItemApprovalLevel
