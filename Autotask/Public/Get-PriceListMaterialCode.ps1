...
#>
Function Get-PriceListMaterialCode
{
...
.EXAMPLE
Get-PriceListMaterialCode -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PriceListMaterialCode -PriceListMaterialCodeName SomeName
Returns the object with PriceListMaterialCodeName 'SomeName', if any.
 .EXAMPLE
Get-PriceListMaterialCode -PriceListMaterialCodeName 'Some Name'
Returns the object with PriceListMaterialCodeName 'Some Name', if any.
 .EXAMPLE
Get-PriceListMaterialCode -PriceListMaterialCodeName 'Some Name' -NotEquals PriceListMaterialCodeName
Returns any objects with a PriceListMaterialCodeName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PriceListMaterialCode -PriceListMaterialCodeName SomeName* -Like PriceListMaterialCodeName
Returns any object with a PriceListMaterialCodeName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PriceListMaterialCode -PriceListMaterialCodeName SomeName* -NotLike PriceListMaterialCodeName
...
# Unit Price
    ...
    [ValidateSet('id', 'AllocationCodeID', 'CurrencyID', 'UsesInternalCurrencyPrice', 'UnitPrice')]
    [String[]]
    $NotEquals,
