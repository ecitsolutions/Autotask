...
.EXAMPLE
Get-QuoteLocation -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-QuoteLocation -QuoteLocationName SomeName
Returns the object with QuoteLocationName 'SomeName', if any.
 .EXAMPLE
Get-QuoteLocation -QuoteLocationName 'Some Name'
Returns the object with QuoteLocationName 'Some Name', if any.
 .EXAMPLE
Get-QuoteLocation -QuoteLocationName 'Some Name' -NotEquals QuoteLocationName
Returns any objects with a QuoteLocationName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-QuoteLocation -QuoteLocationName SomeName* -Like QuoteLocationName
Returns any object with a QuoteLocationName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-QuoteLocation -QuoteLocationName SomeName* -NotLike QuoteLocationName
