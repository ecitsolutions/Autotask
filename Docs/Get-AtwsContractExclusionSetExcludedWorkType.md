...
### Filter (Default)
```
Get-AtwsContractExclusionSetExcludedWorkType -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractExclusionSetExcludedWorkType [-GetReferenceEntityById <String>]
 [-ContractExclusionSetID <Nullable`1[]>] [-ExcludedWorkTypeID <Nullable`1[]>] [-id <Nullable`1[]>]
...
### Get_all
```
Get-AtwsContractExclusionSetExcludedWorkType [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
