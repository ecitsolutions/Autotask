...
### Filter (Default)
```
Get-AtwsBillingItemApprovalLevel -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsBillingItemApprovalLevel [-GetReferenceEntityById <String>] [-ApprovalDateTime <Nullable`1[]>]
 [-ApprovalLevel <Nullable`1[]>] [-ApprovalResourceID <Nullable`1[]>] [-id <Nullable`1[]>]
 [-TimeEntryID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsBillingItemApprovalLevel [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
