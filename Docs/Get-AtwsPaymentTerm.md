...
### Filter (Default)
```
Get-AtwsPaymentTerm -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsPaymentTerm [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>] [-Description <String[]>]
 [-id <Nullable`1[]>] [-Name <String[]>] [-PaymentDueInDays <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsPaymentTerm [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
