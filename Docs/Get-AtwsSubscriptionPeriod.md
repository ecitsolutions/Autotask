...
### Filter (Default)
```
Get-AtwsSubscriptionPeriod -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsSubscriptionPeriod [-GetReferenceEntityById <String>] [-id <Nullable`1[]>] [-PeriodCost <Nullable`1[]>]
 [-PeriodDate <Nullable`1[]>] [-PeriodPrice <Nullable`1[]>] [-PostedDate <Nullable`1[]>]
 [-PurchaseOrderNumber <String[]>] [-SubscriptionID <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsSubscriptionPeriod [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
