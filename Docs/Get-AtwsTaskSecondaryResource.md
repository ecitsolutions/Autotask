...
### Filter (Default)
```
Get-AtwsTaskSecondaryResource -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTaskSecondaryResource [-GetReferenceEntityById <String>] [-id <Nullable`1[]>]
 [-ResourceID <Nullable`1[]>] [-RoleID <Nullable`1[]>] [-TaskID <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsTaskSecondaryResource [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
