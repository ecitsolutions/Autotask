...
### Filter (Default)
```
Get-AtwsTicketAdditionalContact -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTicketAdditionalContact [-GetReferenceEntityById <String>] [-ContactID <Nullable`1[]>]
 [-id <Nullable`1[]>] [-TicketID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsTicketAdditionalContact [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```
Get-AtwsTicketAdditionalContact -Id 0
Returns the object with Id 0, if any.
```

### EXAMPLE 2
```
Get-AtwsTicketAdditionalContact -TicketAdditionalContactName SomeName
Returns the object with TicketAdditionalContactName 'SomeName', if any.
```

### EXAMPLE 3
```
Get-AtwsTicketAdditionalContact -TicketAdditionalContactName 'Some Name'
Returns the object with TicketAdditionalContactName 'Some Name', if any.
```

### EXAMPLE 4
```
Get-AtwsTicketAdditionalContact -TicketAdditionalContactName 'Some Name' -NotEquals TicketAdditionalContactName
Returns any objects with a TicketAdditionalContactName that is NOT equal to 'Some Name', if any.
```

### EXAMPLE 5
```
Get-AtwsTicketAdditionalContact -TicketAdditionalContactName SomeName* -Like TicketAdditionalContactName
