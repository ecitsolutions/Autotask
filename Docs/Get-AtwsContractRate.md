...
### Filter (Default)
```
Get-AtwsContractRate -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractRate [-GetReferenceEntityById <String>] [-ContractHourlyRate <Nullable`1[]>]
 [-ContractID <Nullable`1[]>] [-id <Nullable`1[]>] [-InternalCurrencyContractHourlyRate <Nullable`1[]>]
 [-RoleID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsContractRate [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
