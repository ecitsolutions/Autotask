...
### Filter (Default)
```
Get-AtwsPriceListService -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsPriceListService [-GetReferenceEntityById <String>] [-CurrencyID <Nullable`1[]>] [-id <Nullable`1[]>]
 [-ServiceID <Nullable`1[]>] [-UnitPrice <Nullable`1[]>] [-UsesInternalCurrencyPrice <Nullable`1[]>]
...
### Get_all
```
Get-AtwsPriceListService [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
