...
### Filter (Default)
```
Get-AtwsAttachmentInfo -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsAttachmentInfo [-GetReferenceEntityById <String>] [-AttachDate <Nullable`1[]>]
 [-AttachedByContactID <Nullable`1[]>] [-AttachedByResourceID <Nullable`1[]>] [-ContentType <String[]>]
 [-FullPath <String[]>] [-id <Nullable`1[]>] [-ImpersonatorCreatorResourceID <Nullable`1[]>]
 [-OpportunityID <Nullable`1[]>] [-ParentID <Nullable`1[]>] [-ParentType <String[]>] [-Publish <String[]>]
 [-Title <String[]>] [-Type <String[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsAttachmentInfo [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 10
```
, <PickList Label2> -NotEquals ParentType
Returns any AttachmentInfos with property ParentType NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
```

### EXAMPLE 11
```
, <PickList Label2> -Like AttachmentInfoName -NotEquals ParentType -GreaterThan Id
