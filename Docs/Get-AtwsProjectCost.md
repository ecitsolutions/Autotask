...
### Filter (Default)
```
Get-AtwsProjectCost -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsProjectCost [-GetReferenceEntityById <String>] [-AllocationCodeID <Nullable`1[]>]
 ...
 [-EstimatedCost <Nullable`1[]>] [-ExtendedCost <Nullable`1[]>] [-id <Nullable`1[]>]
 ...
 [-ProjectID <Nullable`1[]>] [-PurchaseOrderNumber <String[]>] [-Status <String[]>]
 [-StatusLastModifiedBy <Nullable`1[]>] [-StatusLastModifiedDate <Nullable`1[]>] [-UnitCost <Nullable`1[]>]
...
### Get_all
```
Get-AtwsProjectCost [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like ProjectCostName -NotEquals CostType -GreaterThan Id
