...
### Filter (Default)
```
Get-AtwsContractExclusionRole -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractExclusionRole [-GetReferenceEntityById <String>] [-ContractID <Nullable`1[]>]
 [-id <Nullable`1[]>] [-RoleID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsContractExclusionRole [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
