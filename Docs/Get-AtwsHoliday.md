...
### Filter (Default)
```
Get-AtwsHoliday -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### By_parameters
```
Get-AtwsHoliday [-GetReferenceEntityById <String>] [-HolidayDate <Nullable`1[]>] [-HolidayName <String[]>]
 [-HolidaySetID <Nullable`1[]>] [-id <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsHoliday [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
