...
### Filter (Default)
```
Get-AtwsDeletedTicketLog -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsDeletedTicketLog [-GetReferenceEntityById <String>] [-DeletedByResourceID <Nullable`1[]>]
 [-DeletedDateTime <Nullable`1[]>] [-id <Nullable`1[]>] [-TicketID <Nullable`1[]>] [-TicketNumber <String[]>]
 [-TicketTitle <String[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsDeletedTicketLog [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
