...
### Filter (Default)
```
Get-AtwsInventoryItem -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsInventoryItem [-GetReferenceEntityById <String>] [-BackOrder <Nullable`1[]>] [-Bin <String[]>]
 [-id <Nullable`1[]>] [-ImpersonatorCreatorResourceID <Nullable`1[]>] [-InventoryLocationID <Nullable`1[]>]
 [-OnOrder <Nullable`1[]>] [-Picked <Nullable`1[]>] [-ProductID <Nullable`1[]>]
 [-QuantityMaximum <Nullable`1[]>] [-QuantityMinimum <Nullable`1[]>] [-QuantityOnHand <Nullable`1[]>]
 [-ReferenceNumber <String[]>] [-Reserved <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsInventoryItem [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
