...
### Filter (Default)
```
Get-AtwsInstalledProductType -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsInstalledProductType [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>] [-id <Nullable`1[]>]
...
### Get_all
```
Get-AtwsInstalledProductType [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
