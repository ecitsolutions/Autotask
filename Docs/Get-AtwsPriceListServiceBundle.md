...
### Filter (Default)
```
Get-AtwsPriceListServiceBundle -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsPriceListServiceBundle [-GetReferenceEntityById <String>] [-CurrencyID <Nullable`1[]>]
 [-id <Nullable`1[]>] [-ServiceBundleID <Nullable`1[]>] [-UnitPrice <Nullable`1[]>]
...
### Get_all
```
Get-AtwsPriceListServiceBundle [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
