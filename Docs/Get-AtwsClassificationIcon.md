...
### Filter (Default)
```
Get-AtwsClassificationIcon -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsClassificationIcon [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>]
 [-Description <String[]>] [-id <Nullable`1[]>] [-Name <String[]>] [-RelativeUrl <String[]>]
 [-System <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsClassificationIcon [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
