...
### Filter (Default)
```
Get-AtwsSurvey -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### By_parameters
```
Get-AtwsSurvey [-GetReferenceEntityById <String>] [-Description <String[]>] [-DisplayName <String[]>]
...
### Get_all
```
Get-AtwsSurvey [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
