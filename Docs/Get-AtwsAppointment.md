...
### Filter (Default)
```
Get-AtwsAppointment -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsAppointment [-GetReferenceEntityById <String>] [-CreateDateTime <Nullable`1[]>]
 [-CreatorResourceID <Nullable`1[]>] [-Description <String[]>] [-EndDateTime <Nullable`1[]>]
 [-id <Nullable`1[]>] [-ResourceID <Nullable`1[]>] [-StartDateTime <Nullable`1[]>] [-Title <String[]>]
 [-UpdateDateTime <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsAppointment [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
