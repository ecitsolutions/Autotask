...
### Filter (Default)
```
Get-AtwsResourceRoleDepartment -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsResourceRoleDepartment [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>]
 [-Default <Nullable`1[]>] [-DepartmentID <Nullable`1[]>] [-DepartmentLead <Nullable`1[]>] [-id <Nullable`1[]>]
 [-ResourceID <Nullable`1[]>] [-RoleID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsResourceRoleDepartment [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
