...
### Filter (Default)
```
Get-AtwsTicketRmaCredit -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTicketRmaCredit [-GetReferenceEntityById <String>] [-CreditAmount <Nullable`1[]>]
 [-CreditDetails <String[]>] [-id <Nullable`1[]>] [-InternalCurrencyCreditAmount <Nullable`1[]>]
...
### Get_all
```
Get-AtwsTicketRmaCredit [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
