...
### Filter (Default)
```
Get-AtwsContractRetainer -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractRetainer [-GetReferenceEntityById <String>] [-Amount <Nullable`1[]>]
 [-ContractID <Nullable`1[]>] [-DatePurchased <Nullable`1[]>] [-EndDate <Nullable`1[]>] [-id <Nullable`1[]>]
 [-InternalCurrencyAmount <Nullable`1[]>] [-InvoiceNumber <String[]>] [-IsPaid <String[]>]
 [-paymentID <String[]>] [-PaymentNumber <String[]>] [-StartDate <Nullable`1[]>] [-Status <String[]>]
...
### Get_all
```
Get-AtwsContractRetainer [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like ContractRetainerName -NotEquals Status -GreaterThan Id
