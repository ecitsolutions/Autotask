...
### Filter (Default)
```
Get-AtwsUserDefinedFieldListItem -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsUserDefinedFieldListItem [-GetReferenceEntityById <String>] [-CreateDate <Nullable`1[]>]
 [-id <Nullable`1[]>] [-IsActive <Nullable`1[]>] [-UdfFieldId <Nullable`1[]>] [-ValueForDisplay <String[]>]
 [-ValueForExport <String[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsUserDefinedFieldListItem [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
