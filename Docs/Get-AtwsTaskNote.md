...
### Filter (Default)
```
Get-AtwsTaskNote -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTaskNote [-GetReferenceEntityById <String>] [-CreateDateTime <Nullable`1[]>]
 ...
 [-Publish <String[]>] [-TaskID <Nullable`1[]>] [-Title <String[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsTaskNote [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like TaskNoteName -NotEquals NoteType -GreaterThan Id
