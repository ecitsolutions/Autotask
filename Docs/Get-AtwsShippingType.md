...
### Filter (Default)
```
Get-AtwsShippingType -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsShippingType [-GetReferenceEntityById <String>] [-AllocationCodeID <Nullable`1[]>]
 [-Description <String[]>] [-id <Nullable`1[]>] [-IsActive <Nullable`1[]>] [-Name <String[]>]
...
### Get_all
```
Get-AtwsShippingType [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
