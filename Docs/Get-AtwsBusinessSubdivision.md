...
### Filter (Default)
```
Get-AtwsBusinessSubdivision -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsBusinessSubdivision [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>]
...
### Get_all
```
Get-AtwsBusinessSubdivision [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
