...
### Filter (Default)
```
Get-AtwsTaskPredecessor -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTaskPredecessor [-GetReferenceEntityById <String>] [-id <Nullable`1[]>] [-LagDays <Nullable`1[]>]
 [-PredecessorTaskID <Nullable`1[]>] [-SuccessorTaskID <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsTaskPredecessor [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
