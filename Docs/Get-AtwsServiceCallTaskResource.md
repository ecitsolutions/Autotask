...
### Filter (Default)
```
Get-AtwsServiceCallTaskResource -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsServiceCallTaskResource [-GetReferenceEntityById <String>] [-id <Nullable`1[]>]
 [-ResourceID <Nullable`1[]>] [-ServiceCallTaskID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsServiceCallTaskResource [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
