...
### Filter (Default)
```
Get-AtwsExpenseReport -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsExpenseReport [-GetReferenceEntityById <String>] [-ApprovedDate <Nullable`1[]>]
 [-ApproverID <Nullable`1[]>] [-BusinessDivisionSubdivisionID <Nullable`1[]>]
 [-CashAdvanceAmount <Nullable`1[]>] [-ExpenseTotal <Nullable`1[]>] [-id <Nullable`1[]>] [-Name <String[]>]
 [-QuickBooksReferenceNumber <String[]>] [-ReimbursementCurrencyAmountDue <Nullable`1[]>]
 [-ReimbursementCurrencyCashAdvanceAmount <Nullable`1[]>] [-ReimbursementCurrencyID <Nullable`1[]>]
 [-RejectionReason <String[]>] [-Status <String[]>] [-SubmitDate <Nullable`1[]>] [-SubmitterID <Nullable`1[]>]
 [-WeekEnding <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsExpenseReport [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like ExpenseReportName -NotEquals Status -GreaterThan Id
