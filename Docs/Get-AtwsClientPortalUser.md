...
### Filter (Default)
```
Get-AtwsClientPortalUser -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsClientPortalUser [-GetReferenceEntityById <String>] [-ClientPortalActive <Nullable`1[]>]
 [-ContactID <Nullable`1[]>] [-DateFormat <String[]>] [-id <Nullable`1[]>] [-NumberFormat <String[]>]
 [-SecurityLevel <String[]>] [-TimeFormat <String[]>] [-UserName <String[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsClientPortalUser [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 10
```
, <PickList Label2> -NotEquals SecurityLevel
Returns any ClientPortalUsers with property SecurityLevel NOT equal to NEITHER <PickList Label1> NOR <PickList Label2>.
```

### EXAMPLE 11
```
, <PickList Label2> -Like ClientPortalUserName -NotEquals SecurityLevel -GreaterThan Id
