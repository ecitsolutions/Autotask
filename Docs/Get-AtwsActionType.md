...
### Filter (Default)
```
Get-AtwsActionType -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsActionType [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>] [-id <Nullable`1[]>]
 [-Name <String[]>] [-SystemActionType <Nullable`1[]>] [-View <String[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsActionType [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
