...
### Filter (Default)
```
Get-AtwsBusinessDivisionSubdivision -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsBusinessDivisionSubdivision [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>]
 [-BusinessDivisionID <Nullable`1[]>] [-BusinessSubdivisionID <Nullable`1[]>] [-id <Nullable`1[]>]
...
### Get_all
```
Get-AtwsBusinessDivisionSubdivision [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
