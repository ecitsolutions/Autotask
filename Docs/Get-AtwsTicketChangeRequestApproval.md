...
### Filter (Default)
```
Get-AtwsTicketChangeRequestApproval -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTicketChangeRequestApproval [-GetReferenceEntityById <String>] [-ApproveRejectDateTime <Nullable`1[]>]
 [-ApproveRejectNote <String[]>] [-ContactID <Nullable`1[]>] [-id <Nullable`1[]>] [-IsApproved <Nullable`1[]>]
 [-ResourceID <Nullable`1[]>] [-TicketID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsTicketChangeRequestApproval [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
