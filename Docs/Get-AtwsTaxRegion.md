...
### Filter (Default)
```
Get-AtwsTaxRegion -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTaxRegion [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>] [-id <Nullable`1[]>]
...
### Get_all
```
Get-AtwsTaxRegion [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
