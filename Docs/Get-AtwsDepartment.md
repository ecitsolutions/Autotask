...
### Filter (Default)
```
Get-AtwsDepartment -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsDepartment [-GetReferenceEntityById <String>] [-Description <String[]>] [-id <Nullable`1[]>]
 [-Name <String[]>] [-Number <String[]>] [-PrimaryLocationID <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsDepartment [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
