...
### Filter (Default)
```
Get-AtwsContractNote -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractNote [-GetReferenceEntityById <String>] [-ContractID <String[]>]
 ...
 [-ImpersonatorUpdaterResourceID <Nullable`1[]>] [-LastActivityDate <Nullable`1[]>] [-Title <String[]>]
...
### Get_all
```
Get-AtwsContractNote [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
