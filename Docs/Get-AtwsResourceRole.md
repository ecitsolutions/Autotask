...
### Filter (Default)
```
Get-AtwsResourceRole -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsResourceRole [-GetReferenceEntityById <String>] [-Active <Nullable`1[]>] [-DepartmentID <Nullable`1[]>]
 [-id <Nullable`1[]>] [-QueueID <String[]>] [-ResourceID <Nullable`1[]>] [-RoleID <Nullable`1[]>]
...
### Get_all
```
Get-AtwsResourceRole [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like ResourceRoleName -NotEquals QueueID -GreaterThan Id
