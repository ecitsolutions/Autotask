...
### Filter (Default)
```
Get-AtwsContractExclusionSetExcludedRole -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractExclusionSetExcludedRole [-GetReferenceEntityById <String>]
 [-ContractExclusionSetID <Nullable`1[]>] [-ExcludedRoleID <Nullable`1[]>] [-id <Nullable`1[]>]
...
### Get_all
```
Get-AtwsContractExclusionSetExcludedRole [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
