...
### Filter (Default)
```
Get-AtwsAccountWebhookExcludedResource -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### By_parameters
```
Get-AtwsAccountWebhookExcludedResource [-GetReferenceEntityById <String>] [-id <Nullable`1[]>]
...
### Get_all
```
Get-AtwsAccountWebhookExcludedResource [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
