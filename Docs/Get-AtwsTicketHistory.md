...
### Filter (Default)
```
Get-AtwsTicketHistory -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTicketHistory [-GetReferenceEntityById <String>] [-TicketID <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsTicketHistory [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
