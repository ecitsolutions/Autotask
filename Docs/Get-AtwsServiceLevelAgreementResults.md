...
# Get-AtwsServiceLevelAgreementResults
...
### Filter (Default)
```
Get-AtwsServiceLevelAgreementResults -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsServiceLevelAgreementResults [-GetReferenceEntityById <String>] [-CreateDateTime <Nullable`1[]>]
 [-CreatorResourceID <Nullable`1[]>] [-FirstResponseElapsedHours <Nullable`1[]>]
 [-FirstResponseInitiatingResourceID <Nullable`1[]>] [-FirstResponseMet <Nullable`1[]>]
 [-FirstResponseResourceID <Nullable`1[]>] [-id <Nullable`1[]>] [-LastModifiedByResourceID <Nullable`1[]>]
 [-LastModifiedDateTime <Nullable`1[]>] [-ResolutionElapsedHours <Nullable`1[]>]
 [-ResolutionMet <Nullable`1[]>] [-ResolutionPlanElapsedHours <Nullable`1[]>]
 [-ResolutionPlanMet <Nullable`1[]>] [-ResolutionPlanResourceID <Nullable`1[]>]
 [-ResolutionResourceID <Nullable`1[]>] [-ServiceLevelAgreementName <String[]>] [-TicketID <Nullable`1[]>]
...
### Get_all
```
Get-AtwsServiceLevelAgreementResults [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
