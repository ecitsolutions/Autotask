...
# Get-AtwsContractServiceBundleUnit
...
### Filter (Default)
```
Get-AtwsContractServiceBundleUnit -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractServiceBundleUnit [-GetReferenceEntityById <String>] [-ApproveAndPostDate <Nullable`1[]>]
 [-BusinessDivisionSubdivisionID <Nullable`1[]>] [-ContractID <Nullable`1[]>]
 [-ContractServiceBundleID <Nullable`1[]>] [-Cost <Nullable`1[]>] [-EndDate <Nullable`1[]>]
 [-id <Nullable`1[]>] [-InternalCurrencyPrice <Nullable`1[]>] [-Price <Nullable`1[]>]
 [-ServiceBundleID <Nullable`1[]>] [-StartDate <Nullable`1[]>] [-Units <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsContractServiceBundleUnit [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
