...
### Filter (Default)
```
Get-AtwsInventoryItemSerialNumber -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsInventoryItemSerialNumber [-GetReferenceEntityById <String>] [-id <Nullable`1[]>]
 [-InventoryItemID <Nullable`1[]>] [-SerialNumber <String[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsInventoryItemSerialNumber [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
