...
### Filter (Default)
```
Get-AtwsPurchaseOrderReceive -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsPurchaseOrderReceive [-GetReferenceEntityById <String>] [-id <Nullable`1[]>]
 [-PurchaseOrderItemID <Nullable`1[]>] [-QuantityBackOrdered <Nullable`1[]>]
 [-QuantityNowReceiving <Nullable`1[]>] [-QuantityPreviouslyReceived <Nullable`1[]>]
 [-ReceiveDate <Nullable`1[]>] [-ReceivedByResourceID <Nullable`1[]>] [-SerialNumber <String[]>]
...
### Get_all
```
Get-AtwsPurchaseOrderReceive [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
