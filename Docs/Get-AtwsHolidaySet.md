...
### Filter (Default)
```
Get-AtwsHolidaySet -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsHolidaySet [-GetReferenceEntityById <String>] [-HolidaySetDescription <String[]>]
 [-HolidaySetName <String[]>] [-id <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsHolidaySet [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
