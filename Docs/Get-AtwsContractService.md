...
### Filter (Default)
```
Get-AtwsContractService -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractService [-GetReferenceEntityById <String>] [-AdjustedPrice <Nullable`1[]>]
 ...
 [-QuoteItemID <Nullable`1[]>] [-ServiceID <Nullable`1[]>] [-UnitCost <Nullable`1[]>]
 [-UnitPrice <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsContractService [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
