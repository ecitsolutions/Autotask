...
### Filter (Default)
```
Get-AtwsTimeEntry -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTimeEntry [-GetReferenceEntityById <String>] [-AllocationCodeID <Nullable`1[]>]
 [-BillingApprovalDateTime <Nullable`1[]>] [-BillingApprovalLevelMostRecent <Nullable`1[]>]
 [-BillingApprovalResourceID <Nullable`1[]>] [-ContractID <Nullable`1[]>]
 [-ContractServiceBundleID <Nullable`1[]>] [-ContractServiceID <Nullable`1[]>] [-CreateDateTime <Nullable`1[]>]
 [-CreatorUserID <Nullable`1[]>] [-DateWorked <Nullable`1[]>] [-EndDateTime <Nullable`1[]>]
 [-HoursToBill <Nullable`1[]>] [-HoursWorked <Nullable`1[]>] [-id <Nullable`1[]>]
 [-ImpersonatorCreatorResourceID <Nullable`1[]>] [-ImpersonatorUpdaterResourceID <Nullable`1[]>]
 [-InternalAllocationCodeID <Nullable`1[]>] [-InternalNotes <String[]>] [-LastModifiedDateTime <Nullable`1[]>]
 [-LastModifiedUserID <Nullable`1[]>] [-NonBillable <Nullable`1[]>] [-OffsetHours <Nullable`1[]>]
 [-ResourceID <Nullable`1[]>] [-RoleID <Nullable`1[]>] [-ShowOnInvoice <Nullable`1[]>]
 [-StartDateTime <Nullable`1[]>] [-SummaryNotes <String[]>] [-TaskID <Nullable`1[]>] [-TicketID <Nullable`1[]>]
 [-Type <String[]>] [-NotEquals <String[]>] [-IsNull <String[]>] [-IsNotNull <String[]>]
...
### Get_all
```
Get-AtwsTimeEntry [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like TimeEntryName -NotEquals Type -GreaterThan Id
