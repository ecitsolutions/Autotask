...
### Filter (Default)
```
Get-AtwsTicketAdditionalInstalledProduct -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTicketAdditionalInstalledProduct [-GetReferenceEntityById <String>] [-id <Nullable`1[]>]
 [-InstalledProductID <Nullable`1[]>] [-TicketID <Nullable`1[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsTicketAdditionalInstalledProduct [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
