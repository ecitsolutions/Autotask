...
### Filter (Default)
```
Get-AtwsContractFactor -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsContractFactor [-GetReferenceEntityById <String>] [-BlockHourFactor <Nullable`1[]>]
 [-ContractID <Nullable`1[]>] [-id <Nullable`1[]>] [-RoleID <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsContractFactor [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
