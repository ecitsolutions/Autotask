...
### Filter (Default)
```
Get-AtwsTicketCost -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsTicketCost [-GetReferenceEntityById <String>] [-AllocationCodeID <Nullable`1[]>]
 [-BillableAmount <Nullable`1[]>] [-BillableToAccount <Nullable`1[]>] [-Billed <Nullable`1[]>]
 [-BusinessDivisionSubdivisionID <Nullable`1[]>] [-ContractServiceBundleID <Nullable`1[]>]
 [-ContractServiceID <Nullable`1[]>] [-CostType <String[]>] [-CreateDate <Nullable`1[]>]
 [-CreatorResourceID <Nullable`1[]>] [-DatePurchased <Nullable`1[]>] [-Description <String[]>]
 [-ExtendedCost <Nullable`1[]>] [-id <Nullable`1[]>] [-InternalCurrencyBillableAmount <Nullable`1[]>]
 [-InternalCurrencyUnitPrice <Nullable`1[]>] [-InternalPurchaseOrderNumber <String[]>] [-Name <String[]>]
 [-Notes <String[]>] [-ProductID <Nullable`1[]>] [-PurchaseOrderNumber <String[]>] [-Status <String[]>]
 [-StatusLastModifiedBy <Nullable`1[]>] [-StatusLastModifiedDate <Nullable`1[]>] [-TicketID <Nullable`1[]>]
 [-UnitCost <Nullable`1[]>] [-UnitPrice <Nullable`1[]>] [-UnitQuantity <Nullable`1[]>] [-NotEquals <String[]>]
...
### Get_all
```
Get-AtwsTicketCost [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like TicketCostName -NotEquals CostType -GreaterThan Id
