...
### Filter (Default)
```
Get-AtwsServiceCall -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsServiceCall [-GetReferenceEntityById <String>] [-AccountID <Nullable`1[]>]
 [-AccountPhysicalLocationID <Nullable`1[]>] [-CancelationNoticeHours <Nullable`1[]>]
 [-CanceledByResource <Nullable`1[]>] [-CanceledDateTime <Nullable`1[]>] [-Complete <Nullable`1[]>]
 [-CreateDateTime <Nullable`1[]>] [-CreatorResourceID <Nullable`1[]>] [-Description <String[]>]
 [-Duration <Nullable`1[]>] [-EndDateTime <Nullable`1[]>] [-id <Nullable`1[]>]
 [-ImpersonatorCreatorResourceID <Nullable`1[]>] [-LastModifiedDateTime <Nullable`1[]>]
 [-StartDateTime <Nullable`1[]>] [-Status <String[]>] [-NotEquals <String[]>] [-IsNull <String[]>]
...
### Get_all
```
Get-AtwsServiceCall [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 11
```
, <PickList Label2> -Like ServiceCallName -NotEquals Status -GreaterThan Id
