...
### Filter (Default)
```
Get-AtwsPriceListRole -Filter <String[]> [-GetReferenceEntityById <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### By_parameters
```
Get-AtwsPriceListRole [-GetReferenceEntityById <String>] [-CurrencyID <Nullable`1[]>]
 [-HourlyRate <Nullable`1[]>] [-id <Nullable`1[]>] [-RoleID <Nullable`1[]>]
...
### Get_all
```
Get-AtwsPriceListRole [-All] [-WhatIf] [-Confirm] [<CommonParameters>]
```
