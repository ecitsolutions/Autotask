...
#>
Function Get-ClassificationIcon
{
...
.EXAMPLE
Get-ClassificationIcon -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ClassificationIcon -ClassificationIconName SomeName
Returns the object with ClassificationIconName 'SomeName', if any.
 .EXAMPLE
Get-ClassificationIcon -ClassificationIconName 'Some Name'
Returns the object with ClassificationIconName 'Some Name', if any.
 .EXAMPLE
Get-ClassificationIcon -ClassificationIconName 'Some Name' -NotEquals ClassificationIconName
Returns any objects with a ClassificationIconName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ClassificationIcon -ClassificationIconName SomeName* -Like ClassificationIconName
Returns any object with a ClassificationIconName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ClassificationIcon -ClassificationIconName SomeName* -NotLike ClassificationIconName
