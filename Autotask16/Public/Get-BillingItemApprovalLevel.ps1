...
#>
Function Get-BillingItemApprovalLevel
{
...
.EXAMPLE
Get-BillingItemApprovalLevel -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-BillingItemApprovalLevel -BillingItemApprovalLevelName SomeName
Returns the object with BillingItemApprovalLevelName 'SomeName', if any.
 .EXAMPLE
Get-BillingItemApprovalLevel -BillingItemApprovalLevelName 'Some Name'
Returns the object with BillingItemApprovalLevelName 'Some Name', if any.
 .EXAMPLE
Get-BillingItemApprovalLevel -BillingItemApprovalLevelName 'Some Name' -NotEquals BillingItemApprovalLevelName
Returns any objects with a BillingItemApprovalLevelName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-BillingItemApprovalLevel -BillingItemApprovalLevelName SomeName* -Like BillingItemApprovalLevelName
Returns any object with a BillingItemApprovalLevelName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-BillingItemApprovalLevel -BillingItemApprovalLevelName SomeName* -NotLike BillingItemApprovalLevelName
...
# Follow this external ID and return any external objects
    ...
    [Alias('GetRef')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('TimeEntryID', 'ApprovalResourceID')]
    [String]
