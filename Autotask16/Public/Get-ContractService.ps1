...
.EXAMPLE
Get-ContractService -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractService -ContractServiceName SomeName
Returns the object with ContractServiceName 'SomeName', if any.
 .EXAMPLE
Get-ContractService -ContractServiceName 'Some Name'
Returns the object with ContractServiceName 'Some Name', if any.
 .EXAMPLE
Get-ContractService -ContractServiceName 'Some Name' -NotEquals ContractServiceName
Returns any objects with a ContractServiceName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractService -ContractServiceName SomeName* -Like ContractServiceName
Returns any object with a ContractServiceName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractService -ContractServiceName SomeName* -NotLike ContractServiceName
...
# Follow this external ID and return any external objects
    ...
    [Alias('GetRef')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('ContractID', 'ServiceID', 'QuoteItemID')]
    [String]
...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('InstalledProduct:ContractServiceID', 'ContractServiceAdjustment:ContractServiceID', 'TicketCost:ContractServiceID', 'ContractServiceUnit:ContractServiceID', 'ProjectCost:ContractServiceID', 'Ticket:ContractServiceID', 'ContractCost:ContractServiceID', 'TimeEntry:ContractServiceID')]
    [String]
