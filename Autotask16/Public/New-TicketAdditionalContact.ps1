...
#>
Function New-TicketAdditionalContact
{
...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the TicketAdditionalContact with Id number 0 you could write 'New-TicketAdditionalContact -Id 0' or you could write 'New-TicketAdditionalContact -Filter {Id -eq 0}.

'New-TicketAdditionalContact -Id 0,4' could be written as 'New-TicketAdditionalContact -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-TicketAdditionalContact -TicketID [Value] -ContactID [Value]
Creates a new [Autotask.TicketAdditionalContact] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-TicketAdditionalContact -Id 124 | New-TicketAdditionalContact 
Copies [Autotask.TicketAdditionalContact] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-TicketAdditionalContact -Id 124 | New-TicketAdditionalContact | Set-TicketAdditionalContact -ParameterName <Parameter Value>
Copies [Autotask.TicketAdditionalContact] by Id 124 to a new object through the Web Services API, passes the new object to the Set-TicketAdditionalContact to modify the object.
 .EXAMPLE
$Result = Get-TicketAdditionalContact -Id 124 | New-TicketAdditionalContact | Set-TicketAdditionalContact -ParameterName <Parameter Value> -Passthru
Copies [Autotask.TicketAdditionalContact] by Id 124 to a new object through the Web Services API, passes the new object to the Set-TicketAdditionalContact to modify the object and returns the new object.
