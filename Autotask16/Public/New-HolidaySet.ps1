...
If you need very complicated queries you can write a filter directly and pass it using the -Filter parameter. To get the HolidaySet with Id number 0 you could write 'New-HolidaySet -Id 0' or you could write 'New-HolidaySet -Filter {Id -eq 0}.

'New-HolidaySet -Id 0,4' could be written as 'New-HolidaySet -Filter {id -eq 0 -or id -eq 4}'. For simple queries you can see that using parameters is much easier than the -Filter option. But the -Filter option supports an arbitrary sequence of most operators (-eq, -ne, -gt, -ge, -lt, -le, -and, -or, -beginswith, -endswith, -contains, -like, -notlike, -soundslike, -isnotnull, -isnull, -isthisday). As you can group them using parenthesis '()' you can write arbitrarily complex queries with -Filter. 
...
.EXAMPLE
$Result = New-HolidaySet -HolidaySetName [Value]
Creates a new [Autotask.HolidaySet] through the Web Services API and returns the new object.
 .EXAMPLE
$Result = Get-HolidaySet -Id 124 | New-HolidaySet 
Copies [Autotask.HolidaySet] by Id 124 to a new object through the Web Services API and returns the new object.
 .EXAMPLE
Get-HolidaySet -Id 124 | New-HolidaySet | Set-HolidaySet -ParameterName <Parameter Value>
Copies [Autotask.HolidaySet] by Id 124 to a new object through the Web Services API, passes the new object to the Set-HolidaySet to modify the object.
 .EXAMPLE
$Result = Get-HolidaySet -Id 124 | New-HolidaySet | Set-HolidaySet -ParameterName <Parameter Value> -Passthru
Copies [Autotask.HolidaySet] by Id 124 to a new object through the Web Services API, passes the new object to the Set-HolidaySet to modify the object and returns the new object.
