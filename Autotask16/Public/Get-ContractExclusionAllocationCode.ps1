...
#>
Function Get-ContractExclusionAllocationCode
{
...
.EXAMPLE
Get-ContractExclusionAllocationCode -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-ContractExclusionAllocationCode -ContractExclusionAllocationCodeName SomeName
Returns the object with ContractExclusionAllocationCodeName 'SomeName', if any.
 .EXAMPLE
Get-ContractExclusionAllocationCode -ContractExclusionAllocationCodeName 'Some Name'
Returns the object with ContractExclusionAllocationCodeName 'Some Name', if any.
 .EXAMPLE
Get-ContractExclusionAllocationCode -ContractExclusionAllocationCodeName 'Some Name' -NotEquals ContractExclusionAllocationCodeName
Returns any objects with a ContractExclusionAllocationCodeName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-ContractExclusionAllocationCode -ContractExclusionAllocationCodeName SomeName* -Like ContractExclusionAllocationCodeName
Returns any object with a ContractExclusionAllocationCodeName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-ContractExclusionAllocationCode -ContractExclusionAllocationCodeName SomeName* -NotLike ContractExclusionAllocationCodeName
