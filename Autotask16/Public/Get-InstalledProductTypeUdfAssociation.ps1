...
#>
Function Get-InstalledProductTypeUdfAssociation
{
...
.EXAMPLE
Get-InstalledProductTypeUdfAssociation -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-InstalledProductTypeUdfAssociation -InstalledProductTypeUdfAssociationName SomeName
Returns the object with InstalledProductTypeUdfAssociationName 'SomeName', if any.
 .EXAMPLE
Get-InstalledProductTypeUdfAssociation -InstalledProductTypeUdfAssociationName 'Some Name'
Returns the object with InstalledProductTypeUdfAssociationName 'Some Name', if any.
 .EXAMPLE
Get-InstalledProductTypeUdfAssociation -InstalledProductTypeUdfAssociationName 'Some Name' -NotEquals InstalledProductTypeUdfAssociationName
Returns any objects with a InstalledProductTypeUdfAssociationName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-InstalledProductTypeUdfAssociation -InstalledProductTypeUdfAssociationName SomeName* -Like InstalledProductTypeUdfAssociationName
Returns any object with a InstalledProductTypeUdfAssociationName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-InstalledProductTypeUdfAssociation -InstalledProductTypeUdfAssociationName SomeName* -NotLike InstalledProductTypeUdfAssociationName
...
# Follow this external ID and return any external objects
    ...
    [Alias('GetRef')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('InstalledProductTypeId')]
    [String]
