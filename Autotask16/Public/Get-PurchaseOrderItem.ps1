...
#>
Function Get-PurchaseOrderItem
{
...
.EXAMPLE
Get-PurchaseOrderItem -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-PurchaseOrderItem -PurchaseOrderItemName SomeName
Returns the object with PurchaseOrderItemName 'SomeName', if any.
 .EXAMPLE
Get-PurchaseOrderItem -PurchaseOrderItemName 'Some Name'
Returns the object with PurchaseOrderItemName 'Some Name', if any.
 .EXAMPLE
Get-PurchaseOrderItem -PurchaseOrderItemName 'Some Name' -NotEquals PurchaseOrderItemName
Returns any objects with a PurchaseOrderItemName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-PurchaseOrderItem -PurchaseOrderItemName SomeName* -Like PurchaseOrderItemName
Returns any object with a PurchaseOrderItemName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-PurchaseOrderItem -PurchaseOrderItemName SomeName* -NotLike PurchaseOrderItemName
