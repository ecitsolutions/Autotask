...
#>
Function Get-TicketAdditionalInstalledProduct
{
...
.EXAMPLE
Get-TicketAdditionalInstalledProduct -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-TicketAdditionalInstalledProduct -TicketAdditionalInstalledProductName SomeName
Returns the object with TicketAdditionalInstalledProductName 'SomeName', if any.
 .EXAMPLE
Get-TicketAdditionalInstalledProduct -TicketAdditionalInstalledProductName 'Some Name'
Returns the object with TicketAdditionalInstalledProductName 'Some Name', if any.
 .EXAMPLE
Get-TicketAdditionalInstalledProduct -TicketAdditionalInstalledProductName 'Some Name' -NotEquals TicketAdditionalInstalledProductName
Returns any objects with a TicketAdditionalInstalledProductName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-TicketAdditionalInstalledProduct -TicketAdditionalInstalledProductName SomeName* -Like TicketAdditionalInstalledProductName
Returns any object with a TicketAdditionalInstalledProductName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-TicketAdditionalInstalledProduct -TicketAdditionalInstalledProductName SomeName* -NotLike TicketAdditionalInstalledProductName
