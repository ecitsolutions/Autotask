...
.EXAMPLE
Get-SurveyResults -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-SurveyResults -SurveyResultsName SomeName
Returns the object with SurveyResultsName 'SomeName', if any.
 .EXAMPLE
Get-SurveyResults -SurveyResultsName 'Some Name'
Returns the object with SurveyResultsName 'Some Name', if any.
 .EXAMPLE
Get-SurveyResults -SurveyResultsName 'Some Name' -NotEquals SurveyResultsName
Returns any objects with a SurveyResultsName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-SurveyResults -SurveyResultsName SomeName* -Like SurveyResultsName
Returns any object with a SurveyResultsName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-SurveyResults -SurveyResultsName SomeName* -NotLike SurveyResultsName
