...
#>
Function Get-TaskSecondaryResource
{
...
.EXAMPLE
Get-TaskSecondaryResource -Id 0
Returns the object with Id 0, if any.
 .EXAMPLE
Get-TaskSecondaryResource -TaskSecondaryResourceName SomeName
Returns the object with TaskSecondaryResourceName 'SomeName', if any.
 .EXAMPLE
Get-TaskSecondaryResource -TaskSecondaryResourceName 'Some Name'
Returns the object with TaskSecondaryResourceName 'Some Name', if any.
 .EXAMPLE
Get-TaskSecondaryResource -TaskSecondaryResourceName 'Some Name' -NotEquals TaskSecondaryResourceName
Returns any objects with a TaskSecondaryResourceName that is NOT equal to 'Some Name', if any.
 .EXAMPLE
Get-TaskSecondaryResource -TaskSecondaryResourceName SomeName* -Like TaskSecondaryResourceName
Returns any object with a TaskSecondaryResourceName that matches the simple pattern 'SomeName*'. Supported wildcards are * and %.
 .EXAMPLE
Get-TaskSecondaryResource -TaskSecondaryResourceName SomeName* -NotLike TaskSecondaryResourceName
...
# Follow this external ID and return any external objects
    ...
    [Alias('GetRef')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('TaskID', 'ResourceID', 'RoleID')]
    [String]
