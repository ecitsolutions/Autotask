...
# Return entities of selected type that are referencing to this entity.
    ...
    [Alias('External')]
    [ValidateNotNullOrEmpty()]
    [ValidateSet('ResourceRole:DepartmentID', 'ResourceRoleDepartment:DepartmentID')]
    [String]
