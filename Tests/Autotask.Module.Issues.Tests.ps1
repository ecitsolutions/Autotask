...
Describe 'Issue #44' -Tag 'Issues' {
    ...
    Context 'Issue #44: GetEntityByReferenceId documentation ' {
        ...
        It 'Account 0 should have a default contract' {$Contract.Count | Should -Be 1}

        It '$Contract should be a contract' {$Contract | Should -BeOfType Autotask.Contract}

        It '-GetReferenceEntityById AccountID should return a single account' {$Account.Count | Should -Be 1}
...
Describe 'Issue #43' -Tag 'Issues' {
    ...
    Context 'Issue #43: New-AtwsAttachment adds timezone difference twice ' {
        InModuleScope Autotask {
            ...
            Mock 'Get-AtwsTicket' {Return $True}
            ...
            It 'should return the date unchanged' {$Result.CreateDate | Should -Be $CreateDate}
        }
    }
...
Describe 'Issue #38' -Tag 'Issues' {
    Context 'Issue #38: Feature request: Make connection object available to advanced users duplicate enhancement ' {
        ...
        $ModulePath = '{0}\{1}' -F $(Split-Path -Parent -Path (Split-Path -Parent $MyInvocation.MyCommand.Path)), $ModuleName
    
        Import-Module $ModulePath -Force -ArgumentList $Credential, $ApiTrackingIdentifier

        $LoadedModule = Get-Module $ModuleName

        It 'should be loaded' {$LoadedModule.Name | Should -Be $ModuleName}

        It 'should export Get-AtwsConnectionObject' {$LoadedModule.ExportedCommands['Get-AtwsConnectionObject'].Name | Should -Be 'Get-AtwsConnectionObject'}

        $Result = Get-AtwsConnectionObject -Confirm:$false

        It 'should return an Autotask web proxy object' {$Result | Should -BeOfType Autotask.ATWS}
    }
}
...
Describe 'Issue #37' -Tag 'Issues' {
    Context 'Issue #37: Feature request: Attachments upload enhancement good first issue ' {
        ...
        It 'should export Get-AtwsAttachment' {$LoadedModule.ExportedCommands['Get-AtwsAttachment'].Name | Should -Be 'Get-AtwsAttachment'}

        It 'should export New-AtwsAttachment' {$LoadedModule.ExportedCommands['New-AtwsAttachment'].Name | Should -Be 'New-AtwsAttachment'}

        It 'should export Remove-AtwsAttachment' {$LoadedModule.ExportedCommands['Remove-AtwsAttachment'].Name | Should -Be 'Remove-AtwsAttachment'}
    }
}
...
Describe 'Issue #33' -Tag 'Issues' {Context 'Issue #33: Updating Diskcache auto running at every import ' { }}
...
Describe 'Issue #25' -Tag 'Issues' {Context 'Issue #25: Set-AtwsTicket.ps1 - int32[] to int64 conversion error ' { }}

Describe 'Issue #24' -Tag 'Issues' {Context 'Issue #24: Missing commands, e.g., *-AtwsTicket ' { }}

Describe 'Issue #23' -Tag 'Issues' {Context 'Issue #23: Help w/ picklists lookups in functions and scripts. ' { }}

Describe 'Issue #22' -Tag 'Issues' {Context 'Issue #22: UDF wildcard does not work ' { }}

Describe 'Issue #21' -Tag 'Issues' {Context 'Issue #21: New-AtwsContractServiceAdjustment: Get-AtwsData : This entity type does not support the query action. ' { }}
...
Describe 'Issue #17' -Tag 'Issues' {Context 'Issue #17: Running on Azure Runbooks (Cache) ' { }}

Describe 'Issue #16' -Tag 'Issues' {Context 'Issue #16: Always confirming the write of new autotask data. ' { }}

Describe 'Issue #15' -Tag 'Issues' {Context 'Issue #15: Date errors using filter ' { }}

Describe 'Issue #14' -Tag 'Issues' {Context 'Issue #14: Changing UDF ' { }}

Describe 'Issue #11' -Tag 'Issues' {Context 'Issue #11: Set "ServiceLevelAgreementID" on contract to nothing ' { }}

Describe 'Issue #10' -Tag 'Issues' {Context 'Issue #10: Unable to connect, as a "\" seems to be prepended ' { }}

Describe 'Issue #9' -Tag 'Issues' {Context 'Issue #9: DateTime conversions ' { }}

Describe 'Issue #8' -Tag 'Issues' {Context 'Issue #8: Set-AtwsAccount -TerritoryID <Integer> Fails  ' { }}

Describe 'Issue #7' -Tag 'Issues' {Context 'Issue #7: Get-AtwsTicket -SubIssueType not updating properly. ' { }}

Describe 'Issue #4' -Tag 'Issues' {Context 'Issue #4: Get / Set AccountManager field ' { }}

Describe 'Issue #3' -Tag 'Issues' {Context 'Issue #3: Value does not exist for the required field when using New-AtwsData -InputObject ' { }}

Describe 'Issue #2' -Tag 'Issues' {Context 'Issue #2: Filters with parenthesis no longer work ' { }}
...
Describe 'Issue #1' -Tag 'Issues' {
    Context 'Issue #1: Account where a certain field (int) is empty' {
        ...
        It 'should exist an Account with id 0' {$Account | Should -BeOfType Autotask.Account}

        It 'should NOT return anything with -KeyAccountIcon $null' {$NoAccount | Should -BeNullOrEmpty}

        It 'should exist an Account with id 0 and a ParentAccountId of $null' {$AccountWithNull | Should -BeOfType Autotask.Account}
    }
}