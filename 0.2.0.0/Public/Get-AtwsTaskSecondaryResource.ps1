...
Use Get-help Get-AtwsTaskSecondaryResource for all possible operators.
      .INPUTS
      ...
      .EXAMPLE
      Get-AtwsTaskSecondaryResource  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsTaskSecondaryResource
      .NOTES
      NAME: Get-AtwsTaskSecondaryResource
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('TaskSecondaryResource')
    ...
    Get-AtwsData -Entity TaskSecondaryResource -Filter $Filter }   
