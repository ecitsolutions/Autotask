...
Use Get-help Get-AtwsClassificationIcon for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ClassificationIcon[]]. This function outputs the Autotask.ClassificationIcon that was returned by the API.
      .EXAMPLE
      Get-AtwsClassificationIcon  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsClassificationIcon
      .NOTES
      NAME: Get-AtwsClassificationIcon
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('ClassificationIcon')
    ...
    Get-AtwsData -Entity ClassificationIcon -Filter $Filter }   
