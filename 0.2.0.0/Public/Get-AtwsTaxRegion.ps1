...
Use Get-help Get-AtwsTaxRegion for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.TaxRegion[]]. This function outputs the Autotask.TaxRegion that was returned by the API.
      .EXAMPLE
      Get-AtwsTaxRegion  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsTaxRegion
      .NOTES
      NAME: Get-AtwsTaxRegion
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('TaxRegion')
    ...
    Get-AtwsData -Entity TaxRegion -Filter $Filter }   
