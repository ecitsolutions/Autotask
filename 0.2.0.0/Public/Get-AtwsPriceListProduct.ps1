...
Use Get-help Get-AtwsPriceListProduct for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.PriceListProduct[]]. This function outputs the Autotask.PriceListProduct that was returned by the API.
      .EXAMPLE
      Get-AtwsPriceListProduct  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsPriceListProduct
      .NOTES
      NAME: Get-AtwsPriceListProduct
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('PriceListProduct')
    ...
    Get-AtwsData -Entity PriceListProduct -Filter $Filter }   
