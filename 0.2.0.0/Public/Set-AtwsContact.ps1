...
Function Set-AtwsContact
{
  <#
      .SYNOPSIS
      This function sets parameters on the Contact specified by the -id parameter through the Autotask Web Services API.
      .DESCRIPTION
      This function sets parameters on the Contact specified by the -id parameter through the Autotask Web Services API.
      .INPUTS
      ...
      For parameters, use Get-Help Set-AtwsContact
      .NOTES
