...
Use Get-help Get-AtwsTax for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.Tax[]]. This function outputs the Autotask.Tax that was returned by the API.
      .EXAMPLE
      Get-AtwsTax  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsTax
      .NOTES
      NAME: Get-AtwsTax
  #>
 ...
 ,        
        ...
        [ValidateSet('id','TaxRegionID','TaxCategoryID','TaxName','TaxRate','IsCompounded')]
        [String[]]
        $NotEquals ,        
  ...
  {     
    ...
    Get-AtwsData -Entity Tax -Filter $Filter }   
