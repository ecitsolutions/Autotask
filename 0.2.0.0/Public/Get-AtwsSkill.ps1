...
Use Get-help Get-AtwsSkill for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.Skill[]]. This function outputs the Autotask.Skill that was returned by the API.
      .EXAMPLE
      Get-AtwsSkill  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsSkill
      .NOTES
      NAME: Get-AtwsSkill
  #>
