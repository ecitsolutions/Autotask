...
Use Get-help Get-AtwsShippingType for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ShippingType[]]. This function outputs the Autotask.ShippingType that was returned by the API.
      .EXAMPLE
      Get-AtwsShippingType  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsShippingType
      .NOTES
