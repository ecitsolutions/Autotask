...
Use Get-help Get-AtwsRole for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.Role[]]. This function outputs the Autotask.Role that was returned by the API.
      .EXAMPLE
      Get-AtwsRole  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsRole
      .NOTES
      NAME: Get-AtwsRole
  #>
