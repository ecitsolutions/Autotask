...
Use Get-help Get-AtwsProjectNote for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ProjectNote[]]. This function outputs the Autotask.ProjectNote that was returned by the API.
      .EXAMPLE
      Get-AtwsProjectNote  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsProjectNote
      .NOTES
 ...
 ,        
        ...
        [ValidateSet('CreatorResourceID','Description','id','LastActivityDate','ProjectID','Title','Announce')]
        [String[]]
        $NotEquals ,        
