...
Use Get-help Get-AtwsQuoteLocation for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.QuoteLocation[]]. This function outputs the Autotask.QuoteLocation that was returned by the API.
      .EXAMPLE
      Get-AtwsQuoteLocation  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsQuoteLocation
      .NOTES
