...
Use Get-help Get-AtwsProjectCost for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ProjectCost[]]. This function outputs the Autotask.ProjectCost that was returned by the API.
      .EXAMPLE
      Get-AtwsProjectCost  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsProjectCost
      .NOTES
      NAME: Get-AtwsProjectCost
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('ProjectCost')
    ...
    Get-AtwsData -Entity ProjectCost -Filter $Filter }   
