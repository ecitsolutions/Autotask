...
Use Get-help Get-AtwsPriceListService for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.PriceListService[]]. This function outputs the Autotask.PriceListService that was returned by the API.
      .EXAMPLE
      Get-AtwsPriceListService  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsPriceListService
      .NOTES
