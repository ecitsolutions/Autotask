...
Use Get-help Get-AtwsChangeRequestLink for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ChangeRequestLink[]]. This function outputs the Autotask.ChangeRequestLink that was returned by the API.
      .EXAMPLE
      Get-AtwsChangeRequestLink  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsChangeRequestLink
      .NOTES
