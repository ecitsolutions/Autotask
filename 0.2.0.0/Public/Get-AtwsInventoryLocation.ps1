...
Use Get-help Get-AtwsInventoryLocation for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.InventoryLocation[]]. This function outputs the Autotask.InventoryLocation that was returned by the API.
      .EXAMPLE
      Get-AtwsInventoryLocation  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsInventoryLocation
      .NOTES
      NAME: Get-AtwsInventoryLocation
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('InventoryLocation')
    ...
    Get-AtwsData -Entity InventoryLocation -Filter $Filter }   
