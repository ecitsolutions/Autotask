...
Function Set-AtwsProductVendor
{
  <#
      .SYNOPSIS
      This function sets parameters on the ProductVendor specified by the -id parameter through the Autotask Web Services API.
      .DESCRIPTION
      This function sets parameters on the ProductVendor specified by the -id parameter through the Autotask Web Services API.
      .INPUTS
      ...
      For parameters, use Get-Help Set-AtwsProductVendor
      .NOTES
