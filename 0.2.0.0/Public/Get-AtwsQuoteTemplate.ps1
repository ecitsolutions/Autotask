...
Use Get-help Get-AtwsQuoteTemplate for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.QuoteTemplate[]]. This function outputs the Autotask.QuoteTemplate that was returned by the API.
      .EXAMPLE
      Get-AtwsQuoteTemplate  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsQuoteTemplate
      .NOTES
