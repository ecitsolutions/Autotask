...
Use Get-help Get-AtwsContractTicketPurchase for all possible operators.
      .INPUTS
      ...
      .EXAMPLE
      Get-AtwsContractTicketPurchase  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsContractTicketPurchase
      .NOTES
