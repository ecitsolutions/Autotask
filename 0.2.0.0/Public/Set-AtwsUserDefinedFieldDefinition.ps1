...
Function Global:Set-AtwsUserDefinedFieldDefinition
{
  <#
      .SYNOPSIS
      This function sets parameters on a specific UserDefinedFieldDefinition through the Autotask Web Services API.
      .DESCRIPTION
      This function sets parameters on a specific UserDefinedFieldDefinition through the Autotask Web Services API.
      .EXAMPLE
      Set-AtwsUserDefinedFieldDefinition [-ParameterName] [Parameter value]
      Use Get-Help Set-AtwsUserDefinedFieldDefinition
      .NOTES
