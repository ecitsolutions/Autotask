...
Use Get-help Get-AtwsContractService for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ContractService[]]. This function outputs the Autotask.ContractService that was returned by the API.
      .EXAMPLE
      Get-AtwsContractService  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsContractService
      .NOTES
      NAME: Get-AtwsContractService
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('ContractService')
    ...
    Get-AtwsData -Entity ContractService -Filter $Filter }   
