...
Use Get-help Get-AtwsServiceBundleService for all possible operators.
      .INPUTS
      ...
      .EXAMPLE
      Get-AtwsServiceBundleService  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsServiceBundleService
      .NOTES
      NAME: Get-AtwsServiceBundleService
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('ServiceBundleService')
    ...
    Get-AtwsData -Entity ServiceBundleService -Filter $Filter }   
