...
Use Get-help Get-AtwsContractRoleCost for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ContractRoleCost[]]. This function outputs the Autotask.ContractRoleCost that was returned by the API.
      .EXAMPLE
      Get-AtwsContractRoleCost  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsContractRoleCost
      .NOTES
      NAME: Get-AtwsContractRoleCost
  #>
 ...
 ,        
  ...
  {     
    ...
    If (-not($Filter))
    {
        $Fields = $Atws.GetFieldInfo('ContractRoleCost')
    ...
    Get-AtwsData -Entity ContractRoleCost -Filter $Filter }   
