...
Function Set-AtwsContract
{
  <#
      .SYNOPSIS
      This function sets parameters on the Contract specified by the -id parameter through the Autotask Web Services API.
      .DESCRIPTION
      This function sets parameters on the Contract specified by the -id parameter through the Autotask Web Services API.
      .INPUTS
      ...
      For parameters, use Get-Help Set-AtwsContract
      .NOTES
