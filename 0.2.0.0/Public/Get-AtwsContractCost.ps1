...
Use Get-help Get-AtwsContractCost for all possible operators.
      .INPUTS
      Nothing. This function only takes parameters.
      .OUTPUTS
      [Autotask.ContractCost[]]. This function outputs the Autotask.ContractCost that was returned by the API.
      .EXAMPLE
      Get-AtwsContractCost  -Parameter1 [Parameter1 value] -Parameter2 [Parameter2 Value] -GreaterThan Parameter2
...
by name of "Parameter2" is greater than [Parameter2 Value].
      For parameters, use Get-Help Get-AtwsContractCost
      .NOTES
 ...
 ,        
        ...
        [ValidateSet('id','ContractID','ProductID','AllocationCodeID','Name','Description','DatePurchased','PurchaseOrderNumber','InternalPurchaseOrderNumber','UnitQuantity','UnitCost','UnitPrice','ExtendedCost','BillableAmount','BillableToAccount','Billed','StatusLastModifiedBy','StatusLastModifiedDate','CreateDate','CreatorResourceID','ContractServiceID','ContractServiceBundleID','InternalCurrencyBillableAmount','InternalCurrencyUnitPrice')]
        [String[]]
        $NotEquals ,        
